...
A fully worked end-to-end walkthrough of the in-process `jaxstanv5` backend
(model declaration through ArviZ diagnostics, with the filesystem effects of
each command annotated) is available as a self-contained page:
[`docs/jaxstanv5-inproc-walkthrough.html`](docs/jaxstanv5-inproc-walkthrough.html).
It is regenerated by [`docs/jaxstanv5-inproc-walkthrough.py`](docs/jaxstanv5-inproc-walkthrough.py).
A compact self-contained walkthrough of the new simulation-gate command surface
is available at
[`docs/simulation-workflow-walkthrough.html`](docs/simulation-workflow-walkthrough.html).
