...
var f = class e {
	...
	lineInner(e, t, n, r) {
		for (let i = 0;; i++) {
			...
			if ((t ? n : o) >= e) return new te(r, o, n, a);
			r = o + 1, n++;
		}
	}
	decompose(t, n, r, i) {
	...
	replace(t, n, r) {
		if ([t, n] = b(this, t, n), r.lines < this.lines) for (let i = 0, a = 0; i < this.children.length; i++) {
			let o = this.children[i], s = a + o.length;
			if (t >= a && n <= s) {
...
function S(e, t) {
	let n = e.charCodeAt(t);
	if (!re(n) || t + 1 == e.length) return n;
	let r = e.charCodeAt(t + 1);
	return ne(r) ? (n - 55296 << 10) + (r - 56320) + 65536 : n;
}
function ie(e) {
	...
	dynamicSlot(e) {
		...
		return {
			...
			reconfigure: (e, o) => {
				...
				if (c != null) {
					let r = Me(o, c);
					if (this.dependencies.every((t) => t instanceof E ? o.facet(t) === e.facet(t) : t instanceof D ? o.field(t, !1) == e.field(t, !1) : !0) || (a ? ye(s = t(e), r, n) : n(s = t(e), r))) return e.values[i] = r, 0;
				} else s = t(e);
...
var Se = /*@__PURE__*/ E.define({ static: !0 }), D = class e {
	constructor(e, t, n, r, i) {
...
var Te = {
	highest: /*@__PURE__*/ we(Ce.highest),
	high: /*@__PURE__*/ we(Ce.high),
	default: /*@__PURE__*/ we(Ce.default),
	low: /*@__PURE__*/ we(Ce.low),
	lowest: /*@__PURE__*/ we(Ce.lowest)
}, Ee = class {
	constructor(e, t) {
	...
	static resolve(t, n, r) {
		...
		for (let e of Ae(t, n, o)) e instanceof D ? i.push(e) : (a[e.facet.id] || (a[e.facet.id] = [])).push(e);
...
function Ae(e, t, n) {
	...
	function a(e, o) {
		...
		if (s != null) {
			if (s <= o) return;
			let t = r[s].indexOf(e);
			t > -1 && r[s].splice(t, 1), e instanceof Oe && n.delete(e.compartment);
		}
		...
		} else if (e instanceof Ee) a(e.inner, e.prec);
		else if (e instanceof D) r[o].push(e), e.provides && a(e.provides, o);
		else if (e instanceof ve) r[o].push(e), e.facet.extensions && a(e.facet.extensions, Ce.default);
		else {
			let t = e.extension;
	...
	return a(e, Ce.default), r.reduce((e, t) => e.concat(t));
}
function je(e, t) {
	if (t & 1) return 2;
...
var Ne = /*@__PURE__*/ E.define(), Pe = /*@__PURE__*/ E.define({
	combine: (e) => e.some((e) => e),
	static: !0
}), Fe = /*@__PURE__*/ E.define({
	combine: (e) => e.length ? e[0] : void 0,
	static: !0
}), Ie = /*@__PURE__*/ E.define(), Le = /*@__PURE__*/ E.define(), Re = /*@__PURE__*/ E.define(), ze = /*@__PURE__*/ E.define({ combine: (e) => e.length ? e[0] : !1 }), Be = class {
	constructor(e, t) {
...
k.time = /*@__PURE__*/ Be.define(), k.userEvent = /*@__PURE__*/ Be.define(), k.addToHistory = /*@__PURE__*/ Be.define(), k.remote = /*@__PURE__*/ Be.define();
function Ue(e, t) {
	let n = [];
	for (let r = 0, i = 0;;) {
		let a, o;
...
function Ge(e, t, n) {
	let r = t.selection, i = Xe(t.annotations);
	return t.userEvent && (i = i.concat(k.userEvent.of(t.userEvent))), {
		changes: t.changes instanceof ce ? t.changes : ce.of(t.changes || [], n, e.facet(Fe)),
...
function Ke(e, t, n) {
	let r = Ge(e, t.length ? t[0] : {}, e.doc.length);
	t.length && t[0].filter === !1 && (n = !1);
	for (let i = 1; i < t.length; i++) {
		t[i].filter === !1 && (n = !1);
		let a = !!t[i].sequential;
		r = We(r, Ge(e, t[i], a ? r.changes.newLength : e.doc.length), a);
	}
	let i = k.create(e, r.changes, r.selection, r.effects, r.annotations, r.scrollIntoView);
	return Je(n ? qe(i) : i);
}
function qe(e) {
	let t = e.startState, n = !0;
	for (let r of t.facet(Ie)) {
		let t = r(e);
		if (t === !1) {
			n = !1;
			break;
		}
		Array.isArray(t) && (n = n === !0 ? t : Ue(n, t));
	}
	if (n !== !0) {
		let r, i;
		...
		e = k.create(t, r, e.selection && e.selection.map(i), O.mapEffects(e.effects, i), e.annotations, e.scrollIntoView);
	}
	let r = t.facet(Le);
	for (let n = r.length - 1; n >= 0; n--) {
		let i = r[n](e);
		e = i instanceof k ? i : Array.isArray(i) && i.length == 1 && i[0] instanceof k ? i[0] : Ke(t, Xe(i), !1);
	}
	return e;
}
function Je(e) {
	let t = e.startState, n = t.facet(Re), r = e;
	for (let i = n.length - 1; i >= 0; i--) {
		let a = n[i](e);
		a && Object.keys(a).length && (r = We(r, Ge(t, a, e.changes.newLength), !0));
	}
	return r == e ? e : k.create(t, e.changes, e.selection, r.effects, r.annotations, r.scrollIntoView);
}
var Ye = [];
function Xe(e) {
	return e == null ? Ye : Array.isArray(e) ? e : [e];
}
var A = /*@__PURE__*/ (function(e) {
	return e[e.Word = 0] = "Word", e[e.Space = 1] = "Space", e[e.Other = 2] = "Other", e;
})(A ||= {}), Ze = /[\u00df\u0587\u0590-\u05f4\u0600-\u06ff\u3040-\u309f\u30a0-\u30ff\u3400-\u4db5\u4e00-\u9fcc\uac00-\ud7af]/, Qe;
try {
	Qe = /*@__PURE__*/ RegExp("[\\p{Alphabetic}\\p{Number}_]", "u");
} catch {}
function $e(e) {
	if (Qe) return Qe.test(e);
	for (let t = 0; t < e.length; t++) {
		let n = e[t];
		if (/\w/.test(n) || n > "" && (n.toUpperCase() != n.toLowerCase() || Ze.test(n))) return !0;
	}
	return !1;
}
function et(e) {
...
var j = class e {
	...
	applyTransaction(t) {
		...
		for (let e of t.effects) e.is(De.reconfigure) ? (n &&= (i = /* @__PURE__ */ new Map(), n.compartments.forEach((e, t) => i.set(t, e)), null), i.set(e.value.compartment, e.value.extension)) : e.is(O.reconfigure) ? (n = null, r = e.value) : e.is(O.appendConfig) && (n = null, r = Xe(r).concat(e.value));
		let a;
		...
		let o = t.startState.facet(Pe) ? t.newSelection : t.newSelection.asSingle();
	...
	changeByRange(e) {
		let t = this.selection, n = e(t.ranges[0]), r = this.changes(n.changes), i = [n.range], a = Xe(n.effects);
		for (let n = 1; n < t.ranges.length; n++) {
			let o = e(t.ranges[n]), s = this.changes(o.changes), c = s.map(r);
			for (let e = 0; e < n; e++) i[e] = i[e].map(c);
			let l = r.mapDesc(s, !0);
			i.push(o.range.map(l)), r = r.compose(c), a = O.mapEffects(a, c).concat(O.mapEffects(Xe(o.effects), l));
		}
		return {
			changes: r,
	...
	facet(e) {
		...
		return t == null ? e.default : (je(this, t), Me(this, t));
	}
	toJSON(e) {
		let t = {
			doc: this.sliceDoc(),
		...
		if (e) for (let n in e) {
			let r = e[n];
			r instanceof D && this.config.address[r.id] != null && (t[n] = r.spec.toJSON(this.field(e[n]), this));
		}
		return t;
	}
	...
	static create(t = {}) {
		let n = ke.resolve(t.extensions || [], /* @__PURE__ */ new Map()), r = t.doc instanceof f ? t.doc : f.of((t.doc || "").split(n.staticFacet(e.lineSeparator) || oe)), i = t.selection ? t.selection instanceof T ? t.selection : T.single(t.selection.anchor, t.selection.head) : T.single(0);
		return he(i, r.length), n.staticFacet(Pe) || (i = i.asSingle()), new e(n, r, i, n.dynamicSlots.map(() => null), (e, t) => t.create(e), null);
	}
	get tabSize() {
	...
	languageDataAt(e, t, n = -1) {
		let r = [];
		for (let i of this.facet(Ne)) for (let a of i(this, t, n)) Object.prototype.hasOwnProperty.call(a, e) && r.push(a[e]);
		return r;
	}
	charCategorizer(e) {
		let t = this.languageDataAt("wordChars", e);
		return et(t.length ? t[0] : "");
	}
	wordAt(e) {
...
j.allowMultipleSelections = Pe, j.tabSize = /*@__PURE__*/ E.define({ combine: (e) => e.length ? e[0] : 4 }), j.lineSeparator = Fe, j.readOnly = ze, j.phrases = /*@__PURE__*/ E.define({ compare(e, t) {
	let n = Object.keys(e), r = Object.keys(t);
	return n.length == r.length && n.every((n) => e[n] == t[n]);
} }), j.languageData = Ne, j.changeFilter = Ie, j.transactionFilter = Le, j.transactionExtender = Re, De.reconfigure = /*@__PURE__*/ O.define();
function tt(e, t, n = {}) {
	let r = {};
...
var nt = class {
	...
	range(e, t = e) {
		return it.create(e, t, this);
	}
};
nt.prototype.startSide = nt.prototype.endSide = 0, nt.prototype.point = !1, nt.prototype.mapMode = C.TrackDel;
function rt(e, t) {
...
var ot = class e {
	...
	update(t) {
		...
		if (r && (n = n.slice().sort(at)), this.isEmpty) return n.length ? e.of(n) : this;
		let s = new ut(this, null, -1).goto(0), c = 0, l = [], u = new ct();
		...
		} else s.rangeIndex == 1 && s.chunkIndex < this.chunk.length && (c == n.length || this.chunkEnd(s.chunkIndex) < n[c].from) && (!o || i > this.chunkEnd(s.chunkIndex) || a < this.chunkPos[s.chunkIndex]) && u.addChunk(this.chunkPos[s.chunkIndex], this.chunk[s.chunkIndex]) ? s.nextChunk() : ((!o || i > s.to || a < s.from || o(s.from, s.to, s.value)) && (u.addInner(s.from, s.to, s.value) || l.push(it.create(s.from, s.to, s.value))), s.next());
	...
	static compare(e, t, n, r, i = -1) {
		let a = e.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), o = t.filter((e) => e.maxPoint > 0 || !e.isEmpty && e.maxPoint >= i), s = lt(a, o, n), c = new pt(a, s, i), l = new pt(o, s, i);
	...
	static eq(e, t, n = 0, r) {
		...
		let o = lt(i, a), s = new pt(i, o, 0).goto(n), c = new pt(a, o, 0).goto(n);
		for (;;) {
			if (s.to != c.to || !ht(s.active, c.active) || s.point && (!c.point || !rt(s.point, c.point))) return !1;
			if (s.to > r) return !0;
			s.next(), c.next();
		}
	}
	...
	static of(e, t = !1) {
		let n = new ct();
		for (let r of e instanceof it ? [e] : t ? st(e) : e) n.add(r.from, r.to, r.value);
		return n.finish();
	}
	static join(t) {
...
function st(e) {
	if (e.length > 1) for (let t = e[0], n = 1; n < e.length; n++) {
		let r = e[n];
		if (at(t, r) > 0) return e.slice().sort(at);
		t = r;
	}
	return e;
}
...
var ct = class e {
	finishChunk(e) {
		this.chunks.push(new ot(this.from, this.to, this.value, this.maxPoint)), this.chunkPos.push(this.chunkStart), this.chunkStart = -1, this.setMaxPoint = Math.max(this.setMaxPoint, this.maxPoint), this.maxPoint = -1, e && (this.from = [], this.to = [], this.value = []);
	}
	constructor() {
...
var ut = class {
	...
	static from(t, n = null, r = -1) {
		let i = [];
		for (let e = 0; e < t.length; e++) for (let a = t[e]; !a.isEmpty; a = a.nextLayer) a.maxPoint >= r && i.push(new ut(a, n, r, e));
	...
	goto(e, t = -1e9) {
		...
		for (let e = this.heap.length >> 1; e >= 0; e--) ft(this.heap, e);
	...
	next() {
		if (this.heap.length == 0) this.from = this.to = 1e9, this.value = null, this.rank = -1;
			...
			let e = this.heap[0];
			this.from = e.from, this.to = e.to, this.value = e.value, this.rank = e.rank, e.value && e.next(), ft(this.heap, 0);
		}
	}
};
function ft(e, t) {
...
var pt = class {
	constructor(e, t, n) {
		this.minPoint = n, this.active = [], this.activeTo = [], this.activeRank = [], this.minActive = -1, this.point = null, this.pointFrom = 0, this.pointRank = 0, this.to = -1e9, this.endSide = 0, this.openStart = -1, this.cursor = dt.from(e, t, n);
	}
	goto(e, t = -1e9) {
	...
	removeActive(e) {
		gt(this.active, e), gt(this.activeTo, e), gt(this.activeRank, e), this.minActive = vt(this.active, this.activeTo);
	}
	addActive(e) {
		let t = 0, { value: n, to: r, rank: i } = this.cursor;
		for (; t < this.activeRank.length && (i - this.activeRank[t] || r - this.activeTo[t]) > 0;) t++;
		_t(this.active, t, n), _t(this.activeTo, t, r), _t(this.activeRank, t, i), e && _t(e, t, this.cursor.from), this.minActive = vt(this.active, this.activeTo);
	}
	next() {
...
function mt(e, t, n, r, i, a) {
	...
	for (let t = !1;;) {
		...
		if (e.point || n.point ? (e.point && n.point && rt(e.point, n.point) && ht(e.activeForPoint(e.to), n.activeForPoint(n.to)) || a.comparePoint(s, d, e.point, n.point), t = !1) : (t && a.boundChange(s), d > s && !ht(e.active, n.active) && a.compareRange(s, d, e.active, n.active), l && d < o && (r || e.openEnd(u) != n.openEnd(u)) && (t = !0)), u > o) break;
		s = u, i <= 0 && e.next(), i >= 0 && n.next();
	}
}
function ht(e, t) {
	if (e.length != t.length) return !1;
	for (let n = 0; n < e.length; n++) if (e[n] != t[n] && !rt(e[n], t[n])) return !1;
	return !0;
}
function gt(e, t) {
...
for (var xt = "ͼ", St = typeof Symbol > "u" ? "__ͼ" : Symbol.for(xt), Ct = typeof Symbol > "u" ? "__styleSet" + Math.floor(Math.random() * 1e8) : Symbol("styleSet"), wt = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : {}, Tt = class {
	constructor(e, t) {
		this.rules = [];
		let { finish: n } = t || {};
		function r(e) {
	...
	static newName() {
		let e = wt[St] || 1;
		return wt[St] = e + 1, xt + e.toString(36);
	}
	static mount(e, t, n) {
		let r = e[Ct], i = n && n.nonce;
		r ? i && r.setNonce(i) : r = new Dt(e, i), r.mount(Array.isArray(t) ? t : [t], e);
	}
}, Et = /* @__PURE__ */ new Map(), Dt = class {
	constructor(e, t) {
		let n = e.ownerDocument || e, r = n.defaultView;
		if (!e.head && e.adoptedStyleSheets && r.CSSStyleSheet) {
			let t = Et.get(n);
			if (t) return e[Ct] = t;
			this.sheet = new r.CSSStyleSheet(), Et.set(n, this);
		} else this.styleTag = n.createElement("style"), t && this.styleTag.setAttribute("nonce", t);
		this.modules = [], e[Ct] = this;
	}
	mount(e, t) {
	...
	221: "}",
	222: "\""
}, At = typeof navigator < "u" && /Mac/.test(navigator.platform), jt = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent), N = 0; N < 10; N++) Ot[48 + N] = Ot[96 + N] = String(N);
for (var N = 1; N <= 24; N++) Ot[N + 111] = "F" + N;
for (var N = 65; N <= 90; N++) Ot[N] = String.fromCharCode(N + 32), kt[N] = String.fromCharCode(N);
for (var Mt in Ot) kt.hasOwnProperty(Mt) || (kt[Mt] = Ot[Mt]);
function Nt(e) {
	var t = !(At && e.metaKey && e.shiftKey && !e.ctrlKey && !e.altKey || jt && e.shiftKey && e.key && e.key.length == 1 || e.key == "Unidentified") && e.key || (e.shiftKey ? kt : Ot)[e.keyCode] || e.key || "Unidentified";
...
var F = typeof navigator < "u" ? navigator : {
	...
	vendor: "",
	platform: ""
}, Ft = typeof document < "u" ? document : { documentElement: { style: {} } }, It = /*@__PURE__*/ /Edge\/(\d+)/.exec(F.userAgent), Lt = /*@__PURE__*/ /MSIE \d/.test(F.userAgent), Rt = /*@__PURE__*/ /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(F.userAgent), zt = !!(Lt || Rt || It), Bt = !zt && /*@__PURE__*/ /gecko\/(\d+)/i.test(F.userAgent), Vt = !zt && /*@__PURE__*/ /Chrome\/(\d+)/.exec(F.userAgent), Ht = "webkitFontSmoothing" in Ft.documentElement.style, Ut = !zt && /*@__PURE__*/ /Apple Computer/.test(F.vendor), Wt = Ut && (/*@__PURE__*/ /Mobile\/\w+/.test(F.userAgent) || F.maxTouchPoints > 2), I = {
	mac: Wt || /*@__PURE__*/ /Mac/.test(F.platform),
	windows: /*@__PURE__*/ /Win/.test(F.platform),
	linux: /*@__PURE__*/ /Linux|X11/.test(F.platform),
	ie: zt,
	ie_version: Lt ? Ft.documentMode || 6 : Rt ? +Rt[1] : It ? +It[1] : 0,
	gecko: Bt,
	gecko_version: Bt ? +(/*@__PURE__*/ /Firefox\/(\d+)/.exec(F.userAgent) || [0, 0])[1] : 0,
	chrome: !!Vt,
	chrome_version: Vt ? +Vt[1] : 0,
	ios: Wt,
	android: /*@__PURE__*/ /Android\b/.test(F.userAgent),
	webkit: Ht,
	webkit_version: Ht ? +(/*@__PURE__*/ /\bAppleWebKit\/(\d+)/.exec(F.userAgent) || [0, 0])[1] : 0,
	safari: Ut,
	safari_version: Ut ? +(/*@__PURE__*/ /\bVersion\/(\d+(\.\d+)?)/.exec(F.userAgent) || [0, 0])[1] : 0,
	tabSize: Ft.documentElement.style.tabSize == null ? "-moz-tab-size" : "tab-size"
};
function Gt(e, t) {
...
R.none = M.empty;
var Qt = class e extends R {
	constructor(e) {
		let { start: t, end: n } = tn(e);
		super(t ? -1 : 5e8, n ? 1 : -6e8, null, e), this.tagName = e.tagName || "span", this.attrs = e.class && e.attributes ? Gt(e.attributes, { class: e.class }) : e.class ? { class: e.class } : e.attributes || Kt;
	}
	eq(t) {
		return this == t || t instanceof e && this.tagName == t.tagName && qt(this.attrs, t.attrs);
	}
	range(e, t = e) {
...
var $t = class e extends R {
	constructor(e) {
		super(-2e8, -2e8, null, e);
	}
	eq(t) {
		return t instanceof e && this.spec.class == t.spec.class && qt(this.spec.attributes, t.spec.attributes);
	}
	range(e, t = e) {
...
$t.prototype.mapMode = C.TrackBefore, $t.prototype.point = !0;
var en = class e extends R {
	constructor(e, t, n, r, i, a) {
	...
	eq(t) {
		return t instanceof e && nn(this.widget, t.widget) && this.block == t.block && this.startSide == t.startSide && this.endSide == t.endSide;
	}
	range(e, t = e) {
...
var an = class e extends nt {
	constructor(e, t, n) {
		super(), this.tagName = e, this.attributes = t, this.rank = n;
	}
	eq(t) {
		return t == this || t instanceof e && this.tagName == t.tagName && qt(this.attributes, t.attributes);
	}
	static create(t) {
		return new e(t.tagName, t.attributes || Kt, t.rank == null ? 50 : Math.max(0, Math.min(t.rank, 100)));
	}
	static set(e, t = !1) {
		return M.of(e, t);
	}
...
I.safari && I.safari_version >= 26 && (xn = !1);
function Sn(e) {
	if (e.setActive) return e.setActive();
	if (xn) return e.focus(xn);
	let t = [];
	for (let n = e; n && (t.push(n, n.scrollTop, n.scrollLeft), n != n.ownerDocument); n = n.parentNode);
	if (e.focus(xn == null ? { get preventScroll() {
...
function kn(e, t) {
	...
	} else if (n.parentNode && !fn(n)) r = dn(n), n = n.parentNode;
	else return null;
}
function An(e, t) {
	...
	} else if (n.parentNode && !fn(n)) r = dn(n) + 1, n = n.parentNode;
	else return null;
}
var jn = class e {
	constructor(e, t, n = !0) {
...
var Fn = /*@__PURE__*/ Pn("88888888888888888888888888888888888666888888787833333333337888888000000000000000000000000008888880000000000000000000000000088888888888888888888888888888888888887866668888088888663380888308888800000000000000000000000800000000000000000000000000000008"), In = /*@__PURE__*/ Pn("4444448826627288999999999992222222222222222222222222222222222222222222222229999999999999999999994444444444644222822222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222222999999949999999229989999223333333333"), Ln = /*@__PURE__*/ Object.create(null), Rn = [];
for (let e of [
	"()",
	"[]",
	"{}"
...
function zn(e) {
	return e <= 247 ? Fn[e] : 1424 <= e && e <= 1524 ? 2 : 1536 <= e && e <= 1785 ? In[e - 1536] : 1774 <= e && e <= 2220 ? 4 : 8192 <= e && e <= 8204 ? 256 : 64336 <= e && e <= 65023 ? 4 : 1;
}
var Bn = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac\ufb50-\ufdff]/, Vn = class {
	get dir() {
		return this.level % 2 ? Nn : Mn;
	}
	constructor(e, t, n) {
...
function Hn(e, t) {
	...
	for (let n = 0; n < e.length; n++) {
		let r = e[n], i = t[n];
		if (r.from != i.from || r.to != i.to || r.direction != i.direction || !Hn(r.inner, i.inner)) return !1;
	}
	return !0;
}
var B = [];
...
function Wn(e, t, n, r, i) {
	...
	for (let o = 0, s = 0, c = 0; o <= r.length; o++) {
		...
		for (let t = l, n, r, o; t < u; t++) if (r = Ln[n = e.charCodeAt(t)]) if (r < 0) {
			for (let e = s - 3; e >= 0; e -= 3) if (Rn[e + 1] == -r) {
				let n = Rn[e + 2], r = n & 2 ? i : n & 4 ? n & 1 ? a : i : 0;
				r && (B[t] = B[Rn[e]] = r), s = e;
				break;
			}
		} else if (Rn.length == 189) break;
		else Rn[s++] = t, Rn[s++] = n, Rn[s++] = c;
		else if ((o = B[t]) == 2 || o == 1) {
			let e = o == i;
			c = +!e;
...
function Kn(e, t, n, r, i, a, o) {
	...
	if (r % 2 == i % 2) for (let c = t, l = 0; c < n;) {
		...
		run: for (;;) if (l < a.length && p == a[l].from) {
			...
			l++, d ? d.push(m) : (m.from > c && o.push(new Vn(c, m.from, f)), qn(e, m.direction == Mn == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.to), p = m.to;
		} else if (p == n || (t ? B[p] != s : B[p] == s)) break;
		else p++;
		d ? Kn(e, c, p, r + 1, i, d, o) : c < p && o.push(new Vn(c, p, f)), c = p;
	}
		...
		run: for (;;) if (l && p == a[l - 1].to) {
			...
			d ? d.push(m) : (m.to < c && o.push(new Vn(m.to, c, f)), qn(e, m.direction == Mn == !(f % 2) ? r : r + 1, i, m.inner, m.from, m.to, o), c = m.from), p = m.from;
		} else if (p == t || (n ? B[p - 1] != s : B[p - 1] == s)) break;
		else p--;
		d ? Kn(e, p, c, r + 1, i, d, o) : p < c && o.push(new Vn(p, c, f)), c = p;
	}
}
function qn(e, t, n, r, i, a, o) {
	let s = t % 2 ? 2 : 1;
	Un(e, i, a, r, s), Wn(e, i, a, r, s), Gn(i, a, r, s), Kn(e, i, a, t, n, r, o);
}
function Jn(e, t, n) {
	if (!e) return [new Vn(0, 0, +(t == Nn))];
	if (t == Mn && !n.length && !Bn.test(e)) return Yn(e.length);
	if (n.length) for (; e.length > B.length;) B[B.length] = 256;
	let r = [], i = t == Mn ? 0 : 1;
	return qn(e, i, i, n, 0, e.length, r), r;
}
function Yn(e) {
	return [new Vn(0, e, 0)];
}
...
function Zn(e, t, n, r, i) {
	let a = r.head - e.from, o = Vn.find(t, a, r.bidiLevel ?? -1, r.assoc), s = t[o], c = s.side(i, n);
	if (a == c) {
		let e = o += i ? 1 : -1;
	...
	(l < s.from || l > s.to) && (l = c), Xn = e.text.slice(Math.min(a, l), Math.max(a, l));
...
function Qn(e, t, n) {
	for (let r = t; r < n; r++) {
		let t = zn(e.charCodeAt(r));
		if (t == 1) return Mn;
		if (t == 2 || t == 4) return Nn;
	}
	return Mn;
}
var $n = /*@__PURE__*/ E.define(), er = /*@__PURE__*/ E.define(), tr = /*@__PURE__*/ E.define(), nr = /*@__PURE__*/ E.define(), rr = /*@__PURE__*/ E.define(), ir = /*@__PURE__*/ E.define(), ar = /*@__PURE__*/ E.define(), or = /*@__PURE__*/ E.define(), sr = /*@__PURE__*/ E.define(), cr = /*@__PURE__*/ E.define({ combine: (e) => e.some((e) => e) }), lr = /*@__PURE__*/ E.define({ combine: (e) => e.some((e) => e) }), ur = /*@__PURE__*/ E.define(), dr = class e {
...
}, fr = /*@__PURE__*/ O.define({ map: (e, t) => e.map(t) }), pr = /*@__PURE__*/ O.define();
function mr(e, t, n) {
	let r = e.facet(nr);
	r.length ? r[0](t) : window.onerror && window.onerror(String(t), n, void 0, void 0, t) || (n ? console.error(n + ":", t) : console.error(t));
}
var hr = /*@__PURE__*/ E.define({ combine: (e) => !e.length || e[0] }), gr = 0, _r = /*@__PURE__*/ E.define({ combine(e) {
	return e.filter((t, n) => {
	...
	constructor(e, t, n, r, i) {
		this.id = e, this.create = t, this.domEventHandlers = n, this.domEventObservers = r, this.baseExtensions = i(this), this.extension = this.baseExtensions.concat(_r.of({
			plugin: this,
			arg: void 0
		}));
	}
	of(e) {
		return this.baseExtensions.concat(_r.of({
			plugin: this,
			arg: e
		}));
	}
	static define(t, n) {
		...
		return new e(gr++, t, r, i, (e) => {
			let t = [];
			return o && t.push(xr.of((t) => {
				let n = t.plugin(e);
				return n ? o(n) : R.none;
			})), a && t.push(a(e)), t;
		});
	...
	update(e) {
		if (!this.value) {
			...
			if (this.mustUpdate = null, this.value.update) try {
				...
				if (mr(e.state, t, "CodeMirror plugin crashed"), this.value.destroy) try {
					this.value.destroy();
				} catch {}
				this.deactivate();
			}
	...
	destroy(e) {
		if (this.value?.destroy) try {
			...
			mr(e.state, t, "CodeMirror plugin crashed");
		}
	}
	deactivate() {
		this.spec = this.value = null;
	}
}, yr = /*@__PURE__*/ E.define(), br = /*@__PURE__*/ E.define(), xr = /*@__PURE__*/ E.define(), Sr = /*@__PURE__*/ E.define(), Cr = /*@__PURE__*/ E.define(), wr = /*@__PURE__*/ E.define(), Tr = /*@__PURE__*/ E.define();
function Er(e, t) {
	...
	return M.spans(r, t.from, t.to, {
		...
		span(e, n, r, a) {
			...
			for (let e = r.length - 1; e >= 0; e--, a--) {
				...
				if (n ??= Qn(t.text, o, s), a > 0 && c.length && (i = c[c.length - 1]).to == o && i.direction == n) i.to = s, c = i.inner;
				else {
					let e = {
						from: o,
						to: s,
...
var Dr = /*@__PURE__*/ E.define();
function Or(e) {
	let t = 0, n = 0, r = 0, i = 0;
	for (let a of e.state.facet(Dr)) {
		let o = a(e);
...
var kr = /*@__PURE__*/ E.define(), Ar = class e {
	constructor(e, t, n, r) {
	...
	constructor(e, t, n) {
		...
		let r = [];
		this.changes.iterChangedRanges((e, t, n, i) => r.push(new Ar(e, t, n, i))), this.changedRanges = r;
	}
	static create(t, n, r) {
		return new e(t, n, r);
	}
	...
	domPosFor(e, t) {
		...
		return new jn(this.parent.dom, n + +!!r, e == 0 || e == this.length);
	}
	markDirty(e) {
	...
	get root() {
		for (let e = this; e; e = e.parent) if (e instanceof Fr) return e;
		return null;
	}
	static get(e) {
		return e.cmTile;
	...
	sync(e) {
		...
		for (let o of this.children) {
			if (o.sync(e), a += o.length + o.breakAfter, r = n ? n.nextSibling : t.firstChild, i && r != o.dom && (i.written = !0), o.dom.parentNode == t) for (; r && r != o.dom;) r = Pr(r);
			else t.insertBefore(o.dom, r);
			n = o.dom;
		}
		for (r = n ? n.nextSibling : t.firstChild, i && r && (i.written = !0); r;) r = Pr(r);
		this.length = a;
	}
};
function Pr(e) {
...
var Fr = class extends Nr {
	...
	blockTiles(e) {
		for (let t = [], n = this, r = 0, i = 0;;) if (r == n.children.length) {
			...
			let a = n.children[r++];
			if (a instanceof Ir) t.push(r), n = a, r = 0;
			else {
	...
	resolveInline(e, t, n) {
		...
		function s(e, c) {
			for (let l = 0, u = 0; l < e.children.length && u <= c; l++) {
				...
				f >= c && (d.isComposite() ? s(d, c - u) : (!a || a.isHidden && (t > 0 && !(a.flags & 32) || n && zr(a, d))) && (f > c || d.flags & 32) ? (a = d, o = c - u) : (u < c || d.flags & 16 && !d.isHidden) && (r = d, i = c - u)), u = f;
			}
		}
		s(this, e);
		let c = (t < 0 ? r : a) || r || a;
	...
	coordsIn(e, t, n) {
		...
		return r ? r.tile.coordsIn(Math.max(0, r.offset), t, n) : Rr(this);
	}
	domIn(e, t) {
		let n = this.resolveInline(e, t);
		if (n) {
			let { tile: e, offset: r } = n;
			if (this.dom.contains(e.dom)) return e.isText() ? new jn(e.dom, Math.min(e.dom.nodeValue.length, r)) : e.domPosFor(r, e.flags & 16 ? 1 : e.flags & 32 ? -1 : t);
			let i = n.tile.parent, a = !1;
			for (let e of i.children) {
				if (a) return new jn(e.dom, 0);
				e == n.tile && (a = !0);
			}
		}
		return new jn(this.dom, 0);
	}
};
function Rr(e) {
...
var Br = class e extends Nr {
	...
	coordsIn(e, t, n) {
		...
		return I.safari && !o && c.width == 0 && (c = Array.prototype.find.call(s, (e) => e.width) || c), n == null ? c : hn(c, (o ? o > 0 : t < 0) == n);
	}
	static of(t, n) {
	...
	coordsInWidget(e, t, n) {
		...
		if (r) return r;
		if (n) return hn(this.dom.getBoundingClientRect(), this.length ? e == 0 : t <= 0);
		{
	...
	addText(e, t, n, r) {
		...
		if (a && a.isText() && !(a.flags & 8) && a.length + e.length < 512) {
			...
			let t = i.children[i.children.length - 1] = new Vr(a.dom, a.text + e);
			t.parent = i;
		} else i.append(r || Vr.of(e, this.cache.find(Vr)?.dom));
		this.pos += e.length, this.afterWidget = null;
	}
	addComposition(e, t) {
		let n = this.curLine;
		n.dom != t.line.dom && (n.setDOM(this.cache.reused.has(t.line) ? ni(t.line.dom) : t.line.dom), this.cache.reused.set(t.line, 2));
		let r = n;
		for (let e = t.marks.length - 1; e >= 0; e--) {
			let n = t.marks[e], i = r.lastChild;
			if (i instanceof Br && i.mark.eq(n.mark)) i.dom != n.dom && i.setDOM(ni(n.dom)), r = i;
			else {
				if (this.cache.reused.get(n)) {
					let e = H.get(n.dom);
					e && e.setDOM(ni(n.dom));
				}
				let e = Br.of(n.mark, n.dom);
				r.append(e), r = e;
			}
		...
		let a = new Vr(e.text, e.text.nodeValue);
	...
	addLineStart(e, t) {
		e ||= $r;
		let n = Lr.start(e, t || this.cache.find(Lr)?.dom, !!t);
	...
	ensureMarks(e, t) {
		...
		for (let r = e.length - 1; r >= 0; r--) {
			let i = e[r], a;
			if (t > 0 && (a = n.lastChild) && a instanceof Br && a.mark.eq(i)) n = a, t--;
			else {
				let e = Br.of(i, this.cache.find(Br, (e) => e.mark.eq(i))?.dom);
				n.append(e), n = e, t = 0;
			}
		}
		return n;
	...
	endLine() {
		if (this.curLine) {
			...
			(!e || !Zr(this.curLine, !1) || e.dom.nodeName != "BR" && e.isWidget() && !(I.ios && Zr(this.curLine, !0))) && this.curLine.append(this.cache.findWidget(ii, 0, 32) || new Hr(ii.toDOM(), 0, ii, 32)), this.curLine = this.afterWidget = null;
		}
	}
	updateBlockWrappers() {
		...
		for (let e = this.blockWrappers; e.value && e.from <= this.pos; e.next()) if (e.to >= this.pos) {
			let t = e.rank * 102 + e.value.rank, n = new Gr(e.from, e.to, e.value, t), r = this.wrappers.length;
	...
	getBlockPos() {
		...
		for (let t of this.wrappers) {
			let n = e.lastChild;
			if (t.from < this.pos && n instanceof Ir && n.wrapper.eq(t.wrapper)) e = n;
			else {
				let n = Ir.of(t.wrapper, this.cache.find(Ir, (e) => e.wrapper.eq(t.wrapper))?.dom);
				e.append(n), e = n;
			}
		}
		return e;
	...
	getBuffer(e) {
		let t = 2 | (e < 0 ? 16 : 32), n = this.cache.find(Ur, void 0, 1);
		return n && (n.flags = t), n || new Ur(t);
	}
	flushBuffer() {
...
for (let e = 0; e < Jr.length; e++) Jr[e].bucket = e;
var Yr = class {
	constructor(e) {
	...
	findWidget(e, t, n) {
		...
		if (r.length) for (let i = 0, a = 0;; i++) {
			...
			let o = r[i];
			if (!this.reused.has(o) && (a == 0 ? o.widget.compare(e) : o.widget.constructor == e.constructor && e.updateDOM(o.dom, this.view, o.widget))) return r.splice(i, 1), i < this.index[0] && this.index[0]--, o.widget == e && o.length == t && (o.flags & 497) == n ? (this.reused.set(o, 1), o) : (this.reused.set(o, 2), new Hr(o.dom, t, e, o.flags & -498 | n));
		}
	}
	reuse(e) {
	...
	constructor(e, t, n, r, i) {
		this.view = e, this.decorations = r, this.disallowBlockEffectsFor = i, this.openWidget = !1, this.openMarks = 0, this.cache = new Yr(e), this.text = new qr(e.state.doc), this.builder = new Kr(this.cache, new Fr(e, e.contentDOM), M.iter(n)), this.cache.reused.set(t, 2), this.old = new Wr(t), this.reuseWalker = {
			skip: (e, t, n) => {
		...
		this.old.advance(e, n ? 1 : -1, {
			skip: (e, t, n) => {
				if (e.isWidget()) if (this.openWidget) this.builder.continueWidget(n - t);
					...
					let a = n > 0 || t < e.length ? Hr.of(e.widget, this.view, n - t, e.flags & 496, this.cache.maybeReuse(e)) : this.cache.reuse(e);
				...
				else if (e instanceof Ur) this.cache.add(e);
				else if (e instanceof Br) this.builder.ensureLine(null), this.builder.addMark(e, r, i), this.cache.reused.set(e, 1), i = r.length;
				else return !1;
				this.openWidget = !1;
			},
			enter: (e) => {
				e.isLine() ? this.builder.addLineStart(e.attrs, this.cache.maybeReuse(e)) : (this.cache.add(e), e instanceof Br && r.unshift(e.mark)), this.openWidget = !1;
			},
			leave: (e) => {
				e.isLine() ? r.length &&= i = 0 : e instanceof Br && (r.shift(), i = Math.min(i, r.length));
			},
			break: () => {
			...
			point: (e, t, a, o, s, c) => {
				if (a instanceof en) {
					...
					if (i = o.length, s > o.length) r.continueWidget(t - e);
						...
						let i = a.widget || (a.block ? ri.block : ri.inline), c = Qr(a), l = this.cache.findWidget(i, t - e, c) || Hr.of(i, this.view, t - e, c);
	...
	getCompositionContext(e) {
		...
		for (let r = e.parentNode;; r = r.parentNode) {
			...
			e instanceof Br ? t.push(e) : e?.isLine() ? n = e : e instanceof Ir || (r.nodeName == "DIV" && !n && r != this.view.contentDOM ? n = new Lr(r, $r) : n || t.push(Br.of(new Qt({
...
function ei(e, t) {
	...
	return !n && !r ? e : (e ||= { class: "cm-line" }, n && Gt(n, e), r && (e.class += " " + r), e);
}
function ti(e) {
	let t = [];
	for (let n = e.parents.length; n > 1; n--) {
		let r = n == e.parents.length ? e.tile : e.parents[n].tile;
		r instanceof Br && t.push(r.mark);
	}
	return t;
}
function ni(e) {
...
ri.inline = /*@__PURE__*/ new ri("span"), ri.block = /*@__PURE__*/ new ri("div");
var ii = /*@__PURE__*/ new class extends Zt {
	toDOM() {
	...
	update(e) {
		...
		let n = -1;
		this.view.inputState.composing >= 0 && !this.view.observer.editContext && (this.domChanged?.newSel ? n = this.domChanged.newSel.head : !gi(e.changes, this.hasComposition) && !e.selectionSet && (n = e.state.selection.main.head));
		let r = n > -1 ? li(this.view, e.changes, n) : null;
		if (this.domChanged = null, this.hasComposition) {
			let { from: n, to: r } = this.hasComposition;
			t = new Ar(n, r, e.changes.mapPos(n, -1), e.changes.mapPos(r, 1)).addToSet(t.slice());
		}
		this.hasComposition = r ? {
			from: r.range.fromB,
			to: r.range.toB
		} : null, (I.ie || I.chrome) && !r && e && e.state.doc.lines != e.startState.doc.lines && (this.forceSelection = !0);
		let i = this.decorations, a = this.blockWrappers;
		this.updateDeco();
		let o = fi(i, this.decorations, e.changes);
		o.length && (t = Ar.extendWithRanges(t, o));
		let s = mi(a, this.blockWrappers, e.changes);
		return s.length && (t = Ar.extendWithRanges(t, s)), r && !t.some((e) => e.fromA <= r.range.fromA && e.toA >= r.range.toA) && (t = r.range.addToSet(t.slice())), this.tile.flags & 2 && t.length == 0 ? !1 : (this.updateInner(t, r), e.transactions.length && (this.lastUpdate = Date.now()), !0);
	}
	updateInner(e, t) {
		...
		n.ignore(() => {
			if (t || e.length) {
				let n = this.tile, r = new Xr(this.view, n, this.blockWrappers, this.decorations, this.dynamicDecorationMap);
				t && H.get(t.text) && r.cache.reused.set(H.get(t.text), 2), this.tile = r.run(e, t), oi(n, r.cache.reused);
			}
		...
		let r = [];
		if (this.view.viewport.from || this.view.viewport.to < this.view.state.doc.length) for (let e of this.tile.children) e.isWidget() && e.widget instanceof _i && r.push(e.dom);
		n.updateGaps(r);
	}
	updateEditContextFormatting(e) {
		this.editContextFormatting = this.editContextFormatting.map(e.changes);
		for (let t of e.transactions) for (let e of t.effects) e.is(pr) && (this.editContextFormatting = e.value);
	}
	updateSelection(e = !1, t = !1) {
		(e || !this.view.observer.selectionRange.focusNode) && this.view.observer.readSelectionRange();
		let { dom: n } = this.tile, r = this.view.root.activeElement, i = r == n, a = !i && !(this.view.state.facet(hr) || n.tabIndex > -1) && cn(n, this.view.observer.selectionRange) && !(r && n.contains(r));
		if (!(i || t || a)) return;
		let o = this.forceSelection;
		this.forceSelection = !1;
		let s = this.view.state.selection.main, c, l;
		if (s.empty ? l = c = this.inlineDOMNearPos(s.anchor, s.assoc || 1) : (l = this.inlineDOMNearPos(s.head, s.head == s.from ? 1 : -1), c = this.inlineDOMNearPos(s.anchor, s.anchor == s.from ? 1 : -1)), I.gecko && s.empty && !this.hasComposition && si(c)) {
			let e = document.createTextNode("");
			this.view.observer.ignore(() => c.node.insertBefore(e, c.node.childNodes[c.offset] || null)), c = l = new jn(e, 0), o = !0;
		}
		let u = this.view.observer.selectionRange;
		(o || !u.focusNode || (!un(c.node, c.offset, u.anchorNode, u.anchorOffset) || !un(l.node, l.offset, u.focusNode, u.focusOffset)) && !this.suppressWidgetCursorChange(u, s)) && (this.view.observer.ignore(() => {
			I.android && I.chrome && n.contains(u.focusNode) && hi(u.focusNode, n) && (n.blur(), n.focus({ preventScroll: !0 }));
			let e = on(this.view.root);
			if (e) if (s.empty) {
				if (I.gecko) {
					let e = ui(c.node, c.offset);
					if (e && e != 3) {
						let t = (e == 1 ? kn : An)(c.node, c.offset);
						t && (c = new jn(t.node, t.offset));
					}
				}
		...
		}), this.view.observer.setSelectionRange(c, l)), this.impreciseAnchor = c.precise ? null : new jn(u.anchorNode, u.anchorOffset), this.impreciseHead = l.precise ? null : new jn(u.focusNode, u.focusOffset);
	}
	...
	coordsAt(e, t, n) {
		...
		return r.isWidget() ? r.widget instanceof _i ? null : r.coordsInWidget(i, t, !0) : r.coordsIn(i, t, n);
	}
	lineAt(e, t) {
	...
	measureVisibleLineHeights(e) {
		let t = [], { from: n, to: r } = e, i = this.view.contentDOM.clientWidth, a = i > Math.max(this.view.scrollDOM.clientWidth, this.minWidth) + 1, o = -1, s = this.view.textDirection == z.LTR, c = 0, l = (e, u, d) => {
			for (let f = 0; f < e.children.length && !(u > r); f++) {
				...
				if (d && !f && (c += m.top - d.top), r instanceof Ir) p > n && l(r, u, m);
				else if (u >= n && (c > 0 && t.push(-c), t.push(h + c), c = 0, a)) {
					let e = r.dom.lastChild, t = e ? ln(e) : [];
					if (t.length) {
	...
	updateDeco() {
		let e = 1, t = this.view.state.facet(xr).map((t) => (this.dynamicDecorationMap[e++] = typeof t == "function") ? t(this.view) : t), n = !1, r = this.view.state.facet(Cr).map((e, t) => {
		...
		this.blockWrappers = this.view.state.facet(Sr).map((e) => typeof e == "function" ? e(this.view) : e);
	}
	scrollIntoView(e) {
		if (e.isSnapshot) {
		...
		for (let t of this.view.state.facet(ur)) try {
			if (t(this.view, e.range, e)) return !0;
		} catch (e) {
			mr(this.view.state, e, "scroll handler");
		}
		...
		let i = Or(this.view), a = {
			left: n.left - i.left,
			top: n.top - i.top,
			right: n.right + i.right,
			bottom: n.bottom + i.bottom
		}, { offsetWidth: o, offsetHeight: s } = this.view.scrollDOM;
		if (vn(this.view.scrollDOM, a, t.head < t.anchor ? -1 : 1, e.x, e.y, Math.max(Math.min(e.xMargin, o), -o), Math.max(Math.min(e.yMargin, s), -s), this.view.textDirection == z.LTR), window.visualViewport && window.innerHeight - window.visualViewport.height > 1 && (n.top > window.pageYOffset + window.visualViewport.offsetTop + window.visualViewport.height || n.bottom < window.pageYOffset + window.visualViewport.offsetTop)) {
...
function oi(e, t) {
	...
	if (n != 1) {
		n ?? e.destroy();
		for (let n of e.children) oi(n, t);
	}
}
function si(e) {
...
function ci(e, t) {
	...
	let r = kn(n.focusNode, n.focusOffset), i = An(n.focusNode, n.focusOffset), a = r || i;
...
function li(e, t, n) {
	...
	return {
		range: new Ar(c.mapPos(a), c.mapPos(o), a, o),
		text: i
	};
}
function ui(e, t) {
...
function yi(e, t, n, r, i) {
	...
	return n.from + bt(o, a, e.state.tabSize);
}
function bi(e, t, n) {
...
function xi(e, t, n, r) {
	let i = bi(e, t.head, t.assoc || -1), a = !r || i.type != L.Text || !(e.lineWrapping || i.widgetLineBreaks) ? null : e.coordsAtPos(t.assoc < 0 && t.head > i.from ? t.head - 1 : t.head);
	if (a) {
...
function Ei(e, t) {
	...
	for (let r = 0; r < t.ranges.length; r++) {
		...
		if (i.empty) {
			...
			let t = Ti(e, i.from, -1), n = Ti(e, i.to, 1);
...
function Di(e, t, n) {
	let r = Ti(e.state.facet(wr).map((t) => t(e)), n.from, t.head > n.from ? -1 : 1);
...
function ki(e, t, n, r) {
	...
	for (;;) {
		if (c < 0) return new Oi(0, 1);
		if (c > e.viewState.docHeight) return new Oi(e.state.doc.length, -1);
	...
	if (e.viewport.from >= l.to || e.viewport.to <= l.from) {
		...
		if (l.type == L.Text) {
			let t = yi(e, i, l, o, s);
			return new Oi(t, t == l.from ? 1 : -1);
		}
	}
	if (l.type != L.Text) return c < (l.top + l.bottom) / 2 ? new Oi(l.from, 1) : new Oi(l.to, -1);
	let u = e.docView.lineAt(l.from, 2);
	return (!u || u.length != l.length) && (u = e.docView.lineAt(l.from, -2)), new Ai(e, o, s, e.textDirectionAt(l.from)).scanTile(u, l.from);
}
var Ai = class {
	constructor(e, t, n, r) {
	...
	baseDirAt(e, t) {
		...
		return r[Vn.find(r, e - n.from, -1, t)].level == this.baseDir;
	}
	dirAt(e, t) {
		let { line: n, spans: r } = this.bidiSpansAt(e);
		return r[Vn.find(r, e - n.from, -1, t)].dir;
	}
	bidiIn(e, t) {
			...
			if (p) for (let t = 0; t < p.length; t++) {
				...
				if (!(n.width == 0 && p.length > 1)) {
					if (n.bottom < this.y) (!s || s.bottom < n.bottom) && (s = n), a = 1;
						...
						t < u && (l = f, u = t, d = n), e && (a = e < 0 == (this.baseDir == z.LTR) ? -1 : 1);
					}
	...
	scanText(e, t) {
		...
		return r.after ? new Oi(n[r.i + 1], -1) : new Oi(n[r.i], 1);
	}
	scanTile(e, t) {
		if (!e.length) return new Oi(t, 1);
		...
		return i.isText() ? this.scanText(i, a) : i.isComposite() ? this.scanTile(i, a) : r.after ? new Oi(n[r.i + 1], -1) : new Oi(a, 1);
	}
}, ji = "￿", Mi = class {
	constructor(e, t) {
	...
	readRange(e, t) {
		...
		for (let r = e;;) {
			...
			let o = H.get(a);
			(i && o ? i.breakAfter : (i ? i.breakAfter : fn(r)) || fn(a) && (r.nodeName != "BR" || i?.isWidget()) && this.text.length > e) && !Pi(a, t) && this.lineBreak(), r = a;
		}
	...
	findPointInside(e, t) {
		for (let n of this.points) (e.nodeType == 3 ? n.node == e : e.contains(n.node)) && (n.pos = this.text.length + (Ni(e, n.node, n.offset) ? t : 0));
	}
};
function Ni(e, t, n) {
	for (;;) {
...
var Fi = class {
	...
	constructor(e, t, n, r) {
		...
		else if (t > -1 && (this.bounds = Li(e.docView.tile, t, n, 0))) {
			let t = i || a ? [] : Hi(e), n = new Mi(t, e);
			n.readRange(this.bounds.startDOM, this.bounds.endDOM), this.text = n.text, this.newSel = Ui(t, this.bounds.from);
		} else {
			let t = e.observer.selectionRange, n = i && i.node == t.focusNode && i.offset == t.focusOffset || !sn(e.contentDOM, t.focusNode) ? o.main.head : e.docView.posFromDOM(t.focusNode, t.focusOffset), r = a && a.node == t.anchorNode && a.offset == t.anchorOffset || !sn(e.contentDOM, t.anchorNode) ? o.main.anchor : e.docView.posFromDOM(t.anchorNode, t.anchorOffset), s = e.viewport;
...
function Ri(e, t) {
	...
	if (t.bounds) {
		...
		let l = i.doc.sliceString(e, r, ji), u, d;
		!a.empty && a.from >= e && a.to <= r && (t.typeOver || l != t.text) && l.slice(0, a.from - e) == t.text.slice(0, a.from - e) && l.slice(a.to - e) == t.text.slice(u = t.text.length - (l.length - (a.to - e))) ? n = {
			from: a.from,
			to: a.to,
			insert: f.of(t.text.slice(a.from - e, u).split(ji))
		} : (d = Vi(l, t.text, s - e, c)) && (I.chrome && o == 13 && d.toB == d.from + 2 && t.text.slice(d.from, d.toB) == "￿￿" && d.toB--, n = {
			from: e + d.from,
			to: e + d.toA,
			insert: f.of(t.text.slice(d.from, d.toB).split(ji))
		});
	} else r && (!e.hasFocus && i.facet(hr) || Wi(r, a)) && (r = null);
	if (!n && !r) return !1;
	if ((I.mac || I.android) && n && n.from == n.to && n.from == a.head - 1 && /^\. ?$/.test(n.insert.toString()) && e.contentDOM.getAttribute("autocorrect") == "off" ? (r && n.insert.length == 2 && (r = T.single(r.main.anchor - 1, r.main.head - 1)), n = {
		from: n.from,
		to: n.to,
	...
	if (r && !Wi(r, a)) {
		let t = !1, n = "select";
		return e.inputState.lastSelectionTime > Date.now() - 50 && (e.inputState.lastSelectionOrigin == "select" && (t = !0), n = e.inputState.lastSelectionOrigin, n == "select.pointer" && (r = Ei(i.facet(wr).map((t) => t(e)), r))), e.dispatch({
			selection: r,
			scrollIntoView: t,
			userEvent: n
		}), !0;
...
function zi(e, t, n, r = -1) {
	...
	if (I.android && (t.to == i.to && (t.from == i.from || t.from == i.from - 1 && e.state.sliceDoc(t.from, i.from) == " ") && t.insert.length == 1 && t.insert.lines == 2 && Tn(e.contentDOM, "Enter", 13) || (t.from == i.from - 1 && t.to == i.to && t.insert.length == 0 || r == 8 && t.insert.length < t.to - t.from && t.to > i.head) && Tn(e.contentDOM, "Backspace", 8) || t.from == i.from && t.to == i.to + 1 && t.insert.length == 0 && Tn(e.contentDOM, "Delete", 46))) return !0;
	let a = t.insert.toString();
	e.inputState.composing >= 0 && e.inputState.composing++;
	let o, s = () => o ||= Bi(e, t, n);
	return e.state.facet(ir).some((n) => n(e, t.from, t.to, a, s)) || e.dispatch(s()), !0;
}
function Bi(e, t, n) {
	let r, i = e.state, a = i.selection.main, o = -1;
	if (t.from == t.to && t.from < a.from || t.from > a.to) {
		let n = t.from < a.from ? -1 : 1, r = n < 0 ? a.from : a.to, s = Ti(i.facet(wr).map((t) => t(e)), r, n);
		t.from == s && (o = s);
	}
	if (o > -1) r = {
		changes: t,
		...
		if (i.selection.ranges.length > 1 && (e.inputState.composing >= 0 || e.inputState.compositionPendingChange) && t.to <= a.to + 10 && t.to >= a.to - 10) {
			let c = e.state.sliceDoc(t.from, t.to), l, u = n && ci(e, n.main.head);
			if (u) {
...
function Hi(e) {
	...
	return n && (t.push(new Fi(n, r)), (i != n || a != r) && t.push(new Fi(i, a))), t;
}
function Ui(e, t) {
...
var Gi = class {
	...
	ensureHandlers(e) {
		let t = Ji(e), n = this.handlers, r = this.view.contentDOM;
	...
	keydown(e) {
		...
		if (this.tabFocusMode > 0 && e.keyCode != 27 && Zi.indexOf(e.keyCode) < 0 && (this.tabFocusMode = -1), I.android && I.chrome && !e.synthetic && (e.keyCode == 13 || e.keyCode == 8)) return this.view.observer.delayAndroidKey(e.key, e.keyCode), !0;
		if (I.ios && !e.synthetic && !e.altKey && !e.metaKey && (Yi.some((t) => t.keyCode == e.keyCode) && !e.ctrlKey || Xi.indexOf(e.key) > -1 && e.ctrlKey)) {
			let t = {
				ctrlKey: e.ctrlKey,
				altKey: e.altKey,
				metaKey: e.metaKey,
			...
			return t.shiftKey && I.ios && !/^(off|none)$/.test(this.view.contentDOM.autocapitalize) && Ki(this.view.win) && (t.shiftKey = !1), this.pendingIOSKey = {
				key: e.key,
				keyCode: e.keyCode,
				mods: t
	...
	flushIOSKey(e) {
		...
		return !t || t.key == "Enter" && e && e.from < e.to && /^\S+$/.test(e.insert.toString()) ? !1 : (this.pendingIOSKey = void 0, Tn(this.view.contentDOM, t.key, t.keyCode, t.mods));
	}
...
function Ji(e) {
	...
	for (let t of e) {
		...
		if (r) for (let e in r) {
			let i = r[e];
			i && n(e).handlers.push(qi(t.value, i));
		}
		if (i) for (let e in i) {
			let r = i[e];
			r && n(e).observers.push(qi(t.value, r));
		}
	}
	for (let e in oa) n(e).handlers.push(oa[e]);
...
var ta = class {
	constructor(e, t, n, r) {
		this.view = e, this.startEvent = t, this.style = n, this.mustSelect = r, this.scrollSpeed = {
			x: 0,
			y: 0
		}, this.scrolling = -1, this.lastEvent = t, this.scrollParents = yn(e.contentDOM), this.atoms = e.state.facet(wr).map((t) => t(e));
		let i = e.contentDOM.ownerDocument;
		i.addEventListener("mousemove", this.move = this.move.bind(this)), i.addEventListener("mouseup", this.up = this.up.bind(this)), this.extend = t.shiftKey, this.multiple = e.state.facet(j.allowMultipleSelections) && na(e, t), this.dragging = ia(e, t) && ga(t) == 1 ? null : !1;
	}
	start(e) {
	...
	move(e) {
		...
		if (this.dragging || this.dragging == null && ea(this.startEvent, e) < 10) return;
		...
		let s = Or(this.view);
		e.clientX - s.left <= r + Qi ? t = -$i(r - e.clientX) : e.clientX + s.right >= a - Qi && (t = $i(e.clientX - a)), e.clientY - s.top <= i + Qi ? n = -$i(i - e.clientY) : e.clientY + s.bottom >= o - Qi && (n = $i(e.clientY - o)), this.setScrollSpeed(t, n);
	}
	up(e) {
	...
	select(e) {
		let { view: t } = this, n = Ei(this.atoms, this.style.get(e, this.extend, this.multiple));
...
var oa = /*@__PURE__*/ Object.create(null), U = /*@__PURE__*/ Object.create(null), sa = I.ie && I.ie_version < 15 || I.ios && I.webkit_version < 604;
function ca(e) {
	let t = e.dom.parentNode;
	if (!t) return;
	let n = t.appendChild(document.createElement("textarea"));
	n.style.cssText = "position: fixed; left: -10000px; top: 10px", n.focus(), setTimeout(() => {
		e.focus(), n.remove(), ua(e, n.value);
	}, 50);
}
function la(e, t, n) {
...
function ua(e, t) {
	...
	if (Sa != null && n.selection.ranges.every((e) => e.empty) && Sa == a.toString()) {
		let e = -1;
		r = n.changeByRange((r) => {
...
}, oa.keydown = (e, t) => (e.inputState.setSelectionOrigin("select"), t.keyCode == 27 && e.inputState.tabFocusMode != 0 && (e.inputState.tabFocusMode = Date.now() + 2e3), !1), U.touchstart = (e, t) => {
...
var fa = I.ie && I.ie_version <= 11, pa = null, ma = 0, ha = 0;
function ga(e) {
	if (!fa) return e.detail;
	let t = pa, n = ha;
	return pa = e, ha = Date.now(), ma = !t || n > Date.now() - 400 && Math.abs(t.clientX - e.clientX) < 2 && Math.abs(t.clientY - e.clientY) < 2 ? (ma + 1) % 3 : 1;
}
function _a(e, t) {
	let n = e.posAndSideAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = ga(t), i = e.state.selection;
	return {
		update(e) {
		...
		get(t, a, o) {
			let s = e.posAndSideAtCoords({
				x: t.clientX,
				y: t.clientY
			}, !1), c, l = da(e, s.pos, s.assoc, r);
			if (n.pos != s.pos && !a) {
				let t = da(e, n.pos, n.assoc, r), i = Math.min(t.from, l.from), a = Math.max(t.to, l.to);
				l = i < l.from ? T.range(i, a, l.assoc) : T.range(a, i, l.assoc);
			}
			return a ? i.replaceRange(i.main.extend(l.from, l.to, l.assoc)) : o && r == 1 && i.ranges.length > 1 && (c = va(i, s.pos)) ? c : o ? i.addRange(l) : T.create([l]);
		}
	};
}
function va(e, t) {
...
oa.dragstart = (e, t) => {
	...
	let { inputState: r } = e;
	return r.mouseSelection && (r.mouseSelection.dragging = !0), r.draggedContent = n, t.dataTransfer && (t.dataTransfer.setData("Text", la(e.state, sr, e.state.sliceDoc(n.from, n.to))), t.dataTransfer.effectAllowed = "copyMove"), !1;
}, oa.dragend = (e) => (e.inputState.draggedContent = null, !1);
function ya(e, t, n, r) {
	if (n = la(e.state, or, n), !n) return;
	let i = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), { draggedContent: a } = e.inputState, o = r && a && ra(e, t) ? {
		from: a.from,
		to: a.to
	} : null, s = {
		from: i,
...
oa.drop = (e, t) => {
	...
	if (n && n.length) {
		let r = Array(n.length), i = 0, a = () => {
			++i == n.length && ya(e, t, r.filter((e) => e != null).join(e.state.lineBreak), !1);
		};
		...
		if (n) return ya(e, t, n, !0), !0;
	}
	return !1;
}, oa.paste = (e, t) => {
	if (e.state.readOnly) return !0;
	e.observer.flush();
	let n = sa ? null : t.clipboardData;
	return n ? (ua(e, n.getData("text/plain") || n.getData("text/uri-list")), !0) : (ca(e), !1);
};
function ba(e, t) {
...
function xa(e) {
	...
	return {
		text: la(e, sr, t.join(e.lineBreak)),
		ranges: n,
		linewise: r
	};
}
var Sa = null;
oa.copy = oa.cut = (e, t) => {
	if (!cn(e.contentDOM, e.observer.selectionRange)) return !1;
	let { text: n, ranges: r, linewise: i } = xa(e.state);
	if (!n && !i) return !1;
	Sa = i ? n : null, t.type == "cut" && !e.state.readOnly && e.dispatch({
		changes: r,
		scrollIntoView: !0,
		userEvent: "delete.cut"
	});
	let a = sa ? null : t.clipboardData;
	return a ? (a.clearData(), a.setData("text/plain", n), !0) : (ba(e, n), !1);
};
var Ca = /*@__PURE__*/ Be.define();
function wa(e, t) {
	let n = [];
	for (let r of e.facet(ar)) {
		let i = r(e, t);
		i && n.push(i);
	}
...
U.focus = (e) => {
	e.inputState.lastFocusTime = Date.now(), !e.scrollDOM.scrollTop && (e.inputState.lastScrollTop || e.inputState.lastScrollLeft) && (e.scrollDOM.scrollTop = e.inputState.lastScrollTop, e.scrollDOM.scrollLeft = e.inputState.lastScrollLeft), Ta(e);
}, U.blur = (e) => {
	e.observer.clearSelectionRange(), Ta(e);
	...
	let n;
	if (I.chrome && I.android && (n = Yi.find((e) => e.inputType == t.inputType)) && (e.observer.delayAndroidKey(n.key, n.keyCode), n.key == "Backspace" || n.key == "Delete")) {
...
function Da(e) {
	Ea.has(e) || (Ea.add(e), e.addEventListener("copy", () => {}), e.addEventListener("cut", () => {}));
}
var Oa = [
	"pre-wrap",
	"normal",
...
var ja = class {
	...
	refresh(e, t, n, r, i, a) {
		let o = Oa.indexOf(e) > -1, s = Math.abs(t - this.lineHeight) > .3 || this.lineWrapping != o;
	...
	setHeight(e) {
		this.height != e && (Math.abs(this.height - e) > Pa && (ka = !0), this.height = e);
	}
	replace(t, n, r) {
		return e.of(r);
	}
...
Fa.prototype.size = 1;
var La = /*@__PURE__*/ R.replace({}), Ra = class extends Fa {
	constructor(e, t, n) {
		super(e, t), this.deco = n, this.spaceAbove = 0;
	}
	mainBlock(e, t) {
		return new Na(t, this.length, e + this.spaceAbove, this.height - this.spaceAbove, this.deco || 0);
	}
	blockAt(e, t, n, r) {
		return this.spaceAbove && e < n + this.spaceAbove ? new Na(r, 0, n, this.spaceAbove, La) : this.mainBlock(n, r);
	}
	lineAt(e, t, n, r, i) {
	...
	mainBlock(e, t) {
		return new Na(t, this.length, e + this.spaceAbove, this.height - this.spaceAbove, this.breaks);
	}
	replace(t, n, r) {
		let i = r[0];
		return r.length == 1 && (i instanceof e || i instanceof Ba && i.flags & 4) && Math.abs(this.length - i.length) < 10 ? (i instanceof Ba ? i = new e(i.length, this.height, this.spaceAbove) : i.height = this.height, this.outdated || (i.outdated = !1), i) : Fa.of(r);
	}
	updateHeight(e, t = 0, n = !1, r) {
	...
	lineAt(e, t, n, r, i) {
		...
		return new Na(c.from, c.length, Math.max(r, Math.min(d, r + this.height - l)), l, 0);
	}
	forEachLine(e, t, n, r, i, a) {
		...
		for (let l = e, u = r; l <= t;) {
			...
			let r = s + c * t.length;
			a(new Na(t.from, t.length, u, r, 0)), u += r, l = t.to + 1;
		}
	}
	replace(t, n, r) {
		let i = this.length - n;
	...
	updateHeight(t, n = 0, r = !1, i) {
		...
		if (i && i.from <= n + this.length && i.more) {
			...
			for (i.from > n && r.push(new e(i.from - n - 1).updateHeight(t, n)); o <= a && i.more;) {
				...
				n < 0 && (a = -n, n = i.heights[i.index++]), s == -1 ? s = n : Math.abs(n - s) >= Pa && (s = -2);
				let c = new za(e, n, a);
				c.outdated = !1, r.push(c), o += e + 1;
			}
			o <= a && r.push(null, new e(a - o).updateHeight(t, o));
			let c = Fa.of(r);
			return (s < 0 || Math.abs(c.height - this.height) >= Pa || Math.abs(s - this.heightMetrics(t, n).perLine) >= Pa) && (ka = !0), Ia(this, c);
	...
	balanced(e, t) {
		return e.size > 2 * t.size || t.size > 2 * e.size ? Fa.of(this.break ? [
			e,
			null,
			t
...
var Ka = class {
	...
	comparePoint(e, t, n, r) {
		(e < t || n && n.heightRelevant || r && r.heightRelevant) && rn(e, t, this.changes, 5);
	}
};
function qa(e, t) {
...
var Xa = class {
	...
	draw(e, t) {
		return R.replace({ widget: new Za(this.displaySize * (t ? e.scaleY : e.scaleX), t) }).range(this.from, this.to);
	}
}, Za = class extends Zt {
	constructor(e, t) {
	...
	constructor(e, t) {
		this.view = e, this.state = t, this.pixelViewport = {
			...
			top: 0,
			bottom: 0
		}, this.inView = !0, this.paddingTop = 0, this.paddingBottom = 0, this.contentDOMWidth = 0, this.contentDOMHeight = 0, this.editorHeight = 0, this.editorWidth = 0, this.scaleX = 1, this.scaleY = 1, this.scrollOffset = 0, this.scrolledToBottom = !1, this.scrollAnchorPos = 0, this.scrollAnchorHeight = -1, this.scaler = io, this.scrollTarget = null, this.printing = !1, this.mustMeasureContent = !0, this.defaultTextDirection = z.LTR, this.visibleRanges = [], this.mustEnforceCursorAssoc = !1;
		let n = t.facet(br).some((e) => typeof e != "function" && e.class == "cm-lineWrapping");
		this.heightOracle = new ja(n), this.stateDeco = ao(t), this.heightMap = Fa.empty().applyChanges(this.stateDeco, f.empty, this.heightOracle.setDoc(t.doc), [new Ar(0, 0, 0, t.doc.length)]);
	...
	update(e, t = null) {
		...
		let r = e.changedRanges, i = Ar.extendWithRanges(r, Ga(n, this.stateDeco, e ? e.changes : ce.empty(this.state.doc.length))), a = this.heightMap.height, o = this.scrolledToBottom ? null : this.scrollAnchorAt(this.scrollOffset);
		Aa(), this.heightMap = this.heightMap.applyChanges(this.stateDeco, e.startState.doc, this.heightOracle.setDoc(this.state.doc), i), (this.heightMap.height != a || ka) && (e.flags |= 2), o ? (this.scrollAnchorPos = e.changes.mapPos(o.from, -1), this.scrollAnchorHeight = o.top) : (this.scrollAnchorPos = -1, this.scrollAnchorHeight = a);
	...
	measure() {
		...
		let p = yn(this.view.contentDOM, !1).y;
		p != this.scrollParent && (this.scrollParent = p, this.scrollAnchorHeight = -1, this.scrollOffset = 0);
		let m = this.getScrollOffset();
		this.scrollOffset != m && (this.scrollAnchorHeight = -1, this.scrollOffset = m), this.scrolledToBottom = On(this.scrollParent || e.win);
		...
		if ((this.contentDOMWidth != y || this.editorHeight != e.scrollDOM.clientHeight) && (this.contentDOMWidth = o.width, this.editorHeight = e.scrollDOM.clientHeight, c |= 16), s) {
			...
			g > 0 && _ > 0 ? l = Math.max(g, _) : g < 0 && _ < 0 && (l = Math.min(g, _)), Aa();
			for (let n of this.viewports) {
				let i = n.from == this.viewport.from ? t : e.docView.measureVisibleLineHeights(n);
				this.heightMap = (a ? Fa.empty().applyChanges(this.stateDeco, f.empty, this.heightOracle, [new Ar(0, 0, 0, e.state.doc.length)]) : this.heightMap).updateHeight(r, 0, a, new Ma(n.from, i));
			}
			ka && (c |= 2);
		}
	...
	getViewport(e, t) {
		let n = .5 - Math.max(-.5, Math.min(.5, e / 1e3 / 2)), r = this.heightMap, i = this.heightOracle, { visibleTop: a, visibleBottom: o } = this, s = new $a(r.lineAt(a - n * 1e3, W.ByHeight, i, 0, 0).from, r.lineAt(o + (1 - n) * 1e3, W.ByHeight, i, 0, 0).to);
		if (t) {
			let { head: e } = t.range;
			if (e < s.from || e > s.to) {
				let n = Math.min(this.editorHeight, this.pixelViewport.bottom - this.pixelViewport.top), a = r.lineAt(e, W.ByPos, i, 0, 0), o;
				o = t.y == "center" ? (a.top + a.bottom) / 2 - n / 2 : t.y == "start" || t.y == "nearest" && e < s.from ? a.top : a.bottom - n, s = new $a(r.lineAt(o - 1e3 / 2, W.ByHeight, i, 0, 0).from, r.lineAt(o + n + 1e3 / 2, W.ByHeight, i, 0, 0).to);
			}
		}
		return s;
	}
	mapViewport(e, t) {
		...
		return new $a(this.heightMap.lineAt(n, W.ByPos, this.heightOracle, 0, 0).from, this.heightMap.lineAt(r, W.ByPos, this.heightOracle, 0, 0).to);
	}
	...
	updateLineGaps(e) {
		Xa.same(e, this.lineGaps) || (this.lineGaps = e, this.lineGapDeco = R.set(e.map((e) => e.draw(this, this.heightOracle.lineWrapping))));
	}
	...
	lineBlockAt(e) {
		return e >= this.viewport.from && e <= this.viewport.to && this.viewportLines.find((t) => t.from <= e && t.to >= e) || so(this.heightMap.lineAt(e, W.ByPos, this.heightOracle, 0, 0), this.scaler);
	}
	lineBlockAtHeight(e) {
		return e >= this.viewportLines[0].top && e <= this.viewportLines[this.viewportLines.length - 1].bottom && this.viewportLines.find((t) => t.top <= e && t.bottom >= e) || so(this.heightMap.lineAt(this.scaler.fromDOM(e), W.ByHeight, this.heightOracle, 0, 0), this.scaler);
	}
	getScrollOffset() {
...
function ao(e) {
	let t = e.facet(xr).filter((e) => typeof e != "function"), n = e.facet(Cr).filter((e) => typeof e != "function");
...
function so(e, t) {
	...
	return new Na(e.from, e.length, n, r - n, Array.isArray(e._content) ? e._content.map((e) => so(e, t)) : e._content);
}
var co = /*@__PURE__*/ E.define({ combine: (e) => e.join(" ") }), lo = /*@__PURE__*/ E.define({ combine: (e) => e.indexOf(!0) > -1 }), uo = /*@__PURE__*/ Tt.newName(), fo = /*@__PURE__*/ Tt.newName(), po = /*@__PURE__*/ Tt.newName(), mo = {
	"&light": "." + fo,
	"&dark": "." + po
};
function ho(e, t, n) {
	return new Tt(t, { finish(t) {
...
var go = /*@__PURE__*/ ho("." + uo, {
...
}, vo = I.ie && I.ie_version <= 11, yo = class {
	constructor(e) {
		...
		}), window.EditContext && I.android && e.constructor.EDIT_CONTEXT !== !1 && !(I.chrome && I.chrome_version < 126) && (this.editContext = new Co(e), e.state.facet(hr) && (e.contentDOM.editContext = this.editContext.editContext)), vo && (this.onCharData = (e) => {
			this.queue.push({
				target: e.target,
				type: "characterData",
	...
	onSelectionChange(e) {
		...
		if (n.state.facet(hr) ? n.root.activeElement != this.dom : !cn(this.dom, r)) return;
		let i = r.anchorNode && n.docView.tile.nearest(r.anchorNode);
		if (i && i.isWidget() && i.widget.ignoreEvent(e)) {
			t || (this.selectionChanged = !1);
			return;
		}
		(I.ie && I.ie_version <= 11 || I.android && I.chrome) && !n.state.selection.main.empty && r.focusNode && un(r.focusNode, r.focusOffset, r.anchorNode, r.anchorOffset) ? this.flushSoon() : this.flush(!1);
	}
	readSelectionRange() {
		let { view: e } = this, t = on(e.root);
		if (!t) return !1;
		let n = I.safari && e.root.nodeType == 11 && e.root.activeElement == this.dom && So(this.view, t) || t;
		if (!n || this.selectionRange.eq(n)) return !1;
		let r = cn(this.dom, n);
		return r && !this.selectionChanged && e.inputState.lastFocusTime > Date.now() - 200 && e.inputState.lastTouchTime < Date.now() - 300 && Dn(this.dom, n) ? (this.view.inputState.lastFocusTime = 0, e.docView.updateSelection(), !1) : (this.selectionRange.setRange(n), r && (this.selectionChanged = !0), !0);
	}
	...
	delayAndroidKey(e, t) {
		if (!this.delayedAndroidKey) {
			let e = () => {
				...
				e && (this.clearDelayedAndroidKey(), this.view.inputState.lastKeyCode = e.keyCode, this.view.inputState.lastKeyTime = Date.now(), !this.flush() && e.force && Tn(this.dom, e.key, e.keyCode));
			};
	...
	readChange() {
		let { from: e, to: t, typeOver: n } = this.processRecords(), r = this.selectionChanged && cn(this.dom, this.selectionRange);
		if (e < 0 && !r) return null;
		e > -1 && (this.lastChange = Date.now()), this.view.inputState.lastFocusTime = 0, this.selectionChanged = !1;
		let i = new Ii(this.view, e, t, n);
	...
	flush(e = !0) {
		...
		let n = this.view.state, r = Ri(this.view, t);
		return this.view.state == n && (t.domChanged || t.newSel && !Wi(this.view.state.selection, t.newSel.main)) && this.view.update([]), r;
	}
	readMutation(e) {
	...
	update(e) {
		this.editContext && (this.editContext.update(e), e.startState.facet(hr) != e.state.facet(hr) && (e.view.contentDOM.editContext = e.state.facet(hr) ? this.editContext.editContext : null));
	}
	destroy() {
		var e, t, n;
...
function xo(e, t) {
	...
	return un(o.node, o.offset, i, a) && ([n, r, i, a] = [
		i,
		a,
		n,
		r
...
var Co = class {
	constructor(e) {
		...
		this.handlers.textupdate = (n) => {
			...
			let l = Vi(e.state.sliceDoc(o, s), n.text, (c ? r.from : r.to) - o, c ? "end" : null);
			if (!l) {
			...
			if ((I.mac || I.android) && u.from == a - 1 && /^\. ?$/.test(n.text) && e.contentDOM.getAttribute("autocorrect") == "off" && (u = {
				...
				zi(e, u, T.single(this.toEditorPos(n.selectionStart, t), this.toEditorPos(n.selectionEnd, t)));
			}
			...
			e.dispatch({ effects: pr.of(R.set(n)) });
	...
	constructor(e = {}) {
		...
		let { dispatch: t } = e;
		this.dispatchTransactions = e.dispatchTransactions || t && ((e) => e.forEach((e) => t(e, this))) || ((e) => this.update(e)), this.dispatch = this.dispatch.bind(this), this._root = e.root || En(e.parent) || document, this.viewState = new Qa(this, e.state || j.create(e)), e.scrollTo && e.scrollTo.is(fr) && (this.viewState.scrollTarget = e.scrollTo.value.clip(this.viewState.state)), this.plugins = this.state.facet(_r).map((e) => new vr(e));
		for (let e of this.plugins) e.update(this);
		this.observer = new yo(this), this.inputState = new Gi(this), this.inputState.ensureHandlers(this.plugins), this.docView = new ai(this), this.mountStyles(), this.updateAttrs(), this.updateState = 0, this.requestMeasure(), document.fonts?.ready && document.fonts.ready.then(() => {
	...
	update(t) {
		...
		t.some((e) => e.annotation(Ca)) ? (this.inputState.notifiedFocused = o, s = 1) : o != this.inputState.notifiedFocused && (this.inputState.notifiedFocused = o, c = wa(a, o), c || (s = 1));
		...
		i = jr.create(this, a, t), i.flags |= s;
		...
		try {
			...
			for (let n of t) {
				if (d &&= d.map(n.changes), n.scrollIntoView) {
					...
					d = new dr(t.empty ? t : T.cursor(t.head, t.head > t.anchor ? -1 : 1), "nearest", "nearest", i, r);
				}
				for (let e of n.effects) e.is(fr) && (d = e.value.clip(this.state));
			}
			this.viewState.update(i, d), this.bidiCache = Eo.update(this.bidiCache, i.changes), i.empty || (this.updatePlugins(i), this.inputState.update(i)), n = this.docView.update(i), this.state.facet(kr) != this.styleModules && this.mountStyles(), r = this.updateAttrs(), this.showAnnouncements(t), this.docView.updateSelection(n, t.some((e) => e.isUserEvent("select.pointer")));
		} finally {
			this.updateState = 0;
		}
		if (i.startState.facet(co) != i.state.facet(co) && (this.viewState.mustMeasureContent = !0), (n || r || d || this.viewState.mustEnforceCursorAssoc || this.viewState.mustMeasureContent) && this.requestMeasure(), n && this.docViewUpdate(), !i.empty) for (let e of this.state.facet(rr)) try {
			e(i);
		} catch (e) {
			mr(this.state, e, "update listener");
		}
		(c || u) && Promise.resolve().then(() => {
			c && this.state == c.startState && this.dispatch(c), u && !Ri(this, u) && l.force && Tn(this.contentDOM, l.key, l.keyCode);
		});
	}
	setState(e) {
		...
		try {
			...
			this.viewState = new Qa(this, e), this.plugins = e.facet(_r).map((e) => new vr(e)), this.pluginMap.clear();
			for (let e of this.plugins) e.update(this);
			this.docView.destroy(), this.docView = new ai(this), this.inputState.ensureHandlers(this.plugins), this.mountStyles(), this.updateAttrs(), this.bidiCache = [];
		} finally {
			this.updateState = 0;
		}
	...
	updatePlugins(e) {
		let t = e.startState.facet(_r), n = e.state.facet(_r);
		if (t != n) {
			let r = [];
			for (let i of n) {
				let n = t.indexOf(i);
	...
	docViewUpdate() {
		for (let e of this.plugins) {
			...
			if (t && t.docViewUpdate) try {
				...
				mr(this.state, e, "doc view update listener");
			}
		}
	}
	measure(e = !0) {
		...
		try {
			for (let e = 0;; e++) {
				if (a < 0) if (On(n || this.win)) i = -1, a = this.viewState.heightMap.height;
				else {
				...
				let c = s.map((e) => {
					try {
						...
						return mr(this.state, e), To;
					}
				}), l = jr.create(this, this.state, []), u = !1;
		...
		if (t && !t.empty) for (let e of this.state.facet(rr)) e(t);
	}
	get themeClasses() {
		return uo + " " + (this.state.facet(lo) ? po : fo) + " " + this.state.facet(co);
	}
	updateAttrs() {
		let e = Do(this, yr, { class: "cm-editor" + (this.hasFocus ? " cm-focused " : " ") + this.themeClasses }), t = {
			spellcheck: "false",
			autocorrect: "off",
			autocapitalize: "off",
			writingsuggestions: "false",
			translate: "no",
			contenteditable: this.state.facet(hr) ? "true" : "false",
			class: "cm-content",
			style: `${I.tabSize}: ${this.state.tabSize}`,
			role: "textbox",
			"aria-multiline": "true"
		};
		this.state.readOnly && (t["aria-readonly"] = "true"), Do(this, br, t);
		let n = this.observer.ignore(() => {
			let n = Yt(this.contentDOM, this.contentAttrs, t), r = Yt(this.dom, this.editorAttrs, e);
			return n || r;
		});
	...
	mountStyles() {
		...
		Tt.mount(this.root, this.styleModules.concat(go).reverse(), t ? { nonce: t } : void 0);
	}
	readMeasured() {
	...
	moveByChar(e, t, n) {
		return Di(this, e, Si(this, e, t, n));
	}
	moveByGroup(e, t) {
		return Di(this, e, Si(this, e, t, (t) => Ci(this, e.head, t)));
	}
	visualLineSide(e, t) {
	...
	moveVertically(e, t, n) {
		return Di(this, e, wi(this, e, t, n));
	}
	domAtPos(e, t = 1) {
	...
	posAndSideAtCoords(e, t = !0) {
		return this.readMeasured(), ki(this, e, t);
	}
	coordsAtPos(e, t = 1) {
		this.readMeasured();
		let n = this.state.doc.lineAt(e), r = this.bidiSpans(n), i = r[Vn.find(r, e - n.from, -1, t)];
	...
	textDirectionAt(e) {
		return !this.state.facet(cr) || e < this.viewport.from || e > this.viewport.to ? this.textDirection : (this.readMeasured(), this.docView.textDirectionAt(e));
	}
	get lineWrapping() {
		return this.viewState.heightOracle.lineWrapping;
	}
	bidiSpans(e) {
		if (e.length > wo) return Yn(e.length);
		let t = this.textDirectionAt(e.from), n;
		for (let r of this.bidiCache) if (r.from == e.from && r.dir == t && (r.fresh || Hn(r.isolates, n = Er(this, e)))) return r.order;
		n ||= Er(this, e);
		let r = Jn(e.text, t, n);
		return this.bidiCache.push(new Eo(e.from, e.to, t, n, !0, r)), r;
	}
	get hasFocus() {
		return (this.dom.ownerDocument.hasFocus() || I.safari && this.inputState?.lastContextMenu > Date.now() - 3e4) && this.root.activeElement == this.contentDOM;
	}
	focus() {
		this.observer.ignore(() => {
			Sn(this.contentDOM), this.docView.updateSelection();
		});
	}
	setRoot(e) {
	...
	static scrollIntoView(e, t = {}) {
		return fr.of(new dr(typeof e == "number" ? T.cursor(e) : e, t.y ?? "nearest", t.x ?? "nearest", t.yMargin ?? 5, t.xMargin ?? 5));
	}
	scrollSnapshot() {
		let { scrollTop: e, scrollLeft: t } = this.scrollDOM, n = this.viewState.scrollAnchorAt(e);
		return fr.of(new dr(T.cursor(n.from), "start", "start", n.top - e, t, !0));
	}
	setTabFocusMode(e) {
	...
	static theme(e, t) {
		let n = Tt.newName(), r = [co.of(n), kr.of(ho(`.${n}`, e))];
		return t && t.dark && r.push(lo.of(!0)), r;
	}
	static baseTheme(e) {
		return Te.lowest(kr.of(ho("." + uo, e, mo)));
	}
...
G.styleModule = kr, G.inputHandler = ir, G.clipboardInputFilter = or, G.clipboardOutputFilter = sr, G.scrollHandler = ur, G.focusChangeEffect = ar, G.perLineTextDirection = cr, G.exceptionSink = nr, G.updateListener = rr, G.editable = hr, G.mouseSelectionStyle = tr, G.dragMovesSelection = er, G.clickAddsSelectionRange = $n, G.decorations = xr, G.blockWrappers = Sr, G.outerDecorations = Cr, G.atomicRanges = wr, G.bidiIsolatedRanges = Tr, G.cursorScrollMargin = /*@__PURE__*/ E.define({ combine: (e) => {
	let t = 5, n = 5;
...
} }), G.scrollMargins = Dr, G.darkTheme = lo, G.cspNonce = /*@__PURE__*/ E.define({ combine: (e) => e.length ? e[0] : "" }), G.contentAttributes = br, G.editorAttributes = yr, G.lineWrapping = /*@__PURE__*/ G.contentAttributes.of({ class: "cm-lineWrapping" }), G.announce = /*@__PURE__*/ O.define();
...
var Oo = I.mac ? "mac" : I.windows ? "win" : I.linux ? "linux" : "key";
function ko(e, t) {
...
var jo = /*@__PURE__*/ Te.default(/*@__PURE__*/ G.domEventHandlers({ keydown(e, t) {
	return Bo(Po(t.state), e, t, "editor");
} })), Mo = /*@__PURE__*/ E.define({ enables: jo }), No = /*@__PURE__*/ new WeakMap();
function Po(e) {
	let t = e.facet(Mo), n = No.get(t);
	return n || No.set(t, n = Ro(t.reduce((e, t) => e.concat(t), []))), n;
}
function Fo(e, t, n) {
	return Bo(Po(e.state), t, e, n);
}
var Io = null, Lo = 4e3;
function Ro(e, t = Oo) {
	...
	for (let r of e) {
		...
		if (r.any) for (let t of e) {
			...
			let { any: i } = r;
			for (let t in e) e[t].run.push((e) => i(e, zo));
		}
		let i = r[t] || r.key;
...
function Bo(e, t, n, r) {
	zo = t;
	let i = Nt(t), a = ae(S(i, 0)) == i.length && i != " ", o = "", s = !1, c = !1, l = !1;
	Io && Io.view == n && Io.scope == r && (o = Io.prefix + " ", Zi.indexOf(t.keyCode) < 0 && (c = !0, Io = null));
	...
	return f && (d(f[o + Ao(i, t, !a)]) ? s = !0 : a && (t.altKey || t.metaKey || t.ctrlKey) && !(I.windows && t.ctrlKey && t.altKey) && !(I.mac && t.altKey && !(t.ctrlKey || t.metaKey)) && (p = Ot[t.keyCode]) && p != i ? (d(f[o + Ao(p, t, !0)]) || t.shiftKey && (m = kt[t.keyCode]) != i && m != p && d(f[o + Ao(m, t, !1)])) && (s = !0) : a && t.shiftKey && d(f[o + Ao(i, t, !0)]) && (s = !0), !s && d(f._any) && (s = !0)), c && (s = !0), s && l && t.stopPropagation(), zo = null, s;
}
var Vo = class e {
	constructor(e, t, n, r, i) {
...
function Wo(e, t, n) {
	...
	let r = Math.max(n.from, e.viewport.from), i = Math.min(n.to, e.viewport.to), a = e.textDirection == z.LTR, o = e.contentDOM, s = o.getBoundingClientRect(), c = Ho(e), l = o.querySelector(".cm-line"), u = l && window.getComputedStyle(l), d = s.left + (u ? parseInt(u.paddingLeft) + Math.min(0, parseInt(u.textIndent)) : 0), f = s.right - (u ? parseInt(u.paddingRight) : 0), p = bi(e, r, 1), m = bi(e, i, -1), h = p.type == L.Text ? p : null, g = m.type == L.Text ? m : null;
	if (h && (e.lineWrapping || p.widgetLineBreaks) && (h = Uo(e, r, 1, h)), g && (e.lineWrapping || m.widgetLineBreaks) && (g = Uo(e, i, -1, g)), h && g && h.from == g.from && h.to == g.to) return v(y(n.from, n.to, h));
	{
	...
	function _(e, n, r, i) {
		return new Vo(t, e - c.left, n - c.top, Math.max(0, r - e), i - n);
	}
...
var Ko = class {
	...
	update(e) {
		e.startState.facet(qo) != e.state.facet(qo) && this.setOrder(e.state), (this.layer.update(e, this.dom) || e.geometryChanged) && (this.scale(), e.view.requestMeasure(this.measureReq));
	}
	docViewUpdate(e) {
		this.layer.updateOnDocViewUpdate !== !1 && e.requestMeasure(this.measureReq);
	}
	setOrder(e) {
		let t = 0, n = e.facet(qo);
	...
	draw(e) {
		if (e.length != this.drawn.length || e.some((e, t) => !Go(e, this.drawn[t]))) {
...
}, qo = /*@__PURE__*/ E.define();
function Jo(e) {
	return [V.define((t) => new Ko(t, e)), qo.of(e)];
}
var Yo = /*@__PURE__*/ E.define({ combine(e) {
	return tt(e, {
...
function Zo(e) {
	return e.startState.facet(Yo) != e.state.facet(Yo);
}
var Qo = /*@__PURE__*/ Jo({
	above: !0,
	markers(e) {
		let { state: t } = e, n = t.facet(Yo), r = [];
		for (let i of t.selection.ranges) {
			...
			if (i.empty || n.drawRangeCursor && !(a && I.ios && n.iosSelectionHandles)) {
				...
				for (let i of Vo.forRange(e, t, n)) r.push(i);
			}
		}
		return r;
	},
	update(e, t) {
		...
		let n = Zo(e);
		return n && $o(e.state, t), e.docChanged || e.selectionSet || n;
	},
	mount(e, t) {
		$o(t.state, e);
	},
...
function $o(e, t) {
	t.style.animationDuration = e.facet(Yo).cursorBlinkRate + "ms";
}
var es = /*@__PURE__*/ Jo({
	above: !1,
	markers(e) {
		let t = [], { main: n, ranges: r } = e.state.selection;
		for (let n of r) if (!n.empty) for (let r of Vo.forRange(e, "cm-selectionBackground", n)) t.push(r);
		if (I.ios && !n.empty && e.state.facet(Yo).iosSelectionHandles) {
			for (let r of Vo.forRange(e, "cm-selectionHandle cm-selectionHandle-start", T.cursor(n.from, 1))) t.push(r);
			for (let r of Vo.forRange(e, "cm-selectionHandle cm-selectionHandle-end", T.cursor(n.to, 1))) t.push(r);
		}
		return t;
	},
	update(e, t) {
		return e.docChanged || e.selectionSet || e.viewportChanged || Zo(e);
	},
	class: "cm-selectionLayer"
}), ts = /*@__PURE__*/ Te.highest(/*@__PURE__*/ G.theme({
	".cm-line": {
...
})), ns = /*@__PURE__*/ O.define({ map(e, t) {
	return e == null ? null : t.mapPos(e);
} }), rs = /*@__PURE__*/ D.define({
	create() {
		return null;
	},
	update(e, t) {
		return e != null && (e = t.changes.mapPos(e)), t.effects.reduce((e, t) => t.is(ns) ? t.value : e, e);
	}
}), is = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
	...
	update(e) {
		var t;
		let n = e.state.field(rs);
		n == null ? this.cursor != null && ((t = this.cursor) == null || t.remove(), this.cursor = null) : (this.cursor || (this.cursor = this.view.scrollDOM.appendChild(document.createElement("div")), this.cursor.className = "cm-dropCursor"), (e.startState.field(rs) != n || e.docChanged || e.geometryChanged) && this.view.requestMeasure(this.measureReq));
	}
	readPos() {
		let { view: e } = this, t = e.state.field(rs), n = t != null && e.coordsAtPos(t);
		if (!n) return null;
	...
	setDropPos(e) {
		this.view.state.field(rs) != e && this.view.dispatch({ effects: ns.of(e) });
	}
}, { eventObservers: {
	dragover(e) {
...
var cs = class {
	...
	createDeco(e) {
		let t = new ct(), n = t.add.bind(t);
		for (let { from: t, to: r } of ss(e, this.maxLength)) os(e.state.doc, this.regexp, t, r, (t, r) => this.addMatch(r, e, t, n));
		return t.finish();
	}
	updateDeco(e, t) {
		let n = 1e9, r = -1;
	...
	updateRange(e, t, n, r) {
		for (let i of e.visibleRanges) {
			...
			if (o >= a) {
				...
				else os(e.state.doc, this.regexp, s, c, (t, n) => this.addMatch(n, e, t, d));
				t = t.update({
					filterFrom: s,
					filterTo: c,
					filter: (e, t) => e < s || t > c,
...
}, ls = /x/.unicode == null ? "g" : "gu", us = /*@__PURE__*/ RegExp("[\0-\b\n--­؜​‎‏\u2028\u2029‭‮⁦⁧⁩﻿￹-￼]", ls), ds = {
	0: "null",
	7: "bell",
	8: "backspace",
	10: "newline",
...
function ps() {
	if (fs == null && typeof document < "u" && document.body) {
		let e = document.body.style;
		fs = (e.tabSize ?? e.MozTabSize) != null;
	}
	return fs || !1;
}
var ms = /*@__PURE__*/ E.define({ combine(e) {
	let t = tt(e, {
		render: null,
		specialChars: us,
		addSpecialChars: null
	});
	return (t.replaceTabs = !ps()) && (t.specialChars = RegExp("	|" + t.specialChars.source, ls)), t.addSpecialChars && (t.specialChars = RegExp(t.specialChars.source + "|" + t.addSpecialChars.source, ls)), t;
} });
function hs(e = {}) {
	return [ms.of(e), _s()];
}
var gs = null;
function _s() {
	return gs ||= V.fromClass(class {
		constructor(e) {
			this.view = e, this.decorations = R.none, this.decorationCache = Object.create(null), this.decorator = this.makeDecorator(e.state.facet(ms)), this.decorations = this.decorator.createDeco(e);
		}
		makeDecorator(e) {
			return new cs({
				regexp: e.specialChars,
				decoration: (t, n, r) => {
					let { doc: i } = n.state, a = S(t[0], 0);
					if (a == 9) {
						let e = i.lineAt(r), t = n.state.tabSize, a = yt(e.text, t, r - e.from);
						return R.replace({ widget: new xs((t - a % t) * this.view.defaultCharacterWidth / this.view.scaleX) });
					}
					return this.decorationCache[a] || (this.decorationCache[a] = R.replace({ widget: new bs(e, a) }));
				},
				boundary: e.replaceTabs ? void 0 : /[^]/
			});
		}
		update(e) {
			let t = e.state.facet(ms);
			e.startState.facet(ms) == t ? this.decorations = this.decorator.updateDeco(e, this.decorations) : (this.decorator = this.makeDecorator(t), this.decorations = this.decorator.createDeco(e.view));
		}
	}, { decorations: (e) => e.decorations });
}
var vs = "•";
function ys(e) {
	return e >= 32 ? vs : e == 10 ? "␤" : String.fromCharCode(9216 + e);
}
var bs = class extends Zt {
	constructor(e, t) {
	...
	toDOM(e) {
		let t = ys(this.code), n = e.state.phrase("Control character") + " " + (ds[this.code] || "0x" + this.code.toString(16)), r = this.options.render && this.options.render(this.code, n, t);
		if (r) return r;
...
var Cs = /*@__PURE__*/ R.line({ class: "cm-activeLine" }), ws = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
	...
	getDeco(e) {
		...
		for (let r of e.state.selection.ranges) {
			...
			i.from > t && (n.push(Cs.range(i.from)), t = i.from);
		}
		return R.set(n);
	}
}, { decorations: (e) => e.decorations }), Ts = 2e3;
function Es(e, t, n) {
	let r = Math.min(t.line, n.line), i = Math.max(t.line, n.line), a = [];
	if (t.off > Ts || n.off > Ts || t.col < 0 || n.col < 0) {
		...
		for (let t = r; t <= i; t++) {
			let n = e.doc.line(t), r = bt(n.text, o, e.tabSize, !0);
			if (r < 0) a.push(T.cursor(n.to));
			else {
				let t = bt(n.text, s, e.tabSize);
...
function Os(e, t) {
	let n = e.posAtCoords({
		x: t.clientX,
		y: t.clientY
	}, !1), r = e.state.doc.lineAt(n), i = n - r.from, a = i > Ts ? -1 : i == r.length ? Ds(e, t.clientX) : yt(r.text, e.state.tabSize, n - r.from);
	return {
		line: r.number,
		col: a,
		off: i
...
function ks(e, t) {
	let n = Os(e, t), r = e.state.selection;
	return n ? {
		update(e) {
			if (e.docChanged) {
...
function As(e) {
	...
	return G.mouseSelectionStyle.of((e, n) => t(n) ? ks(e, n) : null);
}
var js = {
	Alt: [18, (e) => !!e.altKey],
	...
	Meta: [91, (e) => !!e.metaKey]
}, Ms = { style: "cursor: crosshair" };
function Ns(e = {}) {
	let [t, n] = js[e.key || "Alt"], r = V.fromClass(class {
		constructor(e) {
	...
	return [r, G.contentAttributes.of((e) => e.plugin(r)?.isDown ? Ms : null)];
}
var Ps = "-10000px", Fs = class {
	constructor(e, t, n, r) {
...
var Ls = /*@__PURE__*/ E.define({ combine: (e) => ({
	position: I.ios ? "absolute" : e.find((e) => e.position)?.position || "fixed",
	parent: e.find((e) => e.parent)?.parent || null,
	tooltipSpace: e.find((e) => e.tooltipSpace)?.tooltipSpace || Is
}) }), Rs = /*@__PURE__*/ new WeakMap(), zs = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		...
		this.position = t.position, this.parent = t.parent, this.classes = e.themeClasses, this.createContainer(), this.measureReq = {
			...
			key: this
		}, this.resizeObserver = typeof ResizeObserver == "function" ? new ResizeObserver(() => this.measureSoon()) : null, this.manager = new Fs(e, Us, (e, t) => this.createTooltip(e, t), (e) => {
	...
	update(e) {
		...
		let n = t || e.geometryChanged, r = e.state.facet(Ls);
	...
	createTooltip(e, t) {
		...
		return n.dom.style.position = this.position, n.dom.style.top = Ps, n.dom.style.left = "0px", this.container.insertBefore(n.dom, r), n.mount && n.mount(this.view), this.resizeObserver && this.resizeObserver.observe(n.dom), n;
	}
	destroy() {
		var e, t, n;
	...
	readMeasure() {
		...
		let r = this.view.scrollDOM.getBoundingClientRect(), i = Or(this.view);
		return {
			visible: {
				left: r.left + i.left,
				top: r.top + i.top,
	...
	writeMeasure(e) {
		...
		for (let o = 0; o < this.manager.tooltips.length; o++) {
			...
			let f = s.arrow ? c.dom.querySelector(".cm-tooltip-arrow") : null, p = f ? 7 : 0, m = d.right - d.left, h = Rs.get(c) ?? d.bottom - d.top, g = c.offset || Hs, _ = this.view.textDirection == z.LTR, v = d.width > n.right - n.left ? _ ? n.left : n.right - d.width : _ ? Math.max(n.left, Math.min(u.left - (f ? 14 : 0) + g.x, n.right - m)) : Math.min(Math.max(n.left, u.left - m + (f ? 14 : 0) - g.x), n.right - m), y = this.above[o];
			...
			if (ee < h && c.resize !== !1) {
				...
				Rs.set(c, h), l.style.height = (h = ee) / i + "px";
			} else l.style.height && (l.style.height = "");
			let te = y ? u.top - h - p - g.y : u.bottom + p + g.y, b = v + m;
			if (c.overlap !== !0) for (let e of a) e.left < b && e.right > v && e.top < te + h && e.bottom > te && (te = y ? e.top - h - 2 - p : e.bottom + p + 2);
			if (this.position == "absolute" ? (l.style.top = (te - e.parent.top) / i + "px", Bs(l, (v - e.parent.left) / r)) : (l.style.top = te / i + "px", Bs(l, v / r)), f) {
	...
	maybeMeasure() {
		if (this.manager.tooltips.length && (this.view.inView && this.view.requestMeasure(this.measureReq), this.inView != this.view.inView && (this.inView = this.view.inView, !this.inView))) for (let e of this.manager.tooltipViews) e.dom.style.top = Ps;
	}
...
var Vs = /*@__PURE__*/ G.baseTheme({
	...
	x: 0,
	y: 0
}, Us = /*@__PURE__*/ E.define({ enables: [zs, Vs] }), Ws = /*@__PURE__*/ E.define({ combine: (e) => e.reduce((e, t) => e.concat(t), []) }), Gs = class e {
	static create(t) {
		return new e(t);
	}
	constructor(e) {
		this.view = e, this.mounted = !1, this.dom = document.createElement("div"), this.dom.classList.add("cm-tooltip-hover"), this.manager = new Fs(e, Ws, (e, t) => this.createHostedView(e, t), (e) => e.dom.remove());
	}
	...
	activateHover(e, t, n, r) {
		...
		if (i && "then" in i) {
			...
			}, (t) => mr(e.state, t, "hover tooltip"));
		} else a(i);
	}
	get tooltip() {
		let e = this.view.plugin(zs), t = e ? e.manager.tooltips.findIndex((e) => e.create == Gs.create) : -1;
	...
	mousemove(e) {
		...
		if (t.length && !this.locked.has(t) && n && !Xs(n.dom, e) || this.pending) {
			let { pos: n } = t[0] || this.pending, r = t[0]?.end ?? n;
			(n == r ? this.view.posAtCoords(this.lastMove) != n : !Zs(this.view, n, r, e.clientX, e.clientY)) && (this.view.dispatch({ effects: this.setHover.of([]) }), this.pending = null);
		}
	}
	mouseleave(e) {
...
function Xs(e, t) {
	...
	return t.clientX >= n - Ys && t.clientX <= r + Ys && t.clientY >= i - Ys && t.clientY <= a + Ys;
}
...
function Qs(e, t = {}) {
	let n = O.define(), r = /* @__PURE__ */ new WeakMap(), i = D.define({
		create() {
			return [];
		},
		update(e, a) {
			...
			if (e.length && (t.hideOnChange && (a.docChanged || a.selection) || o && o(a) ? e = [] : t.hideOn && (e = e.filter((e) => !t.hideOn(a, e)))), a.docChanged && e.length) {
				let t = [];
				for (let n of e) {
					let e = a.changes.mapPos(n.pos, -1, C.TrackDel);
					if (e != null) {
		...
		provide: (e) => Ws.from(e)
	}), a = V.define((a) => new Js(a, e, i, r, n, t.hoverTime || 300));
	return {
		active: i,
		extension: [
			i,
...
function $s(e, t, n, r = {}) {
	let i = e.state.facet(qs).map((t) => e.plugin(t)).filter((e) => !!e);
...
var tc = /*@__PURE__*/ O.define(), nc = /*@__PURE__*/ E.define({ combine(e) {
	let t, n;
...
function rc(e, t) {
	let n = e.plugin(ic), r = n ? n.specs.indexOf(t) : -1;
	return r > -1 ? n.panels[r] : null;
}
var ic = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.input = e.state.facet(sc), this.specs = this.input.filter((e) => e), this.panels = this.specs.map((t) => t(e));
...
var sc = /*@__PURE__*/ E.define({ enables: ic });
function cc(e, t) {
	let n, r = new Promise((e) => n = e), i = (e) => fc(e, t, n);
	e.state.field(lc, !1) ? e.dispatch({ effects: uc.of(i) }) : e.dispatch({ effects: O.appendConfig.of(lc.init(() => [i])) });
	let a = dc.of(i);
	return {
		close: a,
		result: r.then((t) => ((e.win.queueMicrotask || ((t) => e.win.setTimeout(t, 10)))(() => {
			e.state.field(lc).indexOf(i) > -1 && e.dispatch({ effects: a });
		}), t))
	};
}
var lc = /*@__PURE__*/ D.define({
	create() {
		return [];
	},
	update(e, t) {
		for (let n of t.effects) n.is(uc) ? e = [n.value].concat(e) : n.is(dc) && (e = e.filter((e) => e != n.value));
		return e;
	},
	provide: (e) => sc.computeN([e], (t) => t.field(e))
}), uc = /*@__PURE__*/ O.define(), dc = /*@__PURE__*/ O.define();
function fc(e, t, n) {
...
pc.prototype.elementClass = "", pc.prototype.toDOM = void 0, pc.prototype.mapMode = C.TrackBefore, pc.prototype.startSide = pc.prototype.endSide = -1, pc.prototype.point = !0;
var mc = /*@__PURE__*/ E.define(), hc = /*@__PURE__*/ E.define(), gc = {
	class: "",
...
var yc = /*@__PURE__*/ E.define({ combine: (e) => e.some((e) => e) });
function bc(e) {
	let t = [xc];
	return e && e.fixed === !1 && t.push(yc.of(!0)), t;
}
var xc = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.view = e, this.domAfter = null, this.prevViewport = e.viewport, this.dom = document.createElement("div"), this.dom.className = "cm-gutters cm-gutters-before", this.dom.setAttribute("aria-hidden", "true"), this.dom.style.minHeight = this.view.contentHeight / this.view.scaleY + "px", this.gutters = e.state.facet(_c).map((t) => new Tc(e, t)), this.fixed = !e.state.facet(yc);
	...
	update(e) {
		...
		this.view.state.facet(yc) != !this.fixed && (this.fixed = !this.fixed, this.dom.style.position = this.fixed ? "sticky" : "", this.domAfter && (this.domAfter.style.position = this.fixed ? "sticky" : "")), this.prevViewport = e.view.viewport;
	}
	syncGutters(e) {
		let t = this.dom.nextSibling;
		e && (this.dom.remove(), this.domAfter && this.domAfter.remove());
		let n = M.iter(this.view.state.facet(mc), this.view.viewport.from), r = [], i = this.gutters.map((e) => new wc(e, this.view.viewport, -this.view.documentPadding.top));
	...
	updateGutters(e) {
		let t = e.startState.facet(_c), n = e.state.facet(_c), r = e.docChanged || e.heightChanged || e.viewportChanged || !M.eq(e.startState.facet(mc), e.state.facet(mc), e.view.viewport.from, e.view.viewport.to);
		if (t == n) for (let t of this.gutters) t.update(e) && (r = !0);
			...
			for (let r of n) {
				let n = t.indexOf(r);
				n < 0 ? i.push(new Tc(this.view, r)) : (this.gutters[n].update(e), i.push(this.gutters[n]));
			}
...
var wc = class {
	...
	line(e, t, n) {
		let r = [];
		Cc(this.cursor, r, t.from), n.length && (r = r.concat(n));
	...
	constructor(e, t) {
		...
		this.markers = Sc(t.markers(e)), t.initialSpacer && (this.spacer = new Ec(e, 0, 0, [t.initialSpacer(e)]), this.dom.appendChild(this.spacer.dom), this.spacer.dom.style.cssText += "visibility: hidden; pointer-events: none");
	}
	update(e) {
		let t = this.markers;
		if (this.markers = Sc(this.config.markers(e.view)), this.spacer && this.config.updateSpacer) {
	...
	update(e, t, n, r) {
		this.height != t && (this.height = t, this.dom.style.height = t + "px"), this.above != n && (this.dom.style.marginTop = (this.above = n) ? n + "px" : ""), Dc(this.markers, r) || this.setMarkers(e, r);
	}
	setMarkers(e, t) {
...
var Oc = /*@__PURE__*/ E.define(), kc = /*@__PURE__*/ E.define(), Ac = /*@__PURE__*/ E.define({ combine(e) {
	return tt(e, {
		formatNumber: String,
		domEventHandlers: {}
...
function Mc(e, t) {
	return e.state.facet(Ac).formatNumber(t, e.state);
}
var Nc = /*@__PURE__*/ _c.compute([Ac], (e) => ({
	class: "cm-lineNumbers",
	renderEmptyElements: !1,
	markers(e) {
		return e.state.facet(Oc);
	},
	lineMarker(e, t, n) {
		return n.some((e) => e.toDOM) ? null : new jc(Mc(e, e.state.doc.lineAt(t.from).number));
	},
	widgetMarker: (e, t, n) => {
		for (let r of e.state.facet(kc)) {
			let i = r(e, t, n);
			if (i) return i;
		}
		return null;
	...
	initialSpacer(e) {
		return new jc(Mc(e, Fc(e.state.doc.lines)));
	},
	updateSpacer(e, t) {
		let n = Mc(t.view, Fc(t.view.state.doc.lines));
		return n == e.number ? e : new jc(n);
	},
	domEventHandlers: e.facet(Ac).domEventHandlers,
	side: "before"
}));
function Pc(e = {}) {
	return [
...
var Ic = /*@__PURE__*/ new class extends pc {
	constructor() {
		super(...arguments), this.elementClass = "cm-activeLineGutter";
	}
}(), Lc = /*@__PURE__*/ mc.compute(["selection"], (e) => {
	let t = [], n = -1;
	for (let r of e.selection.ranges) {
		let i = e.doc.lineAt(r.head).from;
		i > n && (n = i, t.push(Ic.range(i)));
	}
	return M.of(t);
});
function Rc() {
...
var zc = 1024, Bc = 0, Vc = class {
	constructor(e, t) {
		this.from = e, this.to = t;
	}
}, K = class {
	constructor(e = {}) {
		this.id = Bc++, this.perNode = !!e.perNode, this.deserialize = e.deserialize || (() => {
	...
	add(e) {
		...
		return typeof e != "function" && (e = Wc.match(e)), (t) => {
			let n = e(t);
...
}, Uc = Object.create(null), Wc = class e {
	constructor(e, t, n, r = 0) {
		this.name = e, this.props = t, this.id = n, this.flags = r;
	}
	static define(t) {
		let n = t.props && t.props.length ? Object.create(null) : Uc, r = !!t.top | (t.skipped ? 2 : 0) | (t.error ? 4 : 0) | (t.name == null ? 8 : 0), i = new e(t.name || "", n, t.id, r);
		if (t.props) {
...
Wc.none = new Wc("", Object.create(null), 0, 8);
var Gc = class e {
	constructor(e) {
		this.types = e;
	...
	extend(...t) {
		...
		for (let e of this.types) {
			...
			n.push(r ? new Wc(e.name, r, e.id, e.flags) : e);
		}
		return new e(n);
	}
}, Kc = /* @__PURE__ */ new WeakMap(), qc = /* @__PURE__ */ new WeakMap(), q;
(function(e) {
...
var J = class e {
	...
	cursor(e = 0) {
		return new sl(this.topNode, e);
	}
	cursorAt(e, t = 0, n = 0) {
		let r = new sl(Kc.get(this) || this.topNode);
		return r.moveTo(e, t), Kc.set(this, r._tree), r;
	}
	get topNode() {
		return new $c(this, 0, 0, null);
	}
	resolve(e, t = 0) {
		let n = Zc(Kc.get(this) || this.topNode, e, t, !1);
		return Kc.set(this, n), n;
	}
	resolveInner(e, t = 0) {
		let n = Zc(qc.get(this) || this.topNode, e, t, !0);
		return qc.set(this, n), n;
	}
	resolveStack(e, t = 0) {
		return ol(this, e, t);
	}
	...
	balance(t = {}) {
		return this.children.length <= 8 ? this : fl(Wc.none, this.children, this.positions, 0, this.children.length, 0, this.length, (t, n, r) => new e(this.type, t, n, r, this.propValues), t.makeTree || ((t, n, r) => new e(Wc.none, t, n, r)));
	}
	static build(e) {
		return ll(e);
	}
};
J.empty = new J(Wc.none, [], [], 0);
var Jc = class e {
	constructor(e, t) {
	...
	findChild(e, t, n, r, i) {
		...
		for (let s = e; s != t && !(Xc(i, r, a[s + 1], a[s + 2]) && (o = s, n > 0)); s = a[s + 3]);
		return o;
	}
	slice(t, n, r) {
...
function Zc(e, t, n, r) {
	for (; e.from == e.to || (n < 1 ? e.from >= t : e.from > t) || (n > -1 ? e.to <= t : e.to < t);) {
		let t = !r && e instanceof $c && e.index < 0 ? null : e.parent;
		if (!t) return e;
		e = t;
	}
	let i = r ? 0 : q.IgnoreOverlays;
	if (r) for (let r = e, a = r.parent; a; r = a, a = r.parent) r instanceof $c && r.index < 0 && a.enter(t, n, i)?.from != r.from && (e = a);
	for (;;) {
		let r = e.enter(t, n, i);
		if (!r) return e;
		e = r;
...
var Qc = class {
	...
	nextChild(t, n, r, i, a = 0) {
		for (let o = this;;) {
			for (let { children: s, positions: c } = o._tree, l = n > 0 ? s.length : -1; t != l; t += n) {
				...
				if (!(!(a & q.EnterBracketed && l instanceof J && (d = Hc.get(l)) && !d.overlay && d.bracketed && r >= u && r <= u + l.length) && !Xc(i, r, u, u + l.length))) {
					if (l instanceof Yc) {
						if (a & q.ExcludeBuffers) continue;
						let e = l.findChild(0, l.buffer.length, n, r - u, i);
						if (e > -1) return new rl(new nl(o, l, t, u), null, e);
					} else if (a & q.IncludeAnonymous || !l.type.isAnonymous || cl(l)) {
						let s;
						if (!(a & q.IgnoreMounts) && (s = Hc.get(l)) && !s.overlay) return new e(s.tree, u, t, o);
						let c = new e(l, u, t, o);
	...
	enter(t, n, r = 0) {
		let i;
		if (!(r & q.IgnoreOverlays) && (i = Hc.get(this._tree)) && i.overlay) {
...
function il(e) {
	...
	let r = n instanceof $c && n.index < 0 ? null : n.parent, i = e.slice();
...
var al = class {
	...
	get next() {
		return il(this.heads);
	}
};
function ol(e, t, n) {
	let r = e.resolveInner(t, n), i = null;
	for (let e = r instanceof $c ? r : r.context.parent; e; e = e.parent) if (e.index < 0) {
		let a = e.parent;
		(i ||= [r]).push(a.resolve(t, n)), e = a;
	} else {
		let a = Hc.get(e.tree);
		if (a && a.overlay && a.overlay[0].from <= t && a.overlay[a.overlay.length - 1].to >= t) {
			let o = new $c(a.tree, a.overlay[0].from + e.from, -1, e);
			(i ||= [r]).push(Zc(o, t, n, !1));
		}
	}
	return i ? il(i) : r;
...
var sl = class {
	...
	constructor(e, t = 0) {
		if (this.buffer = null, this.stack = [], this.index = 0, this.bufferNode = null, this.mode = t & ~q.EnterBracketed, e instanceof $c) this.yieldNode(e);
		else {
	...
	yield(e) {
		return e ? e instanceof $c ? (this.buffer = null, this.yieldNode(e)) : (this.buffer = e.context, this.yieldBuf(e.index, e.type)) : !1;
	}
	toString() {
	...
	atLastNode(e) {
		...
		for (; n; {index: t, _parent: n} = n) if (t > -1) for (let r = t + e, i = e < 0 ? -1 : n._tree.children.length; r != i; r += e) {
			...
			if (this.mode & q.IncludeAnonymous || e instanceof Yc || !e.type.isAnonymous || cl(e)) return !1;
		}
		return !0;
	}
	move(e, t) {
	...
	get node() {
		...
		for (let e = n; e < this.stack.length; e++) t = new rl(this.buffer, t, this.stack[e]);
		return this.bufferNode = new rl(this.buffer, t, this.index);
	}
	get tree() {
...
function cl(e) {
	return e.children.some((e) => e instanceof Yc || !e.type.isAnonymous || cl(e));
}
function ll(e) {
	let { buffer: t, nodeSet: n, maxBufferLength: r = zc, reused: i = [], minRepeatType: a = n.types.length } = e, o = Array.isArray(t) ? new Jc(t, t.length) : t, s = n.types, c = 0, l = 0;
	function u(e, t, _, v, y, ee) {
		let { id: te, start: b, end: x, size: ne } = o, re = l, S = c;
		if (ne < 0) if (o.next(), ne == -1) {
			let t = i[te];
			_.push(t), v.push(b - e);
			return;
		} else if (ne == -3) {
			...
			l = te;
			return;
		} else throw RangeError(`Unrecognized record size: ${ne}`);
		let ie = s[te], ae, oe, C = b - e;
		if (x - b <= r && (oe = h(o.pos - t, y))) {
			let t = new Uint16Array(oe.size - oe.skip), r = o.pos - oe.size, i = t.length;
			for (; o.pos > r;) i = g(oe.start, t, i);
			ae = new Yc(t, x - oe.start, n), C = oe.start - e;
		} else {
			let e = o.pos - ne;
			o.next();
			let t = [], n = [], i = te >= a ? te : -1, s = 0, c = x;
			for (; o.pos > e;) i >= 0 && o.id == i && o.size >= 0 ? (o.end <= c - r && (p(t, n, b, s, o.end, c, i, re, S), s = t.length, c = o.end), o.next()) : ee > 2500 ? d(b, e, t, n) : u(b, e, t, n, i, ee + 1);
			if (i >= 0 && s > 0 && s < t.length && p(t, n, b, s, b, c, i, re, S), t.reverse(), n.reverse(), i > -1 && s > 0) {
				let e = f(ie, S);
				ae = fl(ie, t, n, 0, t.length, 0, x - b, e, e);
			} else ae = m(ie, t, n, x - b, re - x, S);
		}
		_.push(ae), v.push(C);
	}
	function d(e, t, i, a) {
		...
		if (c) {
			...
			i.push(new Yc(t, s[2] - r, n)), a.push(r - e);
		}
	}
	function f(e, t) {
		return (n, r, i) => {
	...
	return new J(s[e.topID], _.reverse(), v.reverse(), y);
}
var ul = /* @__PURE__ */ new WeakMap();
function dl(e, t) {
	if (!e.isAnonymous || t instanceof Yc || t.type != e) return 1;
	let n = ul.get(t);
	if (n == null) {
		n = 1;
...
function fl(e, t, n, r, i, a, o, s, c) {
	let l = 0;
	for (let n = r; n < i; n++) l += dl(e, t[n]);
	let u = Math.ceil(l * 1.5 / 8), d = [], f = [];
	function p(t, n, r, i, o) {
		for (let s = r; s < i;) {
			let r = s, l = n[s], m = dl(e, t[s]);
			for (s++; s < i; s++) {
				let n = dl(e, t[s]);
				if (m + n >= u) break;
				m += n;
			...
			if (s == r + 1) {
				...
				d.push(fl(e, t, n, r, s, l, i, null, c));
			}
			f.push(l + o - a);
		}
	}
...
var pl = class {
	...
	set(e, t) {
		e instanceof rl ? this.setBuffer(e.context.buffer, e.index, t) : e instanceof $c && this.map.set(e.tree, t);
	}
	get(e) {
		return e instanceof rl ? this.getBuffer(e.context.buffer, e.index) : e instanceof $c ? this.map.get(e.tree) : void 0;
	}
	cursorSet(e, t) {
	...
	startParse(e, t, n) {
		return typeof e == "string" && (e = new gl(e)), n = n ? n.length ? n.map((e) => new Vc(e.from, e.to)) : [new Vc(0, 0)] : [new Vc(0, e.length)], this.createParse(e, t || [], n);
	}
	parse(e, t, n) {
...
var _l = 0, vl = class e {
	constructor(e, t, n, r) {
		this.name = e, this.set = t, this.base = n, this.modified = r, this.id = _l++;
	}
	toString() {
		let { name: e } = this;
	...
	static defineModifier(e) {
		let t = new bl(e);
		return (e) => e.modified.indexOf(t) > -1 ? e : bl.get(e.base || e, e.modified.concat(t).sort((e, t) => e.id - t.id));
	}
}, yl = 0, bl = class e {
	constructor(e) {
		this.name = e, this.instances = [], this.id = yl++;
	}
	static get(t, n) {
		if (!n.length) return t;
		let r = n[0].instances.find((e) => e.base == t && xl(n, e.modified));
		if (r) return r;
...
function Cl(e) {
	...
	for (let n in e) {
		...
		for (let e of n.split(" ")) if (e) {
			...
			t[s] = new Tl(r, i, o > 0 ? n.slice(0, o) : null).sort(t[s]);
		}
	}
	return wl.add(t);
}
var wl = new K({ combine(e, t) {
	let n, r, i;
	for (; e || t;) {
		if (!e || t && e.depth >= t.depth ? (i = t, t = t.next) : (i = e, e = e.next), n && n.mode == i.mode && !i.context && !n.context) continue;
		let a = new Tl(i.tags, i.mode, i.context);
		n ? n.next = a : r = a, n = a;
	}
	return r;
} }), Tl = class {
...
function Ol(e, t, n, r = 0, i = e.length) {
	let a = new kl(r, Array.isArray(t) ? t : [t], n);
...
var kl = class {
	...
	highlightRange(e, t, n, r, i) {
		...
		let c = r, l = Al(e) || Tl.empty, u = Dl(i, l.tags);
...
function Al(e) {
	let t = e.type.prop(wl);
	for (; t && t.context && !e.matchContext(t.context);) t = t.next;
	return t || null;
}
var Y = vl.define, jl = Y(), Ml = Y(), Nl = Y(Ml), Pl = Y(Ml), Fl = Y(), Il = Y(Fl), Ll = Y(Fl), Rl = Y(), zl = Y(Rl), Bl = Y(), Vl = Y(), Hl = Y(), Ul = Y(Hl), Wl = Y(), X = {
	comment: jl,
	lineComment: Y(jl),
	blockComment: Y(jl),
	docComment: Y(jl),
	...
	unit: Y(Bl),
	modifier: Y(Bl),
	operatorKeyword: Y(Bl),
	controlKeyword: Y(Bl),
	definitionKeyword: Y(Bl),
	moduleKeyword: Y(Bl),
	operator: Vl,
	derefOperator: Y(Vl),
	arithmeticOperator: Y(Vl),
	logicOperator: Y(Vl),
	bitwiseOperator: Y(Vl),
	compareOperator: Y(Vl),
	updateOperator: Y(Vl),
	definitionOperator: Y(Vl),
	typeOperator: Y(Vl),
	controlOperator: Y(Vl),
	punctuation: Hl,
	separator: Y(Hl),
	bracket: Ul,
	angleBracket: Y(Ul),
...
var Gl = /*@__PURE__*/ new K();
function Kl(e) {
	return E.define({ combine: e ? (t) => t.concat(e) : void 0 });
}
var ql = /*@__PURE__*/ new K(), Jl = class {
	constructor(e, t, n = [], r = "") {
		this.data = e, this.name = r, j.prototype.hasOwnProperty("tree") || Object.defineProperty(j.prototype, "tree", { get() {
			return Z(this);
		} }), this.parser = t, this.extension = [au.of(this), j.languageData.of((e, t, n) => {
			let r = Yl(e, t, n), i = r.type.prop(Gl);
			if (!i) return [];
			let a = e.facet(i), o = r.type.prop(ql);
			if (o) {
	...
	isActiveAt(e, t, n = -1) {
		return Yl(e, t, n).type.prop(Gl) == this.data;
	}
	findRegions(e) {
		let t = e.facet(au);
		...
		let n = [], r = (e, t) => {
			...
			for (let n = 0; n < e.children.length; n++) {
				let i = e.children[n];
				i instanceof J && r(i, e.positions[n] + t);
			}
		};
		return r(Z(e), 0), n;
	}
...
Jl.setState = /*@__PURE__*/ O.define();
function Yl(e, t, n) {
	let r = e.facet(au), i = Z(e).topNode;
	if (!r || r.allowsNesting) for (let e = i; e; e = e.enter(t, n, q.ExcludeBuffers | q.EnterBracketed)) e.type.isTop && (i = e);
	return i;
}
var Xl = class e extends Jl {
	constructor(e, t, n) {
		super(e, t, [], n), this.parser = t;
	}
	static define(t) {
		let n = Kl(t.languageData);
		return new e(n, t.parser.configure({ props: [Gl.add((e) => e.isTop ? n : void 0)] }), t.name);
	}
	configure(t, n) {
...
var Zl = class {
	...
	startParse() {
		return this.parser.startParse(new Zl(this.state.doc), this.fragments);
	}
	work(e, t) {
		return t != null && t >= this.state.doc.length && (t = void 0), this.tree != J.empty && this.isDone(t ?? this.state.doc.length) ? (this.takeTree(), !0) : this.withContext(() => {
			...
			for (this.parse ||= this.startParse(), t != null && (this.parse.stoppedAt == null || this.parse.stoppedAt > t) && t < this.state.doc.length && this.parse.stopAt(t);;) {
				...
				if (n) if (this.fragments = this.withoutTempSkipped(ml.addTree(n, this.fragments, this.parse.stoppedAt != null)), this.treeLen = this.parse.stoppedAt ?? this.state.doc.length, this.tree = n, this.parse = null, this.treeLen < (t ?? this.state.doc.length)) this.parse = this.startParse();
				else return !0;
				if (e()) return !1;
			}
		});
	...
	takeTree() {
		...
		}), this.treeLen = e, this.tree = t, this.fragments = this.withoutTempSkipped(ml.addTree(this.tree, this.fragments, !0)), this.parse = null);
	}
	withContext(e) {
		let t = Ql;
		Ql = this;
	...
	withoutTempSkipped(e) {
		for (let t; t = this.tempSkipped.pop();) e = eu(e, t.from, t.to);
		return e;
	}
	changes(t, n) {
		...
		if (this.takeTree(), !t.empty) {
			...
			if (t.iterChangedRanges((t, n, r, i) => e.push({
				...
				fromB: r,
				toB: i
			})), r = ml.applyChanges(r, e), i = J.empty, a = 0, o = {
	...
	updateViewport(e) {
		...
		for (let t = 0; t < this.skipped.length; t++) {
			...
			n < e.to && r > e.from && (this.fragments = eu(this.fragments, n, r), this.skipped.splice(t--, 1));
		}
			...
			createParse(t, n, r) {
				...
				return {
					...
					advance() {
						...
						return this.parsedPos = a, new J(Wc.none, [], [], a - i);
					},
					stoppedAt: null,
					stopAt() {}
				};
...
var tu = class e {
	...
	static init(t) {
		let n = Math.min(3e3, t.doc.length), r = $l.create(t.facet(au).parser, t, {
			from: 0,
			to: n
		});
...
Jl.state = /*@__PURE__*/ D.define({
	create: tu.init,
	update(e, t) {
		for (let e of t.effects) if (e.is(Jl.setState)) return e.value;
		return t.startState.facet(au) == t.state.facet(au) ? e.apply(t) : tu.init(t.state);
	}
});
var nu = (e) => {
...
typeof requestIdleCallback < "u" && (nu = (e) => {
	let t = -1, n = setTimeout(() => {
		t = requestIdleCallback(e, { timeout: 400 });
	}, 100);
	return () => t < 0 ? clearTimeout(n) : cancelIdleCallback(t);
});
var ru = typeof navigator < "u" && navigator.scheduling?.isInputPending ? () => navigator.scheduling.isInputPending() : null, iu = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.view = e, this.working = null, this.workScheduled = 0, this.chunkEnd = -1, this.chunkBudget = -1, this.work = this.work.bind(this), this.scheduleWork();
	}
	update(e) {
		let t = this.view.state.field(Jl.state).context;
		(t.updateViewport(e.view.viewport) || this.view.viewport.to > t.treeLen) && this.scheduleWork(), (e.docChanged || e.selectionSet) && (this.view.hasFocus && (this.chunkBudget += 50), this.scheduleWork()), this.checkAsyncSchedule(t);
	}
	scheduleWork() {
		if (this.working) return;
		let { state: e } = this.view, t = e.field(Jl.state);
		(t.tree != t.context.tree || !t.context.isDone(e.doc.length)) && (this.working = nu(this.work));
	}
	work(e) {
		this.working = null;
		let t = Date.now();
		if (this.chunkEnd < t && (this.chunkEnd < 0 || this.view.hasFocus) && (this.chunkEnd = t + 3e4, this.chunkBudget = 3e3), this.chunkBudget <= 0) return;
		let { state: n, viewport: { to: r } } = this.view, i = n.field(Jl.state);
		if (i.tree == i.context.tree && i.context.isDone(r + 1e5)) return;
		let a = Date.now() + Math.min(this.chunkBudget, 100, e && !ru ? Math.max(25, e.timeRemaining() - 5) : 1e9), o = i.context.treeLen < r && n.doc.length > r + 1e3, s = i.context.work(() => ru && ru() || Date.now() > a, r + (o ? 0 : 1e5));
		this.chunkBudget -= Date.now() - t, (s || this.chunkBudget <= 0) && (i.context.takeTree(), this.view.dispatch({ effects: Jl.setState.of(new tu(i.context)) })), this.chunkBudget > 0 && !(s && !o) && this.scheduleWork(), this.checkAsyncSchedule(i.context);
	}
	checkAsyncSchedule(e) {
		e.scheduleOn &&= (this.workScheduled++, e.scheduleOn.then(() => this.scheduleWork()).catch((e) => mr(this.view.state, e)).then(() => this.workScheduled--), null);
	}
	destroy() {
...
}, su = /*@__PURE__*/ E.define(), cu = /*@__PURE__*/ E.define({ combine: (e) => {
	if (!e.length) return "  ";
	let t = e[0];
...
function uu(e, t) {
	let n = "", r = e.tabSize, i = e.facet(cu)[0];
	if (i == "	") {
		for (; t >= r;) n += "	", t -= r;
		i = " ";
	}
...
function du(e, t) {
	e instanceof j && (e = new fu(e));
	for (let n of e.state.facet(su)) {
		let r = n(e, t);
		if (r !== void 0) return r;
	}
	let n = Z(e.state);
	return n.length >= t ? mu(e, n, t) : null;
}
var fu = class {
	constructor(e, t = {}) {
	...
	countColumn(e, t = e.length) {
		return yt(e, this.state.tabSize, t);
	}
	lineIndent(e, t = 1) {
...
var yu = class e extends fu {
	...
	continue() {
		return hu(this.context.next, this.base, this.pos);
	}
};
function bu(e, t) {
...
function Su({ closing: e, align: t = !0, units: n = 1 }) {
	return (r) => Cu(r, t, n, e);
}
function Cu(e, t, n, r, i) {
	let a = e.textAfter, o = a.match(/^\s*/)[0].length, s = r && a.slice(o, o + r.length) == r || i == e.pos + o, c = t ? xu(e) : null;
...
function Tu() {
	return j.transactionFilter.of((e) => {
		...
		for (let { head: e } of o.selection.ranges) {
			...
			let n = du(o, t.from);
			if (n == null) continue;
			let r = /^\s*/.exec(t.text)[0], i = uu(o, n);
			r != i && c.push({
				from: t.from,
				to: t.from + r.length,
				insert: i
...
var Eu = /*@__PURE__*/ E.define(), Du = /*@__PURE__*/ new K();
function Ou(e) {
...
function ku(e, t, n) {
	...
	for (let o = i; o; o = o.next) {
		...
		if (a && i.from < t) break;
		let s = i.type.prop(Du);
		if (s && (i.to < r.length - 50 || r.length == e.doc.length || !Au(i))) {
			let r = s(i, e);
...
var Nu = /*@__PURE__*/ O.define({ map: Mu }), Pu = /*@__PURE__*/ O.define({ map: Mu });
function Fu(e) {
	let t = [];
	for (let { head: n } of e.state.selection.ranges) t.some((e) => e.from <= n && e.to >= n) || t.push(e.lineBlockAt(n));
	return t;
}
var Iu = /*@__PURE__*/ D.define({
	create() {
		return R.none;
	},
	update(e, t) {
		t.isUserEvent("delete") && t.changes.iterChangedRanges((t, n) => e = Lu(e, t, n)), e = e.map(t.changes);
		let n = [];
		for (let r of t.effects) r.is(Nu) && !zu(e, r.value.from, r.value.to) ? n.push(r.value) : r.is(Pu) && (e = e.update({
			filter: (e, t) => r.value.from != e || r.value.to != t,
			filterFrom: r.value.from,
			filterTo: r.value.to
		}));
		if (n.length) {
			let { preparePlaceholder: r } = t.state.facet(Ku), i = n.map((e) => (r ? R.replace({ widget: new Xu(r(t.state, e)) }) : Yu).range(e.from, e.to));
			e = e.update({ add: i });
		}
		return t.selection && (e = Lu(e, t.selection.main.head)), e;
	},
...
function Ru(e, t, n) {
	var r;
	let i = null;
	return (r = e.field(Iu, !1)) == null || r.between(t, n, (e, t) => {
		(!i || i.from > e) && (i = {
			from: e,
			to: t
		});
...
function Bu(e, t) {
	return e.field(Iu, !1) ? t : t.concat(O.appendConfig.of(qu()));
}
var Vu = (e) => {
	for (let t of Fu(e)) {
		let n = ju(e.state, t.from, t.to);
		if (n) return e.dispatch({ effects: Bu(e.state, [Nu.of(n), Uu(e, n)]) }), !0;
	}
	return !1;
}, Hu = (e) => {
	if (!e.state.field(Iu, !1)) return !1;
	let t = [];
	for (let n of Fu(e)) {
		let r = Ru(e.state, n.from, n.to);
		r && t.push(Pu.of(r), Uu(e, r, !1));
	}
...
var Wu = [
	...
	},
	{
		...
		run: (e) => {
			...
			for (let r = 0; r < t.doc.length;) {
				let i = e.lineBlockAt(r), a = ju(t, i.from, i.to);
				a && n.push(Nu.of(a)), r = (a ? e.lineBlockAt(a.to) : i).to + 1;
			}
			return n.length && e.dispatch({ effects: Bu(e.state, n) }), !!n.length;
		}
	},
	{
		key: "Ctrl-Alt-]",
		run: (e) => {
			let t = e.state.field(Iu, !1);
	...
	placeholderText: "…"
}, Ku = /*@__PURE__*/ E.define({ combine(e) {
	return tt(e, Gu);
} });
function qu(e) {
	let t = [Iu, ed];
	return e && t.push(Ku.of(e)), t;
}
function Ju(e, t) {
	let { state: n } = e, r = n.facet(Ku), i = (t) => {
		let n = e.lineBlockAt(e.posAtDOM(t.target)), r = Ru(e.state, n.from, n.to);
		r && e.dispatch({ effects: Pu.of(r) }), t.preventDefault();
	};
...
var Yu = /*@__PURE__*/ R.replace({ widget: /*@__PURE__*/ new class extends Zt {
	toDOM(e) {
		return Ju(e, null);
	}
}() }), Xu = class extends Zt {
...
function $u(e = {}) {
	let t = {
		...Zu,
		...e
	}, n = new Qu(t, !0), r = new Qu(t, !1), i = V.fromClass(class {
		constructor(e) {
			this.from = e.viewport.from, this.markers = this.buildMarkers(e);
		}
		update(e) {
			(e.docChanged || e.viewportChanged || e.startState.facet(au) != e.state.facet(au) || e.startState.field(Iu, !1) != e.state.field(Iu, !1) || Z(e.startState) != Z(e.state) || t.foldingChanged(e)) && (this.markers = this.buildMarkers(e.view));
		}
		buildMarkers(e) {
			let t = new ct();
			for (let i of e.viewportLineBlocks) {
				let a = Ru(e.state, i.from, i.to) ? r : ju(e.state, i.from, i.to) ? n : null;
	...
	return [
		...
		vc({
			class: "cm-foldGutter",
			markers(e) {
				return e.plugin(i)?.markers || M.empty;
			},
			initialSpacer() {
				return new Qu(t, !1);
			},
			domEventHandlers: {
				...
				click: (e, t, n) => {
					...
					let r = Ru(e.state, t.from, t.to);
					if (r) return e.dispatch({ effects: Pu.of(r) }), !0;
					let i = ju(e.state, t.from, t.to);
					return i ? (e.dispatch({ effects: Nu.of(i) }), !0) : !1;
				}
			}
		}),
		qu()
...
var ed = /*@__PURE__*/ G.baseTheme({
	...
	constructor(e, t) {
		...
		this.scope = a instanceof Jl ? (e) => e.prop(Gl) == a.data : a ? (e) => e == a : void 0, this.style = El(e.map((e) => ({
			tag: e.tag,
			class: e.class || r(Object.assign({}, e, { tag: null }))
		})), { all: i }).style, this.module = n ? new Tt(n) : null, this.themeType = t.themeType;
	}
	static define(t, n) {
		return new e(t, n || {});
	}
}, nd = /*@__PURE__*/ E.define(), rd = /*@__PURE__*/ E.define({ combine(e) {
	return e.length ? [e[0]] : null;
} });
function id(e) {
	let t = e.facet(nd);
	return t.length ? t : e.facet(rd);
}
function ad(e, t) {
	let n = [sd], r;
	return e instanceof td && (e.module && n.push(G.styleModule.of(e.module)), r = e.themeType), t?.fallback ? n.push(rd.of(e)) : r ? n.push(nd.computeN([G.darkTheme], (t) => t.facet(G.darkTheme) == (r == "dark") ? [e] : [])) : n.push(nd.of(e)), n;
}
var od = class {
	constructor(e) {
		this.markCache = Object.create(null), this.tree = Z(e.state), this.decorations = this.buildDeco(e, id(e.state)), this.decoratedTo = e.viewport.to;
	}
	update(e) {
		let t = Z(e.state), n = id(e.state), r = n != id(e.startState), { viewport: i } = e.view, a = e.changes.mapPos(this.decoratedTo, 1);
	...
	buildDeco(e, t) {
		...
		let n = new ct();
		for (let { from: r, to: i } of e.visibleRanges) Ol(this.tree, t, (e, t, r) => {
			n.add(e, t, this.markCache[r] || (this.markCache[r] = R.mark({ class: r })));
		}, r, i);
		return n.finish();
	}
}, sd = /*@__PURE__*/ Te.high(/*@__PURE__*/ V.fromClass(od, { decorations: (e) => e.decorations })), cd = /*@__PURE__*/ td.define([
	{
		tag: X.meta,
		color: "#404740"
	},
...
]), ld = /*@__PURE__*/ G.baseTheme({
	"&.cm-focused .cm-matchingBracket": { backgroundColor: "#328c8252" },
	"&.cm-focused .cm-nonmatchingBracket": { backgroundColor: "#bb555544" }
}), ud = 1e4, dd = "()[]{}", fd = /*@__PURE__*/ E.define({ combine(e) {
	return tt(e, {
		afterCursor: !0,
		brackets: dd,
		maxScanDistance: ud,
...
} }), pd = /*@__PURE__*/ R.mark({ class: "cm-matchingBracket" }), md = /*@__PURE__*/ R.mark({ class: "cm-nonmatchingBracket" });
function hd(e) {
	let t = [], n = e.matched ? pd : md;
...
function gd(e) {
	...
	for (let r of e.selection.ranges) {
		if (!r.empty) continue;
		let i = Sd(e, r.head, -1, n) || r.head > 0 && Sd(e, r.head - 1, 1, n) || n.afterCursor && (Sd(e, r.head, 1, n) || r.head < e.doc.length && Sd(e, r.head + 1, -1, n));
		i && (t = t.concat(n.renderMatch(i, e)));
	}
	return R.set(t, !0);
}
var _d = [/* @__PURE__ */ V.fromClass(class {
	constructor(e) {
		this.paused = !1, this.decorations = gd(e.state);
	}
	update(e) {
		(e.docChanged || e.selectionSet || this.paused) && (e.view.composing ? (this.decorations = this.decorations.map(e.changes), this.paused = !0) : (this.decorations = gd(e.state), this.paused = !1));
	}
}, { decorations: (e) => e.decorations }), ld];
function vd(e = {}) {
	return [fd.of(e), _d];
}
var yd = /*@__PURE__*/ new K();
function bd(e, t, n) {
...
function Sd(e, t, n, r = {}) {
	let i = r.maxScanDistance || ud, a = r.brackets || dd, o = Z(e), s = o.resolveInner(t, n);
	for (let r = s; r; r = r.parent) {
		let i = bd(r.type, n, a);
		if (i && r.from < r.to) {
			let o = xd(r);
			if (o && (n > 0 ? t >= o.from && t < o.to : t > o.from && t <= o.to)) return Cd(e, t, n, r, o, i, a);
		}
	}
...
var Td = /*@__PURE__*/ Object.create(null), Ed = [Wc.none], Dd = [], Od = /*@__PURE__*/ Object.create(null), kd = /*@__PURE__*/ Object.create(null);
for (let [e, t] of [
...
]) kd[e] = /*@__PURE__*/ jd(Td, t);
function Ad(e, t) {
	Dd.indexOf(e) > -1 || (Dd.push(e), console.warn(t));
}
function jd(e, t) {
	let n = [];
	for (let r of t.split(" ")) {
		...
		for (let n of r.split(".")) {
			let r = e[n] || X[n];
			r ? typeof r == "function" ? t.length ? t = t.map(r) : Ad(n, `Modifier ${n} used at start of tag`) : t.length ? Ad(n, `Tag ${n} used as modifier`) : t = Array.isArray(r) ? r : [r] : Ad(n, `Unknown highlighting tag ${n}`);
		}
		for (let e of t) n.push(e);
	}
	if (!n.length) return 0;
	let r = t.replace(/ /g, "_"), i = r + " " + n.map((e) => e.id), a = Od[i];
	if (a) return a.id;
	let o = Od[i] = Wc.define({
		id: Ed.length,
		name: r,
		props: [Cl({ [r]: n })]
	});
	return Ed.push(o), o.id;
}
z.RTL, z.LTR;
//#endregion
//#region node_modules/@codemirror/commands/dist/index.js
var Md = (e) => {
	let { state: t } = e, n = t.doc.lineAt(t.selection.main.from), r = Ld(e.state, n.from);
	return r.line ? Pd(e) : r.block ? Id(e) : !1;
};
function Nd(e, t) {
...
var Pd = /*@__PURE__*/ Nd(Hd, 0), Fd = /*@__PURE__*/ Nd(Vd, 0), Id = /*@__PURE__*/ Nd((e, t) => Vd(e, t, Bd(t)), 0);
function Ld(e, t) {
	let n = e.languageDataAt("commentTokens", t, 1);
	return n.length ? n[0] : {};
}
var Rd = 50;
function zd(e, { open: t, close: n }, r, i) {
	let a = e.sliceDoc(r - Rd, r), o = e.sliceDoc(i, i + Rd), s = /\s*$/.exec(a)[0].length, c = /^\s*/.exec(o)[0].length, l = a.length - s;
	...
	let u, d;
	i - r <= 2 * Rd ? u = d = e.sliceDoc(r, i) : (u = e.sliceDoc(r, r + Rd), d = e.sliceDoc(i - Rd, i));
...
function Vd(e, t, n = t.selection.ranges) {
	let r = n.map((e) => Ld(t, e.from).block);
...
function Hd(e, t, n = t.selection.ranges) {
	let r = [], i = -1;
	ranges: for (let { from: e, to: a } of n) {
		let n = r.length, o = 1e9, s;
		for (let n = e; n <= a;) {
			let c = t.doc.lineAt(n);
			if (s == null && (s = Ld(t, c.from).line, !s)) continue ranges;
...
var Ud = /*@__PURE__*/ Be.define(), Wd = /*@__PURE__*/ Be.define(), Gd = /*@__PURE__*/ E.define(), Kd = /*@__PURE__*/ E.define({ combine(e) {
	return tt(e, {
		minDepth: 100,
		newGroupDelay: 500,
		joinToEvent: (e, t) => t
...
} }), qd = /*@__PURE__*/ D.define({
	create() {
		return pf.empty;
	},
	update(e, t) {
		let n = t.state.facet(Kd), r = t.annotation(Ud);
		if (r) {
			let i = ef.fromTransaction(t, r.selection), a = r.side, o = a == 0 ? e.undone : e.done;
			return o = i ? tf(o, o.length, n.minDepth, i) : cf(o, t.startState.selection), new pf(a == 0 ? r.rest : o, a == 0 ? o : r.rest);
		}
		let i = t.annotation(Wd);
		if ((i == "full" || i == "before") && (e = e.isolate()), t.annotation(k.addToHistory) === !1) return t.changes.empty ? e : e.addMapping(t.changes.desc);
		let a = ef.fromTransaction(t), o = t.annotation(k.time), s = t.annotation(k.userEvent);
	...
	fromJSON(e) {
		return new pf(e.done.map(ef.fromJSON), e.undone.map(ef.fromJSON));
	}
});
function Jd(e = {}) {
	return [
		...
		G.domEventHandlers({ beforeinput(e, t) {
			let n = e.inputType == "historyUndo" ? Xd : e.inputType == "historyRedo" ? Zd : null;
...
var Xd = /*@__PURE__*/ Yd(0, !1), Zd = /*@__PURE__*/ Yd(1, !1), Qd = /*@__PURE__*/ Yd(0, !0), $d = /*@__PURE__*/ Yd(1, !0), ef = class e {
	constructor(e, t, n, r, i) {
	...
	static fromJSON(t) {
		return new e(t.changes && ce.fromJSON(t.changes), [], t.mapped && se.fromJSON(t.mapped), t.startSelection && T.fromJSON(t.startSelection), t.selectionsAfter.map(T.fromJSON));
	}
	static fromTransaction(t, n) {
		let r = of;
		for (let e of t.startState.facet(Gd)) {
			let n = e(t);
			n.length && (r = r.concat(n));
		}
		return !r.length && t.changes.empty ? null : new e(t.changes.invert(t.startState.doc), r, void 0, n || t.startState.selection, of);
	}
	static selection(t) {
		return new e(void 0, of, void 0, void 0, t);
	}
};
function tf(e, t, n, r) {
...
function cf(e, t) {
	if (e.length) {
		let n = e[e.length - 1], r = n.selectionsAfter.slice(Math.max(0, n.selectionsAfter.length - sf));
		return r.length && r[r.length - 1].eq(t) ? e : (r.push(t), tf(e, e.length - 1, 1e9, n.setSelAfter(r)));
	} else return [ef.selection([t])];
}
function lf(e) {
...
function uf(e, t) {
	...
	return r.length ? [ef.selection(r)] : of;
}
function df(e, t, n) {
	let r = af(e.selectionsAfter.length ? e.selectionsAfter.map((e) => e.map(t)) : of, n);
	if (!e.changes) return ef.selection(r);
	let i = e.changes.map(t), a = t.mapDesc(e.changes, !0), o = e.mapped ? e.mapped.composeDesc(a) : a;
	return new ef(i, O.mapEffects(e.effects, t), o, e.startSelection.map(a), r);
}
var ff = /^(input\.type|delete)($|\.)/, pf = class e {
	...
	addChanges(t, n, r, i, a) {
		...
		return o = s && s.changes && !s.changes.empty && t.changes && (!r || ff.test(r)) && (!s.selectionsAfter.length && n - this.prevTime < i.newGroupDelay && i.joinToEvent(a, nf(s.changes, t.changes)) || r == "input.type.compose") ? tf(o, o.length - 1, i.minDepth, new ef(t.changes.compose(s.changes), af(O.mapEffects(t.effects, s.changes), s.effects), s.mapped, s.startSelection, of)) : tf(o, o.length, i.minDepth, t), new e(o, of, n, r);
	}
	addSelection(t, n, r, i) {
		let a = this.done.length ? this.done[this.done.length - 1].selectionsAfter : of;
		return a.length > 0 && n - this.prevTime < i && r == this.prevUserEvent && r && /^select($|\.)/.test(r) && rf(a[a.length - 1], t) ? this : new e(cf(this.done, t), this.undone, n, r);
	}
	addMapping(t) {
		return new e(uf(this.done, t), uf(this.undone, t), this.prevTime, this.prevUserEvent);
	}
	pop(e, t, n) {
		...
		if (i.changes) {
			let n = r.length == 1 ? of : r.slice(0, r.length - 1);
			return i.mapped && (n = uf(n, i.mapped)), t.update({
				changes: i.changes,
...
pf.empty = /*@__PURE__*/ new pf(of, of);
var mf = [
	{
		key: "Mod-z",
		run: Xd,
...
function _f({ state: e, dispatch: t }, n) {
	let r = hf(e.selection, n);
	return r.eq(e.selection, !0) ? !1 : (t(gf(e, r)), !0);
}
function vf(e, t) {
	return T.cursor(t ? e.to : e.from);
}
function yf(e, t) {
	return _f(e, (n) => n.empty ? e.moveByChar(n, t) : vf(n, t));
}
function Q(e) {
	return e.textDirectionAt(e.state.selection.main.head) == z.LTR;
}
var bf = (e) => yf(e, !Q(e)), xf = (e) => yf(e, Q(e));
function Sf(e, t) {
	return _f(e, (n) => n.empty ? e.moveByGroup(n, t) : vf(n, t));
}
var Cf = (e) => Sf(e, !Q(e)), wf = (e) => Sf(e, Q(e));
...
function Ef(e, t, n) {
	let r = Z(e).resolveInner(t.head), i = n ? K.closedBy : K.openedBy;
	for (let a = t.head;;) {
		let t = n ? r.childAfter(a) : r.childBefore(a);
		if (!t) break;
		Tf(e, t, i) ? r = t : a = n ? t.to : t.from;
	}
	let a = r.type.prop(i), o, s;
	return s = a && (o = n ? Sd(e, r.from, 1) : Sd(e, r.to, -1)) && o.matched ? n ? o.end.to : o.end.from : n ? r.to : r.from, T.cursor(s, n ? -1 : 1);
}
var Df = (e) => _f(e, (t) => Ef(e.state, t, !Q(e))), Of = (e) => _f(e, (t) => Ef(e.state, t, Q(e)));
function kf(e, t) {
	return _f(e, (n) => {
		if (!n.empty) return vf(n, t);
		let r = e.moveVertically(n, t);
		return r.head == n.head ? e.moveToLineBoundary(n, t) : r;
	});
}
var Af = (e) => kf(e, !1), jf = (e) => kf(e, !0);
function Mf(e) {
...
function Nf(e, t) {
	let n = Mf(e), { state: r } = e, i = hf(r.selection, (r) => r.empty ? e.moveVertically(r, t, n.height) : vf(r, t));
	...
	return e.dispatch(gf(r, i), { effects: a }), !0;
}
var Pf = (e) => Nf(e, !1), Ff = (e) => Nf(e, !0);
function If(e, t, n) {
...
var Lf = (e) => _f(e, (t) => If(e, t, !0)), Rf = (e) => _f(e, (t) => If(e, t, !1)), zf = (e) => _f(e, (t) => If(e, t, !Q(e))), Bf = (e) => _f(e, (t) => If(e, t, Q(e))), Vf = (e) => _f(e, (t) => T.cursor(e.lineBlockAt(t.head).from, 1)), Hf = (e) => _f(e, (t) => T.cursor(e.lineBlockAt(t.head).to, -1));
function Uf(e, t, n) {
	let r = !1, i = hf(e.selection, (t) => {
		let i = Sd(e, t.head, -1) || Sd(e, t.head, 1) || t.head > 0 && Sd(e, t.head - 1, 1) || t.head < e.doc.length && Sd(e, t.head + 1, -1);
		if (!i || !i.end) return t;
		r = !0;
		let a = i.start.from == t.head ? i.end.to : i.end.from;
		return n ? T.range(t.anchor, a) : T.cursor(a);
	});
	return r ? (t(gf(e, i)), !0) : !1;
}
var Wf = ({ state: e, dispatch: t }) => Uf(e, t, !1);
function Gf(e, t, n) {
	let r = hf(e.state.selection, (e) => {
	...
	return r.eq(e.state.selection) ? !1 : (e.dispatch(gf(e.state, r)), !0);
}
function Kf(e, t) {
	return Gf(e, t, (n) => e.moveByChar(n, t));
}
var qf = (e) => Kf(e, !Q(e)), Jf = (e) => Kf(e, Q(e));
function Yf(e, t) {
	return Gf(e, t, (n) => e.moveByGroup(n, t));
}
var Xf = (e) => Yf(e, !Q(e)), Zf = (e) => Yf(e, Q(e)), Qf = (e) => {
	let t = !Q(e);
	return Gf(e, t, (n) => Ef(e.state, n, t));
}, $f = (e) => {
	let t = Q(e);
	return Gf(e, t, (n) => Ef(e.state, n, t));
};
function ep(e, t) {
	return Gf(e, t, (n) => e.moveVertically(n, t));
}
var tp = (e) => ep(e, !1), np = (e) => ep(e, !0);
function rp(e, t) {
	return Gf(e, t, (n) => e.moveVertically(n, t, Mf(e).height));
}
var ip = (e) => rp(e, !1), ap = (e) => rp(e, !0), op = (e) => Gf(e, !0, (t) => If(e, t, !0)), sp = (e) => Gf(e, !1, (t) => If(e, t, !1)), cp = (e) => {
	let t = !Q(e);
	return Gf(e, t, (n) => If(e, n, t));
}, lp = (e) => {
	let t = Q(e);
	return Gf(e, t, (n) => If(e, n, t));
}, up = (e) => Gf(e, !1, (t) => T.cursor(e.lineBlockAt(t.head).from)), dp = (e) => Gf(e, !0, (t) => T.cursor(e.lineBlockAt(t.head).to)), fp = ({ state: e, dispatch: t }) => (t(gf(e, { anchor: 0 })), !0), pp = ({ state: e, dispatch: t }) => (t(gf(e, { anchor: e.doc.length })), !0), mp = ({ state: e, dispatch: t }) => (t(gf(e, {
	anchor: e.selection.main.anchor,
	head: 0
})), !0), hp = ({ state: e, dispatch: t }) => (t(gf(e, {
	anchor: e.selection.main.anchor,
	head: e.doc.length
})), !0), gp = ({ state: e, dispatch: t }) => (t(e.update({
	selection: {
		anchor: 0,
		head: e.doc.length
	},
	userEvent: "select"
})), !0), _p = ({ state: e, dispatch: t }) => {
	let n = Ip(e).map(({ from: t, to: n }) => T.range(t, Math.min(n + 1, e.doc.length)));
	return t(e.update({
		selection: T.create(n),
		userEvent: "select"
	})), !0;
}, vp = ({ state: e, dispatch: t }) => {
	let n = hf(e.selection, (t) => {
		...
		for (let e = r; e; e = e.next) {
			let { node: n } = e;
			if ((n.from < t.from && n.to >= t.to || n.to > t.to && n.from <= t.from) && e.next) return T.range(n.to, n.from);
		}
		return t;
	});
	return n.eq(e.selection) ? !1 : (t(gf(e, n)), !0);
};
function yp(e, t) {
	...
	return i.length == r.ranges.length ? !1 : (e.dispatch(gf(n, T.create(i, i.length - 1))), !0);
}
var bp = (e) => yp(e, !1), xp = (e) => yp(e, !0), Sp = ({ state: e, dispatch: t }) => {
	let n = e.selection, r = null;
	return n.ranges.length > 1 ? r = T.create([n.main]) : n.main.empty || (r = T.create([T.cursor(n.main.head)])), r ? (t(gf(e, r)), !0) : !1;
};
function Cp(e, t) {
	...
	let n = "delete.selection", { state: r } = e, i = r.changeByRange((r) => {
		...
		if (i == a) {
			let o = t(r);
			o < i ? (n = "delete.backward", o = wp(e, o, !1)) : o > i && (n = "delete.forward", o = wp(e, o, !0)), i = Math.min(i, o), a = Math.max(a, o);
		} else i = wp(e, i, !1), a = wp(e, a, !0);
		return i == a ? { range: r } : {
			changes: {
				from: i,
				to: a
...
var Tp = (e, t, n) => Cp(e, (r) => {
	...
	if (n && !t && i > o.from && i < o.from + 200 && !/[^ \t]/.test(s = o.text.slice(0, i - o.from))) {
		...
		let e = yt(s, a.tabSize) % lu(a) || lu(a);
	...
	return c;
}), Ep = (e) => Tp(e, !1, !0), Dp = (e) => Tp(e, !0, !1), Op = (e, t) => Cp(e, (n) => {
	...
	return r;
}), kp = (e) => Op(e, !1), Ap = (e) => Op(e, !0), jp = (e) => Cp(e, (t) => {
...
var Rp = ({ state: e, dispatch: t }) => Lp(e, t, !1), zp = ({ state: e, dispatch: t }) => Lp(e, t, !0);
function Bp(e, t, n) {
	if (e.readOnly) return !1;
	let r = [];
	for (let t of Ip(e)) n ? r.push({
		from: t.from,
...
var Vp = ({ state: e, dispatch: t }) => Bp(e, t, !1), Hp = ({ state: e, dispatch: t }) => Bp(e, t, !0), Up = (e) => {
	if (e.state.readOnly) return !1;
	let { state: t } = e, n = t.changes(Ip(t).map(({ from: e, to: n }) => (e > 0 ? e-- : n < t.doc.length && n++, {
		from: e,
		to: n
	}))), r = hf(t.selection, (t) => {
		let n;
...
function Wp(e, t) {
	...
	let n = Z(e).resolveInner(t), r = n.childBefore(t), i = n.childAfter(t), a;
...
var Gp = /*@__PURE__*/ qp(!1), Kp = /*@__PURE__*/ qp(!0);
function qp(e) {
	return ({ state: t, dispatch: n }) => {
		if (t.readOnly) return !1;
		let r = t.changeByRange((n) => {
			let { from: r, to: i } = n, a = t.doc.lineAt(r), o = !e && r == i && Wp(t, r);
			e && (r = i = (i <= a.to ? a : t.doc.lineAt(i)).to);
			let s = new fu(t, {
				simulateBreak: r,
				simulateDoubleBreak: !!o
			}), c = du(s, r);
			for (c ??= yt(/^\s*/.exec(t.doc.lineAt(r).text)[0], t.tabSize); i < a.to && /\s/.test(a.text[i - a.from]);) i++;
			o ? {from: r, to: i} = o : r > a.from && r < a.from + 100 && !/\S/.test(a.text.slice(0, r)) && (r = a.from);
			let l = ["", uu(t, c)];
			return o && l.push(uu(t, s.lineIndent(a.from, -1))), {
				changes: {
					from: r,
					to: i,
					insert: f.of(l)
...
var Yp = ({ state: e, dispatch: t }) => {
	if (e.readOnly) return !1;
	let n = Object.create(null), r = new fu(e, { overrideIndentation: (e) => n[e] ?? -1 }), i = Jp(e, (t, i, a) => {
		let o = du(r, t.from);
		if (o == null) return;
		/\S/.test(t.text) || (o = 0);
		let s = /^\s*/.exec(t.text)[0], c = uu(e, o);
...
}, Xp = ({ state: e, dispatch: t }) => e.readOnly ? !1 : (t(e.update(Jp(e, (t, n) => {
	n.push({
		from: t.from,
		insert: e.facet(cu)
	});
}), { userEvent: "input.indent" })), !0), Zp = ({ state: e, dispatch: t }) => e.readOnly ? !1 : (t(e.update(Jp(e, (t, n) => {
	let r = /^\s*/.exec(t.text)[0];
	if (!r) return;
	let i = yt(r, e.tabSize), a = 0, o = uu(e, Math.max(0, i - lu(e)));
...
}), { userEvent: "delete.dedent" })), !0), Qp = (e) => (e.setTabFocusMode(), !0), $p = [
	{
		key: "Ctrl-b",
		run: bf,
		shift: qf,
...
].concat(em), nm = typeof String.prototype.normalize == "function" ? (e) => e.normalize("NFKD") : (e) => e, rm = class {
	constructor(e, t, n = 0, r = e.length, i, a) {
		this.test = a, this.value = {
			from: 0,
			to: 0,
			precise: !1
		}, this.done = !1, this.matches = [], this.buffer = "", this.bufferPos = 0, this.iter = e.iterRange(n, r), this.bufferStart = n, this.normalize = i ? (e) => i(nm(e)) : nm, this.query = this.normalize(t);
	}
	peek() {
	...
	nextOverlapping() {
		for (;;) {
			...
			let t = ie(e), n = this.bufferStart + this.bufferPos;
			this.bufferPos += ae(e);
...
typeof Symbol < "u" && (rm.prototype[Symbol.iterator] = function() {
	return this;
});
var im = {
	from: -1,
	...
	match: /*@__PURE__*/ /.*/.exec(""),
	precise: !0
}, am = "gm" + (/x/.unicode == null ? "" : "u"), om = class {
	constructor(e, t, n, r = 0, i = e.length) {
		if (this.text = e, this.to = i, this.curLine = "", this.done = !1, this.value = im, /\\[sWDnr]|\n|\r|\[\^/.test(t)) return new lm(e, t, n, r, i);
		this.re = new RegExp(t, am + (n?.ignoreCase ? "i" : "")), this.test = n?.test, this.iter = e.iter();
		let a = e.lineAt(r);
		this.curLineStart = a.from, this.matchPos = dm(e, r), this.getLine(this.curLineStart);
	}
	getLine(e) {
	...
	next() {
		for (let e = this.matchPos - this.curLineStart;;) {
			...
			if (t) {
				...
				if (this.matchPos = dm(this.text, r + +(n == r)), n == this.curLineStart + this.curLine.length && this.nextLine(), (n < r || n > this.value.to) && (!this.test || this.test(n, r, t))) return this.value = {
					from: n,
					to: r,
					precise: !0,
					match: t
	...
	constructor(e, t, n, r, i) {
		this.text = e, this.to = i, this.done = !1, this.value = im, this.matchPos = dm(e, r), this.re = new RegExp(t, am + (n?.ignoreCase ? "i" : "")), this.test = n?.test, this.flat = cm.get(e, r, this.chunkEnd(r + 5e3));
	}
	chunkEnd(e) {
		...
		for (;;) {
			...
			if (t && !t[0] && t.index == e && (this.re.lastIndex = e + 1, t = this.re.exec(this.flat.text)), t) {
				...
				if ((this.flat.to >= this.to || t.index + t[0].length <= this.flat.text.length - 10) && (!this.test || this.test(e, n, t))) return this.value = {
					...
					precise: !0,
					match: t
				}, this.matchPos = dm(this.text, n + +(e == n)), this;
			}
...
typeof Symbol < "u" && (om.prototype[Symbol.iterator] = lm.prototype[Symbol.iterator] = function() {
	return this;
});
function um(e) {
	try {
		return new RegExp(e, am), !0;
	} catch {
		return !1;
	}
}
...
var fm = (e) => {
	let { state: t } = e, n = String(t.doc.lineAt(e.state.selection.main.head).number), { close: r, result: i } = cc(e, {
	...
	maxMatches: 100,
	wholeWords: !1
}, mm = /*@__PURE__*/ E.define({ combine(e) {
	return tt(e, pm, {
...
function hm(e) {
	let t = [xm, bm];
	return e && t.push(mm.of(e)), t;
}
var gm = /*@__PURE__*/ R.mark({ class: "cm-selectionMatch" }), _m = /*@__PURE__*/ R.mark({ class: "cm-selectionMatch cm-selectionMatch-main" });
function vm(e, t, n, r) {
...
var bm = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.decorations = this.getDeco(e);
	}
	update(e) {
	...
	getDeco(e) {
		let t = e.state.facet(mm), { state: n } = e, r = n.selection;
		...
		if (i.empty) {
			...
			if (t.wholeWords) {
				if (a = n.sliceDoc(i.from, i.to), o = n.charCategorizer(i.head), !(vm(o, n, i.from, i.to) && ym(o, n, i.from, i.to))) return R.none;
			} else if (a = n.sliceDoc(i.from, i.to), !a) return R.none;
		}
		let s = [];
		for (let r of e.visibleRanges) {
			let e = new rm(n.doc, a, r.from, r.to);
			for (; !e.next().done;) {
				let { from: r, to: a } = e.value;
				if ((!o || vm(o, n, r, a)) && (i.empty && r <= i.from && a >= i.to ? s.push(_m.range(r, a)) : (r >= i.to || a <= i.from) && s.push(gm.range(r, a)), s.length > t.maxMatches)) return R.none;
			}
		}
		return R.set(s);
	}
}, { decorations: (e) => e.decorations }), xm = /*@__PURE__*/ G.baseTheme({
	".cm-selectionMatch": { backgroundColor: "#99ff7780" },
	".cm-searchMatch .cm-selectionMatch": { backgroundColor: "transparent" }
}), Sm = ({ state: e, dispatch: t }) => {
...
function Cm(e, t) {
	...
	for (let n = !1, i = new rm(e.doc, t, r[r.length - 1].to);;) if (i.next(), i.done) {
		if (n) return null;
		i = new rm(e.doc, t, 0, Math.max(0, r[r.length - 1].from - 1)), n = !0;
	} else {
...
var wm = ({ state: e, dispatch: t }) => {
	let { ranges: n } = e.selection;
	if (n.some((e) => e.from === e.to)) return Sm({
		state: e,
		dispatch: t
	});
...
}, Tm = /*@__PURE__*/ E.define({ combine(e) {
	return tt(e, {
		top: !1,
		caseSensitive: !1,
		literal: !1,
		regexp: !1,
		wholeWord: !1,
		createPanel: (e) => new ah(e),
		scrollToMatch: (e) => G.scrollIntoView(e)
	});
} }), Em = class {
	constructor(e) {
		this.search = e.search, this.caseSensitive = !!e.caseSensitive, this.literal = !!e.literal, this.regexp = !!e.regexp, this.replace = e.replace || "", this.valid = !!this.search && (!this.regexp || um(this.search)), this.unquoted = this.unquote(this.search), this.wholeWord = !!e.wholeWord, this.test = e.test;
	}
	unquote(e) {
	...
	create() {
		return this.regexp ? new Lm(this) : new jm(this);
	}
	getCursor(e, t = 0, n) {
		let r = e.doc ? e : j.create({ doc: e });
		return n ??= r.doc.length, this.regexp ? Nm(this, r, t, n) : km(this, r, t, n);
	}
}, Dm = class {
	constructor(e) {
		this.spec = e;
...
function km(e, t, n, r) {
	let i;
	return e.wholeWord && (i = Am(t.doc, t.charCategorizer(t.selection.main.head))), e.test && (i = Om(e.test, t, i)), new rm(t.doc, e.unquoted, n, r, e.caseSensitive ? void 0 : (e) => e.toLowerCase(), i);
}
function Am(e, t) {
	return (n, r, i, a) => ((a > n || a + i.length < r) && (a = Math.max(0, n - 2), i = e.sliceString(a, Math.min(e.length, r + 2))), (t(Pm(i, n - a)) != A.Word || t(Fm(i, n - a)) != A.Word) && (t(Fm(i, r - a)) != A.Word || t(Pm(i, r - a)) != A.Word));
}
var jm = class extends Dm {
	constructor(e) {
		super(e);
	}
	nextMatch(e, t, n) {
		let r = km(this.spec, e, n, e.doc.length).nextOverlapping();
		if (r.done) {
			let n = Math.min(e.doc.length, t + this.spec.unquoted.length);
			r = km(this.spec, e, 0, n).nextOverlapping();
		}
		return r.done || r.value.from == t && r.value.to == n ? null : r.value;
	}
	prevMatchInRange(e, t, n) {
		for (let r = n;;) {
			let n = Math.max(t, r - 1e4 - this.spec.unquoted.length), i = km(this.spec, e, n, r), a = null;
	...
	matchAll(e, t) {
		let n = km(this.spec, e, 0, e.doc.length), r = [];
		for (; !n.next().done;) {
	...
	highlight(e, t, n, r) {
		let i = km(this.spec, e, Math.max(0, t - this.spec.unquoted.length), Math.min(n + this.spec.unquoted.length, e.doc.length));
...
function Nm(e, t, n, r) {
	let i;
	return e.wholeWord && (i = Im(t.charCategorizer(t.selection.main.head))), e.test && (i = Mm(e.test, t, i)), new om(t.doc, e.search, {
...
function Im(e) {
	return (t, n, r) => !r[0].length || (e(Pm(r.input, r.index)) != A.Word || e(Fm(r.input, r.index)) != A.Word) && (e(Fm(r.input, r.index + r[0].length)) != A.Word || e(Pm(r.input, r.index + r[0].length)) != A.Word);
}
var Lm = class extends Dm {
	nextMatch(e, t, n) {
		let r = Nm(this.spec, e, n, e.doc.length).next();
		return r.done && (r = Nm(this.spec, e, 0, t).next()), r.done ? null : r.value;
	}
	prevMatchInRange(e, t, n) {
		for (let r = 1;; r++) {
			let i = Math.max(t, n - r * 1e4), a = Nm(this.spec, e, i, n), o = null;
	...
	matchAll(e, t) {
		let n = Nm(this.spec, e, 0, e.doc.length), r = [];
		for (; !n.next().done;) {
			if (r.length >= t) return null;
			r.push(n.value);
		}
	...
	highlight(e, t, n, r) {
		let i = Nm(this.spec, e, Math.max(0, t - 250), Math.min(n + 250, e.doc.length));
		for (; !i.next().done;) r(i.value.from, i.value.to);
	}
}, Rm = /*@__PURE__*/ O.define(), zm = /*@__PURE__*/ O.define(), Bm = /*@__PURE__*/ D.define({
	create(e) {
		return new Vm($m(e).create(), null);
	},
	update(e, t) {
		for (let n of t.effects) n.is(Rm) ? e = new Vm(n.value.create(), e.panel) : n.is(zm) && (e = new Vm(e.query, n.value ? Qm : null));
		return e;
	},
	provide: (e) => sc.from(e, (e) => e.panel)
}), Vm = class {
	constructor(e, t) {
		this.query = e, this.panel = t;
	}
}, Hm = /*@__PURE__*/ R.mark({ class: "cm-searchMatch" }), Um = /*@__PURE__*/ R.mark({ class: "cm-searchMatch cm-searchMatch-selected" }), Wm = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.view = e, this.decorations = this.highlight(e.state.field(Bm));
	}
	update(e) {
		let t = e.state.field(Bm);
		(t != e.startState.field(Bm) || e.docChanged || e.selectionSet || e.viewportChanged) && (this.decorations = this.highlight(t));
	}
	highlight({ query: e, panel: t }) {
		if (!t || !e.spec.valid) return R.none;
		let { view: n } = this, r = new ct();
...
function Gm(e) {
	return (t) => {
		let n = t.state.field(Bm, !1);
		return n && n.query.spec.valid ? e(t, n) : nh(t);
	};
}
var Km = /*@__PURE__*/ Gm((e, { query: t }) => {
	let { to: n } = e.state.selection.main, r = t.nextMatch(e.state, n, n);
	if (!r) return !1;
	let i = T.single(r.from, r.to), a = e.state.facet(Tm);
	return e.dispatch({
		selection: i,
		effects: [lh(e, r), a.scrollToMatch(i.main, e)],
		userEvent: "select.search"
	}), th(e), !0;
}), qm = /*@__PURE__*/ Gm((e, { query: t }) => {
	let { state: n } = e, { from: r } = n.selection.main, i = t.prevMatch(n, r, r);
	if (!i) return !1;
	let a = T.single(i.from, i.to), o = e.state.facet(Tm);
	return e.dispatch({
		selection: a,
		effects: [lh(e, i), o.scrollToMatch(a.main, e)],
		userEvent: "select.search"
	}), th(e), !0;
}), Jm = /*@__PURE__*/ Gm((e, { query: t }) => {
	let n = t.matchAll(e.state, 1e3);
	return !n || !n.length ? !1 : (e.dispatch({
		selection: T.create(n.map((e) => T.range(e.from, e.to))),
		userEvent: "select.search.matches"
	}), !0);
}), Ym = ({ state: e, dispatch: t }) => {
	let n = e.selection;
	if (n.ranges.length > 1 || n.main.empty) return !1;
	let { from: r, to: i } = n.main, a = [], o = 0;
	for (let t = new rm(e.doc, e.sliceDoc(r, i)); !t.next().done;) {
	...
	return o && (c = T.single(o.from, o.to).map(d), u.push(lh(e, o)), u.push(n.facet(Tm).scrollToMatch(c.main, e))), e.dispatch({
		changes: d,
		selection: c,
		effects: u,
		userEvent: "input.replace"
	}), !0;
}), Zm = /*@__PURE__*/ Gm((e, { query: t }) => {
	if (e.state.readOnly) return !1;
	let n = [];
...
function Qm(e) {
	return e.state.facet(Tm).createPanel(e);
}
function $m(e, t) {
...
var nh = (e) => {
	let t = e.state.field(Bm, !1);
	if (t && t.panel) {
		let n = eh(e);
		if (n && n != e.root.activeElement) {
			let r = $m(e.state, t.query.spec);
			r.valid && e.dispatch({ effects: Rm.of(r) }), n.focus(), n.select();
		}
	} else e.dispatch({ effects: [zm.of(!0), t ? Rm.of($m(e.state, t.query.spec)) : O.appendConfig.of(dh)] });
	return !0;
}, rh = (e) => {
	let t = e.state.field(Bm, !1);
	if (!t || !t.panel) return !1;
	let n = rc(e, Qm);
	return n && n.dom.contains(e.root.activeElement) && e.focus(), e.dispatch({ effects: zm.of(!1) }), !0;
}, ih = [
	{
		key: "Mod-f",
		run: nh,
	...
	constructor(e) {
		this.view = e;
		let t = this.query = e.state.field(Bm).query.spec;
		...
		this.dom = P("div", {
			...
			this.searchField,
			n("next", () => Km(e), [oh(e, "next")]),
			n("prev", () => qm(e), [oh(e, "previous")]),
			n("select", () => Jm(e), [oh(e, "all")]),
			P("label", null, [this.caseField, oh(e, "match case")]),
			P("label", null, [this.reField, oh(e, "regexp")]),
			P("label", null, [this.wordField, oh(e, "by word")]),
			...e.state.readOnly ? [] : [
				P("br"),
				this.replaceField,
				n("replace", () => Xm(e), [oh(e, "replace")]),
				n("replaceAll", () => Zm(e), [oh(e, "replace all")])
			],
			P("button", {
				name: "close",
				onclick: () => rh(e),
	...
	commit() {
		...
		e.eq(this.query) || (this.query = e, this.view.dispatch({ effects: Rm.of(e) }));
	}
	keydown(e) {
		Fo(this.view, e, "search-panel") ? e.preventDefault() : e.keyCode == 13 && e.target == this.searchField ? (e.preventDefault(), (e.shiftKey ? qm : Km)(this.view)) : e.keyCode == 13 && e.target == this.replaceField && (e.preventDefault(), Xm(this.view));
	}
	update(e) {
		for (let t of e.transactions) for (let e of t.effects) e.is(Rm) && !e.value.eq(this.query) && this.setQuery(e.value);
	}
	setQuery(e) {
	...
	get top() {
		return this.view.state.facet(Tm).top;
	}
};
function oh(e, t) {
...
var uh = /*@__PURE__*/ G.baseTheme({
	...
	matchBefore(e) {
		let t = this.state.doc.lineAt(this.pos), n = Math.max(t.from, this.pos - 250), r = t.text.slice(n - t.from, this.pos - t.from), i = r.search(yh(e, !1));
		return i < 0 ? null : {
			from: n + i,
			to: this.pos,
			text: r.slice(i)
...
function hh(e) {
	let t = e.map((e) => typeof e == "string" ? { label: e } : e), [n, r] = t.every((e) => /^\w+$/.test(e.label)) ? [/\w*$/, /\w+$/] : mh(t);
	return (e) => {
...
function Ch(e) {
	...
	let t = Sh.get(e);
	return t || Sh.set(e, t = hh(e)), t;
}
var wh = /*@__PURE__*/ O.define(), Th = /*@__PURE__*/ O.define(), Eh = class {
	constructor(e) {
		...
		for (let t = 0; t < e.length;) {
			...
			this.folded.push(S(a == i ? i.toLowerCase() : a, 0)), t += r;
		}
	...
	match(e) {
		...
		if (t.length == 1) {
			let r = S(e, 0), i = ae(r), a = i == e.length ? 0 : -100;
	...
	result(e, t, n) {
		let r = [], i = 0;
		for (let e of t) {
			let t = e + (this.astral ? ae(S(n, e)) : 1);
	...
	return tt(e, {
		...
		closeOnBlur: (e, t) => e && t,
		icons: (e, t) => e && t,
		tooltipClass: (e, t) => (n) => Oh(e(n), t(n)),
		optionClass: (e, t) => (n) => Oh(e(n), t(n)),
...
var Nh = class {
	constructor(e, t, n) {
		...
		this.optionContent = jh(o), this.optionClass = o.optionClass, this.tooltipClass = o.tooltipClass, this.range = Mh(i.length, a, o.maxRenderedOptions), this.dom = document.createElement("div"), this.dom.className = "cm-tooltip-autocomplete", this.updateTooltipClass(e.state), this.dom.addEventListener("mousedown", (n) => {
			...
			if (n.target == this.list) {
				...
				t != null && (e.dispatch({ effects: Ah.of(t) }), n.preventDefault());
			}
		}), this.dom.addEventListener("focusout", (t) => {
			let n = e.state.field(this.stateField, !1);
			n && n.tooltip && e.state.facet($).closeOnBlur && t.relatedTarget != e.contentDOM && e.dispatch({ effects: Th.of(null) });
	...
	update(e) {
		...
		if (this.updateTooltipClass(e.state), t != n) {
			...
			(!n.open || n.open.options != r) && (this.range = Mh(r.length, i, e.state.facet($).maxRenderedOptions), this.showOptions(r, t.id)), this.updateSel(), a != n.open?.disabled && this.dom.classList.toggle("cm-tooltip-autocomplete-disabled", !!a);
		}
	}
	...
	updateSel() {
		...
		(t.selected > -1 && t.selected < this.range.from || t.selected >= this.range.to) && (this.range = Mh(t.options.length, t.selected, this.view.state.facet($).maxRenderedOptions), this.showOptions(t.options, e.id));
		...
		if (n) {
			...
			}).catch((e) => mr(this.view.state, e, "completion info")) : (this.addInfoPane(a, r), n.setAttribute("aria-describedby", this.info.id));
		}
	}
	addInfoPane(e, t) {
		this.destroyInfo();
...
function Lh(e, t) {
	...
	for (let r of e) if (r.hasResult()) {
		...
		if (r.result.filter === !1) for (let t of r.result.options) a(new _h(t, r.source, e ? e(t) : [], 1e9 - n.length));
		else {
			let n = t.sliceDoc(r.from, r.to), s, c = o.filterStrict ? new Dh(n) : new Eh(n);
			for (let t of r.result.options) if (s = c.match(t.label)) {
				let n = t.displayLabel ? e ? e(t, s.matched) : [] : s.matched, o = s.score + (t.boost || 0);
				if (a(new _h(t, r.source, n, o)), typeof t.section == "object" && t.section.rank === "dynamic") {
	...
	for (let e of n.sort((e, t) => t.score - e.score || l(e.completion, t.completion))) {
		let t = e.completion;
		!c || c.label != t.label || c.detail != t.detail || c.type != null && t.type != null && c.type != t.type || c.apply != t.apply || c.boost != t.boost ? s.push(e) : Ih(e.completion) > Ih(c) && (s[s.length - 1] = e), c = e.completion;
	}
	return s;
}
var Rh = class e {
	...
	setSelected(t, n) {
		return t == this.selected || t >= this.options.length ? this : new e(this.options, Uh(n, t), this.tooltip, this.timestamp, t, this.disabled);
	}
	...
	static start() {
		return new e(Wh, "cm-ac-" + Math.floor(Math.random() * 2e6).toString(36), null);
	}
	update(t) {
		let { state: n } = t, r = n.facet($), i = (r.override || n.languageDataAt("autocomplete", vh(n)).map(Ch)).map((e) => (this.active.find((t) => t.source == e) || new Kh(e, +!!this.active.some((e) => e.state != 0))).update(t, r));
		i.length == this.active.length && i.every((e, t) => e == this.active[t]) && (i = this.active);
		let a = this.open, o = t.effects.some((e) => e.is(Yh));
		a && t.docChanged && (a = a.map(t.changes)), t.selection || i.some((e) => e.hasResult() && t.changes.touchesRange(e.from, e.to)) || !Bh(i, this.active) || o ? a = Rh.build(i, n, this.id, a, r, o) : a && a.disabled && !i.some((e) => e.isPending) && (a = null), !a && i.every((e) => !e.isPending) && i.some((e) => e.hasResult()) && (i = i.map((e) => e.hasResult() ? new Kh(e.source, 0) : e));
		for (let e of t.effects) e.is(Ah) && (a &&= a.setSelected(e.value, this.id));
	...
	get attrs() {
		return this.open ? this.open.attrs : this.active.length ? Vh : Hh;
	}
};
function Bh(e, t) {
	if (e == t) return !0;
...
var Vh = { "aria-autocomplete": "list" }, Hh = {};
function Uh(e, t) {
	let n = {
...
var Kh = class e {
	...
	update(t, n) {
		...
		else if (n.is(Th)) i = new e(i.source, 0);
		else if (n.is(Yh)) for (let e of n.value) e.source == i.source && (i = e);
		return i;
	}
	updateFor(e, t) {
	...
	touches(e) {
		return e.changes.touchesRange(vh(e.state));
	}
}, qh = class e extends Kh {
	constructor(e, t, n, r, i, a) {
	...
	updateFor(t, n) {
		...
		let i = t.changes.mapPos(this.from), a = t.changes.mapPos(this.to, 1), o = vh(t.state);
		if (o > a || !r || n & 2 && (vh(t.startState) == this.from || o < this.limit)) return new Kh(this.source, n & 4 ? 1 : 0);
		let s = t.changes.mapPos(this.limit);
		return Jh(r.validFor, t.state, i, a) ? new e(this.source, this.explicit, s, r, i, a) : r.update && (r = r.update(r, i, a, new fh(t.state, o, !1))) ? new e(this.source, this.explicit, s, r, r.from, r.to ?? vh(t.state)) : new Kh(this.source, 1, this.explicit);
	}
	map(t) {
		if (t.empty) return this;
		let n = this.result.map ? this.result.map(this.result, t) : this.result;
		return n ? new e(this.source, this.explicit, t.mapPos(this.limit), n, t.mapPos(this.from), t.mapPos(this.to, 1)) : new Kh(this.source, 0);
	}
	touches(e) {
...
function Jh(e, t, n, r) {
	...
	return typeof e == "function" ? e(i, n, r, t) : yh(e, !0).test(i);
}
var Yh = /*@__PURE__*/ O.define({ map(e, t) {
	return e.map((e) => e.map(t));
} }), Xh = /*@__PURE__*/ D.define({
	create() {
		return zh.start();
	},
	update(e, t) {
	...
	provide: (e) => [Us.from(e, (e) => e.tooltip), G.contentAttributes.from(e, (e) => e.attrs)]
});
function Zh(e, t) {
	let n = t.completion.apply || t.completion.label, r = e.state.field(Xh).active.find((e) => e.source == t.source);
	return r instanceof qh ? (typeof n == "string" ? e.dispatch({
		...xh(e.state, n, r.from, r.to),
		annotations: bh.of(t.completion)
	}) : n(e, t.completion, r.from, r.to), !0) : !1;
}
var Qh = /*@__PURE__*/ Ph(Xh, Zh);
function $h(e, t = "option") {
	return (n) => {
		let r = n.state.field(Xh, !1);
		...
		return s < 0 ? s = t == "page" ? 0 : o - 1 : s >= o && (s = t == "page" ? o - 1 : 0), n.dispatch({ effects: Ah.of(s) }), !0;
	};
}
var eg = (e) => {
	let t = e.state.field(Xh, !1);
	return e.state.readOnly || !t || !t.open || t.open.selected < 0 || t.open.disabled || Date.now() - t.open.timestamp < e.state.facet($).interactionDelay ? !1 : Zh(e, t.open.options[t.open.selected]);
}, tg = (e) => e.state.field(Xh, !1) ? (e.dispatch({ effects: wh.of(!0) }), !0) : !1, ng = (e) => {
	let t = e.state.field(Xh, !1);
	return !t || !t.active.some((e) => e.state != 0) ? !1 : (e.dispatch({ effects: Th.of(null) }), !0);
}, rg = class {
	constructor(e, t) {
		this.active = e, this.context = t, this.time = Date.now(), this.updates = [], this.done = void 0;
	}
}, ig = 50, ag = 1e3, og = /*@__PURE__*/ V.fromClass(class {
	constructor(e) {
		this.view = e, this.debounceUpdate = -1, this.running = [], this.debounceAccept = -1, this.pendingStart = !1, this.composing = 0;
		for (let t of e.state.field(Xh).active) t.isPending && this.startQuery(t);
	}
	update(e) {
		let t = e.state.field(Xh), n = e.state.facet($);
		if (!e.selectionSet && !e.docChanged && e.startState.field(Xh) == t) return;
		...
		for (let t = 0; t < this.running.length; t++) {
			...
			if (r || n.context.abortOnDocChange && e.docChanged || n.updates.length + e.transactions.length > ig && Date.now() - n.time > ag) {
				for (let e of n.context.abortListeners) try {
					e();
				} catch (e) {
					mr(this.view.state, e);
				}
	...
	startUpdate() {
		...
		let { state: e } = this.view, t = e.field(Xh);
	...
	startQuery(e) {
		let { state: t } = this.view, n = new fh(t, vh(t), e.explicit, this.view), r = new rg(e, n);
		this.running.push(r), Promise.resolve(e.source(n)).then((e) => {
			r.context.aborted || (r.done = e || null, this.scheduleAccept());
		}, (e) => {
			this.view.dispatch({ effects: Th.of(null) }), mr(this.view.state, e);
		});
	}
	scheduleAccept() {
	...
	accept() {
		...
		let e = [], t = this.view.state.facet($), n = this.view.state.field(Xh);
		for (let r = 0; r < this.running.length; r++) {
			let i = this.running[r];
			if (i.done === void 0) continue;
			if (this.running.splice(r--, 1), i.done) {
				let n = vh(i.updates.length ? i.updates[0].startState : this.view.state), r = Math.min(n, i.done.from + +!i.active.explicit), a = new qh(i.active.source, i.active.explicit, r, i.done, i.done.from, i.done.to ?? n);
			...
			if (a && a.isPending) if (i.done == null) {
				let n = new Kh(i.active.source, 0);
				for (let e of i.updates) n = n.update(e, t);
				n.isPending || e.push(n);
			} else this.startQuery(a);
		}
		(e.length || n.open && n.open.disabled) && this.view.dispatch({ effects: Yh.of(e) });
	}
}, { eventHandlers: {
	blur(e) {
		let t = this.view.state.field(Xh, !1);
		if (t && t.tooltip && this.view.state.facet($).closeOnBlur) {
			let n = t.open && ec(this.view, t.open.tooltip);
			(!n || !n.dom.contains(e.relatedTarget)) && setTimeout(() => this.view.dispatch({ effects: Th.of(null) }), 10);
		}
	},
	compositionstart() {
		this.composing = 1;
...
} }), sg = typeof navigator == "object" && /*@__PURE__*/ /Win/.test(navigator.platform), cg = /*@__PURE__*/ Te.highest(/*@__PURE__*/ G.domEventHandlers({ keydown(e, t) {
	let n = t.state.field(Xh, !1);
	if (!n || !n.open || n.open.disabled || n.open.selected < 0 || e.key.length > 1 || e.ctrlKey && !(sg && e.altKey) || e.metaKey) return !1;
	...
	return a && a.indexOf(e.key) > -1 && Zh(t, r), !1;
} })), lg = /*@__PURE__*/ G.baseTheme({
	...
	instantiate(e, t) {
		...
		for (let i of this.lines) {
			if (n.length) {
				...
				for (let t = 0; t < o; t++) n += e.facet(cu);
		...
		return {
			text: n,
			ranges: this.fieldPositions.map((e) => new dg(e.field, r[e.line] + e.from, r[e.line] + e.to))
		};
	}
	static parse(t) {
		let n = [], r = [], i = [], a;
		for (let e of t.split(/\r\n?|\n/)) {
			for (; a = /[#$]\{(?:(\d+)(?::([^{}]*))?|((?:\\[{}]|[^{}])*))\}/.exec(e);) {
				...
				i.push(new ug(s, r.length, a.index, a.index + c.length)), e = e.slice(0, a.index) + o + e.slice(a.index + a[0].length);
			}
			e = e.replace(/\\([{}])/g, (e, t, n) => {
...
}, pg = /*@__PURE__*/ R.widget({ widget: /*@__PURE__*/ new class extends Zt {
	toDOM() {
		let e = document.createElement("span");
...
}() }), mg = /*@__PURE__*/ R.mark({ class: "cm-snippetField" }), hg = class e {
	constructor(e, t) {
		this.ranges = e, this.active = t, this.deco = R.set(e.map((e) => (e.from == e.to ? pg : mg).range(e.from, e.to)), !0);
	}
	map(t) {
		let n = [];
...
}, gg = /*@__PURE__*/ O.define({ map(e, t) {
	return e && e.map(t);
} }), _g = /*@__PURE__*/ O.define(), vg = /*@__PURE__*/ D.define({
	create() {
		return null;
	},
	update(e, t) {
		for (let n of t.effects) {
			if (n.is(gg)) return n.value;
			if (n.is(_g) && e) return new hg(e.ranges, n.value);
		}
...
function bg(e) {
	...
	return (e, n, r, i) => {
		let { text: a, ranges: o } = t.instantiate(e.state, r), { main: s } = e.state.selection, c = {
			...
			scrollIntoView: !0,
			annotations: n ? [bh.of(n), k.userEvent.of("input.complete")] : void 0
		};
		if (o.length && (c.selection = yg(o, 0)), o.some((e) => e.field > 0)) {
			let t = new hg(o, 0), n = c.effects = [gg.of(t)];
			e.state.field(vg, !1) === void 0 && n.push(O.appendConfig.of([
				vg,
				wg,
				Eg,
				lg
...
function xg(e) {
	return ({ state: t, dispatch: n }) => {
		...
		return n(t.update({
			...
			effects: gg.of(a ? null : new hg(r.ranges, i)),
			scrollIntoView: !0
		})), !0;
	};
}
var Sg = [{
	...
	key: "Escape",
	run: ({ state: e, dispatch: t }) => e.field(vg, !1) ? (t(e.update({ effects: gg.of(null) })), !0) : !1
}], Cg = /*@__PURE__*/ E.define({ combine(e) {
	return e.length ? e[0] : Sg;
} }), wg = /*@__PURE__*/ Te.highest(/*@__PURE__*/ Mo.compute([Cg], (e) => e.facet(Cg)));
function Tg(e, t) {
	return {
		...t,
		apply: bg(e)
...
var Eg = /*@__PURE__*/ G.domEventHandlers({ mousedown(e, t) {
	let n = t.state.field(vg, !1), r;
	...
	return !i || i.field == n.active ? !1 : (t.dispatch({
		...
		effects: gg.of(n.ranges.some((e) => e.field > i.field) ? new hg(n.ranges, i.field) : null),
		scrollIntoView: !0
	}), !0);
} }), Dg = {
	brackets: [
	...
	before: ")]}:;>",
	stringPrefixes: []
}, Og = /*@__PURE__*/ O.define({ map(e, t) {
	return t.mapPos(e, -1, C.TrackAfter) ?? void 0;
} }), kg = /*@__PURE__*/ new class extends nt {}();
kg.startSide = 1, kg.endSide = -1;
var Ag = /*@__PURE__*/ D.define({
	create() {
		return M.empty;
	},
	update(e, t) {
		...
		for (let n of t.effects) n.is(Og) && (e = e.update({ add: [kg.range(n.value, n.value + 1)] }));
		return e;
	}
});
function jg() {
...
var Mg = "()[]{}<>«»»«［］｛｝";
function Ng(e) {
	for (let t = 0; t < 16; t += 2) if (Mg.charCodeAt(t) == e) return Mg.charAt(t + 1);
	return ie(e < 128 ? e : e + 1);
}
function Pg(e, t) {
	return e.languageDataAt("closeBrackets", t)[0] || Dg;
}
var Fg = typeof navigator == "object" && /*@__PURE__*/ /Android\b/.test(navigator.userAgent), Ig = /*@__PURE__*/ G.inputHandler.of((e, t, n, r) => {
	if ((Fg ? e.composing : e.compositionStarted) || e.state.readOnly) return !1;
	let i = e.state.selection.main;
	if (r.length > 2 || r.length == 2 && ae(S(r, 0)) == 1 || t != i.from || n != i.to) return !1;
	let a = Rg(e.state, r);
	...
	run: ({ state: e, dispatch: t }) => {
		if (e.readOnly) return !1;
		let n = Pg(e, e.selection.main.head).brackets || Dg.brackets, r = null, i = e.changeByRange((t) => {
			if (t.empty) {
				let r = Vg(e.doc, t.head);
				for (let i of n) if (i == r && Bg(e.doc, t.head) == Ng(S(i, 0))) return {
					changes: {
...
function Rg(e, t) {
	let n = Pg(e, e.selection.main.head), r = n.brackets || Dg.brackets;
	for (let i of r) {
		let a = Ng(S(i, 0));
		if (t == i) return a == i ? Wg(e, i, r.indexOf(i + i + i) > -1, n) : Hg(e, i, a, n.before || Dg.before);
		if (t == a && zg(e, e.selection.main.from)) return Ug(e, i, a);
	}
	return null;
}
function zg(e, t) {
	let n = !1;
	return e.field(Ag).between(0, e.doc.length, (e) => {
		e == t && (n = !0);
	}), n;
}
function Bg(e, t) {
	let n = e.sliceString(t, t + 2);
	return n.slice(0, ae(S(n, 0)));
}
function Vg(e, t) {
	let n = e.sliceString(t - 2, t);
	return ae(S(n, 0)) == n.length ? n : n.slice(1);
}
function Hg(e, t, n, r) {
...
function Ug(e, t, n) {
	let r = null, i = e.changeByRange((t) => t.empty && Bg(e.doc, t.head) == n ? {
		changes: {
			from: t.head,
			to: t.head + n.length,
			insert: n
...
function Wg(e, t, n, r) {
	let i = r.stringPrefixes || Dg.stringPrefixes, a = null, o = e.changeByRange((r) => {
		if (!r.empty) return {
			changes: [{
				insert: t,
				from: r.from
			...
			effects: Og.of(r.to + t.length),
			range: T.range(r.anchor + t.length, r.head + t.length)
		};
		let o = r.head, s = Bg(e.doc, o), c;
		if (s == t) {
			if (Gg(e, o)) return {
				changes: {
					insert: t + t,
		...
		} else if (n && e.sliceDoc(o - 2 * t.length, o) == t + t && (c = qg(e, o - 2 * t.length, i)) > -1 && Gg(e, c)) return {
			changes: {
				insert: t + t + t + t,
				from: o
			},
		...
		else if (e.charCategorizer(o)(s) != A.Word && qg(e, o, i) > -1 && !Kg(e, o, t, i)) return {
			changes: {
				insert: t + t,
				from: o
			},
...
var Yg = [
...
], Xg = /*@__PURE__*/ Te.highest(/*@__PURE__*/ Mo.computeN([$], (e) => e.facet($).defaultKeymap ? [Yg] : [])), Zg = class {
	constructor(e, t, n) {
	...
	static init(t, n, r) {
		let i = r.facet(f_).markerFilter;
		i && (t = i(t, r));
		let a = t.slice().sort((e, t) => e.from - t.from || e.to - t.to), o = new ct(), s = [], c = 0, l = r.doc.iter(), u = 0, d = r.doc.length;
		for (let e = 0;;) {
		...
		let f = o.finish();
		return new e(f, n, $g(f));
	}
};
function $g(e, t = null, n = 0) {
	let r = null;
	return e.between(n, 1e9, (e, n, { spec: i }) => {
		if (!(t && i.diagnostics.indexOf(t) < 0)) if (!r) r = new Zg(e, n, t || i.diagnostics[0]);
		else if (i.diagnostics.indexOf(r.diagnostic) < 0) return !1;
		else r = new Zg(r.from, n, r.diagnostic);
	}), r;
}
function e_(e, t) {
	let n = t.pos, r = t.end || n, i = e.state.facet(f_).hideOn(e, n, r);
	if (i != null) return i;
	let a = e.startState.doc.lineAt(t.pos);
	return !!(e.effects.some((e) => e.is(n_)) || e.changes.touchesRange(a.from, Math.max(a.to, r)));
}
function t_(e, t) {
	return e.field(a_, !1) ? t : t.concat(O.appendConfig.of(T_));
}
var n_ = /*@__PURE__*/ O.define(), r_ = /*@__PURE__*/ O.define(), i_ = /*@__PURE__*/ O.define(), a_ = /*@__PURE__*/ D.define({
	create() {
		return new Qg(R.none, null, null);
	},
	update(e, t) {
		if (t.docChanged && e.diagnostics.size) {
			...
			if (e.selected) {
				...
				r = $g(n, e.selected.diagnostic, i) || $g(n, null, i);
			}
			!n.size && i && t.state.facet(f_).autoPanel && (i = null), e = new Qg(n, i, r);
		}
		for (let n of t.effects) if (n.is(n_)) {
			let r = t.state.facet(f_).autoPanel ? n.value.length ? v_.open : null : e.panel;
			e = Qg.init(n.value, r, t.state);
		} else n.is(r_) ? e = new Qg(e.diagnostics, n.value ? v_.open : null, e.selected) : n.is(i_) && (e = new Qg(e.diagnostics, e.panel, n.value));
		return e;
	},
	provide: (e) => [sc.from(e, (e) => e.panel), G.decorations.from(e, (e) => e.diagnostics)]
}), o_ = /*@__PURE__*/ R.mark({ class: "cm-lintRange cm-lintRange-active" });
function s_(e, t, n) {
	let { diagnostics: r } = e.state.field(a_), i, a = -1, o = -1;
	r.between(t - +(n < 0), t + +(n > 0), (e, r, { spec: s }) => {
		if (t >= e && t <= r && (e == r || (t > e || n > 0) && (t < r || n < 0))) return i = s.diagnostics, a = e, o = r, !1;
	});
	let s = e.state.facet(f_).tooltipFilter;
...
function c_(e, t) {
	return P("ul", { class: "cm-tooltip-lint" }, t.map((t) => h_(e, t, !1)));
}
var l_ = (e) => {
	let t = e.state.field(a_, !1);
	(!t || !t.panel) && e.dispatch({ effects: t_(e.state, [r_.of(!0)]) });
	let n = rc(e, v_.open);
	return n && n.dom.querySelector(".cm-panel-lint ul").focus(), !0;
}, u_ = (e) => {
	let t = e.state.field(a_, !1);
	return !t || !t.panel ? !1 : (e.dispatch({ effects: r_.of(!1) }), !0);
}, d_ = [{
	key: "Mod-Shift-m",
	run: l_,
	preventDefault: !0
	...
	run: (e) => {
		let t = e.state.field(a_, !1);
		if (!t) return !1;
		let n = e.state.selection.main, r = $g(t.diagnostics, null, n.to + 1);
		return !r && (r = $g(t.diagnostics, null, 0), !r || r.from == n.from && r.to == n.to) ? !1 : (e.dispatch({
			selection: {
				anchor: r.from,
				head: r.to
			},
...
}], f_ = /*@__PURE__*/ E.define({ combine(e) {
	return {
...
function h_(e, t, n) {
	...
	return P("li", { class: "cm-diagnostic cm-diagnostic-" + t.severity }, P("span", { class: "cm-diagnosticText" }, t.renderMessage ? t.renderMessage(e) : t.message), t.actions?.map((n, i) => {
		let a = !1, o = (r) => {
			...
			a = !0;
			let i = $g(e.state.field(a_).diagnostics, t);
...
var g_ = class extends Zt {
	...
	constructor(e, t) {
		this.diagnostic = t, this.id = "item_" + Math.floor(Math.random() * 4294967295).toString(16), this.dom = h_(e, t, !0), this.dom.id = this.id, this.dom.setAttribute("role", "option");
	}
}, v_ = class e {
	constructor(e) {
		...
		let t = (t) => {
			if (!(t.ctrlKey || t.altKey || t.metaKey)) {
				if (t.keyCode == 27) u_(this.view), this.view.focus();
					...
					let { diagnostic: n } = this.items[this.selectedIndex], r = m_(n.actions);
					for (let i = 0; i < r.length; i++) if (r[i].toUpperCase().charCodeAt(0) == t.keyCode) {
						let t = $g(this.view.state.field(a_).diagnostics, n);
		...
		this.list = P("ul", {
			...
			onclick: () => u_(this.view)
		}, "×")), this.update();
	}
	get selectedIndex() {
		let e = this.view.state.field(a_).selected;
		if (!e) return -1;
		for (let t = 0; t < this.items.length; t++) if (this.items[t].diagnostic == e.diagnostic) return t;
		return -1;
	}
	update() {
		let { diagnostics: e, selected: t } = this.view.state.field(a_), n = 0, r = !1, i = null, a = /* @__PURE__ */ new Set();
		for (e.between(0, this.view.state.doc.length, (e, o, { spec: s }) => {
			for (let e of s.diagnostics) {
				...
				o < 0 ? (s = new __(this.view, e), this.items.splice(n, 0, s), r = !0) : (s = this.items[o], o > n && (this.items.splice(n, o - n), r = !0)), t && s.diagnostic == t.diagnostic ? s.dom.hasAttribute("aria-selected") || (s.dom.setAttribute("aria-selected", "true"), i = s) : s.dom.hasAttribute("aria-selected") && s.dom.removeAttribute("aria-selected"), n++;
			}
		}); n < this.items.length && !(this.items.length == 1 && this.items[0].diagnostic.from < 0);) r = !0, this.items.pop();
		this.items.length == 0 && (this.items.push(new __(this.view, {
			from: -1,
			to: -1,
			severity: "info",
	...
	moveSelection(e) {
		...
		let t = $g(this.view.state.field(a_).diagnostics, this.items[e].diagnostic);
...
function y_(e, t = "viewBox=\"0 0 40 40\"") {
	return `url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" ${t}>${encodeURIComponent(e)}</svg>')`;
}
function b_(e) {
	return y_(`<path d="m0 2.5 l2 -1.5 l1 0 l2 1.5 l1 0" stroke="${e}" fill="none" stroke-width=".7"/>`, "width=\"6\" height=\"3\"");
}
var x_ = /*@__PURE__*/ G.baseTheme({
	".cm-diagnostic": {
	...
	".cm-lintRange-error": { backgroundImage: /*@__PURE__*/ b_("#f11") },
	".cm-lintRange-warning": { backgroundImage: /*@__PURE__*/ b_("orange") },
	".cm-lintRange-info": { backgroundImage: /*@__PURE__*/ b_("#999") },
	".cm-lintRange-hint": { backgroundImage: /*@__PURE__*/ b_("#66d") },
...
var w_ = /*@__PURE__*/ Qs(s_, { hideOn: e_ }), T_ = [
	a_,
	/*@__PURE__*/ G.decorations.compute([a_], (e) => {
		let { selected: t, panel: n } = e.field(a_);
		return !t || !n || t.from == t.to ? R.none : R.set([o_.range(t.from, t.to)]);
	}),
	w_,
	x_
], E_ = [
	...
	static start(t, n, r = 0) {
		...
		return new e(t, [], n, r, r, 0, [], 0, i ? new O_(i, i.start) : null, 0, null);
	}
	get context() {
	...
	updateContext(e) {
		if (e != this.curContext.context) {
			let t = new O_(this.curContext.tracker, e);
...
var M_ = class {
	...
	constructor(e, t) {
		this.input = e, this.ranges = t, this.chunk = "", this.chunkOff = 0, this.chunk2 = "", this.chunk2Pos = 0, this.next = -1, this.token = N_, this.rangeIndex = 0, this.pos = this.chunkPos = t[0].from, this.range = t[0], this.end = t[t.length - 1].to, this.readNext();
	}
	resolveOffset(e, t) {
	...
	reset(e, t) {
		if (t ? (this.token = t, t.start = e, t.lookAhead = e + 1, t.value = t.extended = -1) : this.token = N_, this.pos != e) {
	...
	token(e, t) {
		let { parser: n } = t.p;
		R_(this.data, e, t, this.id, n.data, n.tokenPrecTable);
	}
};
F_.prototype.contextual = F_.prototype.fallback = F_.prototype.extend = !1;
var I_ = class {
	constructor(e, t, n) {
		this.precTable = t, this.elseToken = n, this.data = typeof e == "string" ? j_(e) : e;
	}
	token(e, t) {
		let n = e.pos, r = 0;
		for (;;) {
			let n = e.next < 0, i = e.resolveOffset(1, 1);
			if (R_(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1) break;
...
I_.prototype.contextual = F_.prototype.fallback = F_.prototype.extend = !1;
var L_ = class {
	constructor(e, t = {}) {
...
function R_(e, t, n, r, i, a) {
	...
	scan: for (; (s & e[o]) != 0;) {
		...
		for (let r = o + 3; r < n; r += 2) if ((e[r + 1] & s) > 0) {
			let n = e[r];
			if (c.allows(n) && (t.token.value == -1 || t.token.value == n || B_(n, t.token.value, i, a))) {
				t.acceptToken(n);
				break;
			}
		}
...
function B_(e, t, n, r) {
	let i = z_(n, r, t);
	return i < 0 || z_(n, r, e) < i;
}
var V_ = typeof process < "u" && process.env && /\bparse\b/.test(process.env.LOG), H_ = null;
function U_(e, t, n) {
	let r = e.cursor(q.IncludeAnonymous);
...
var W_ = class {
	...
	nextFragment() {
		...
		if (e) {
			for (this.safeFrom = e.openStart ? U_(e.tree, e.from + e.offset, 1) - e.offset : e.from, this.safeTo = e.openEnd ? U_(e.tree, e.to + e.offset, -1) - e.offset : e.to; this.trees.length;) this.trees.pop(), this.start.pop(), this.index.pop();
	...
	constructor(e, t) {
		this.stream = t, this.tokens = [], this.mainToken = null, this.actions = [], this.tokens = e.tokenizers.map((e) => new M_());
	}
	getActions(e) {
		...
		return s && e.setLookAhead(s), !n && e.pos == this.stream.end && (n = new M_(), n.value = e.p.parser.eofTerm, n.start = n.end = e.pos, t = this.addActions(e, n.value, n.end, t)), this.mainToken = n, this.actions;
	}
	getMainToken(e) {
		if (this.mainToken) return this.mainToken;
		let t = new M_(), { pos: n, p: r } = e;
	...
	addActions(e, t, n, r) {
		...
		for (let e = 0; e < 2; e++) for (let s = a.stateSlot(i, e ? 2 : 1);; s += 3) {
			if (o[s] == 65535) if (o[s + 1] == 1) s = Q_(o, s + 2);
			else {
				r == 0 && o[s + 1] == 2 && (r = this.putAction(Q_(o, s + 2), t, n, r));
				break;
			}
			o[s] == t && (r = this.putAction(Q_(o, s + 1), t, n, r));
		}
		return r;
	}
}, K_ = class {
	constructor(e, t, n, r) {
		this.parser = e, this.input = t, this.ranges = r, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.lastBigReductionStart = -1, this.lastBigReductionSize = 0, this.bigReductionCount = 0, this.stream = new P_(t, r), this.tokens = new G_(e, this.stream), this.topTerm = e.top[1];
		let { from: i } = r[0];
		this.stacks = [D_.start(this, e.top[0], i)], this.fragments = n.length && this.stream.end - i > e.bufferLength * 4 ? new W_(n, e.nodeSet) : null;
	}
	get parsedPos() {
	...
	advance() {
		...
		if (!n.length) {
			let e = r && $_(r);
			if (e) return V_ && console.log("Finish with " + this.stackID(e)), this.stackToTree(e);
			if (this.parser.strict) throw V_ && r && console.log("Stuck with token " + (this.tokens.mainToken ? this.parser.getName(this.tokens.mainToken.value) : "none")), SyntaxError("No parse at " + t);
			this.recovering ||= 5;
		}
		if (this.recovering && r) {
			let e = this.stoppedAt != null && r[0].pos > this.stoppedAt ? r[0] : this.runRecovery(r, i, n);
			if (e) return V_ && console.log("Force-finish " + this.stackID(e)), this.stackToTree(e.forceAll());
		}
		if (this.recovering) {
	...
	advanceStack(e, t, n) {
		let r = e.pos, { parser: i } = this, a = V_ ? this.stackID(e) + " -> " : "";
		...
		if (this.fragments) {
			...
			for (let o = this.fragments.nodeAt(r); o;) {
				...
				if (r > -1 && o.length && (!t || (o.prop(K.contextHash) || 0) == n)) return e.useNode(o, r), V_ && console.log(a + this.stackID(e) + ` (via reuse of ${i.getName(o.type.id)})`), !0;
				if (!(o instanceof J) || o.children.length == 0 || o.positions[0] > 0) break;
				let s = o.children[0];
				if (s instanceof J && o.positions[0] == 0) o = s;
				else break;
			}
		}
		let o = i.stateSlot(e.state, 4);
		if (o > 0) return e.reduce(o), V_ && console.log(a + this.stackID(e) + ` (via always-reduce ${i.getName(o & 65535)})`), !0;
		...
		for (let o = 0; o < s.length;) {
			...
			if (f.apply(c, l, p ? p.start : f.pos, u), V_ && console.log(a + this.stackID(f) + ` (via ${c & 65536 ? `reduce of ${i.getName(c & 65535)}` : "shift"} for ${i.getName(l)} @ ${r}${f == e ? "" : ", split"})`), d) return !0;
	...
	advanceFully(e, t) {
		...
		for (;;) {
			...
			if (e.pos > n) return q_(e, t), !0;
		}
	}
	runRecovery(e, t, n) {
		let r = null, i = !1;
		for (let a = 0; a < e.length; a++) {
			let o = e[a], s = t[a << 1], c = t[(a << 1) + 1], l = V_ ? this.stackID(o) + " -> " : "";
			if (o.deadEnd && (i || (i = !0, o.restart(), V_ && console.log(l + this.stackID(o) + " (restarted)"), this.advanceFully(o, n)))) continue;
			let u = o.split(), d = l;
			for (let e = 0; e < 10 && u.forceReduce() && (V_ && console.log(d + this.stackID(u) + " (via force-reduce)"), !this.advanceFully(u, n)); e++) V_ && (d = this.stackID(u) + " -> ");
			for (let e of o.recoverByInsert(s)) V_ && console.log(l + this.stackID(e) + " (via recover-insert)"), this.advanceFully(e, n);
			this.stream.end > o.pos ? (c == o.pos && (c++, s = 0), o.recoverByDelete(s, c), V_ && console.log(l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(s)})`), q_(o, n)) : (!r || r.score < u.score) && (r = u);
		}
		return r;
	}
	stackToTree(e) {
	...
	stackID(e) {
		let t = (H_ ||= /* @__PURE__ */ new WeakMap()).get(e);
		return t || H_.set(e, t = String.fromCodePoint(this.nextStackID++)), t + e;
	}
};
function q_(e, t) {
...
var J_ = class {
	...
	constructor(e) {
		this.start = e.start, this.shift = e.shift || Y_, this.reduce = e.reduce || Y_, this.reuse = e.reuse || Y_, this.hash = e.hash || (() => 0), this.strict = e.strict !== !1;
	}
}, Z_ = class e extends hl {
	constructor(e) {
		...
		this.nodeSet = new Gc(t.map((t, i) => Wc.define({
		...
		let a = j_(e.tokenData);
		this.context = e.context, this.specializerSpecs = e.specialized || [], this.specialized = new Uint16Array(this.specializerSpecs.length);
		for (let e = 0; e < this.specializerSpecs.length; e++) this.specialized[e] = this.specializerSpecs[e].term;
		this.specializers = this.specializerSpecs.map(ev), this.states = j_(e.states, Uint32Array), this.data = j_(e.stateData), this.goto = j_(e.goto), this.maxTerm = e.maxTerm, this.tokenizers = e.tokenizers.map((e) => typeof e == "number" ? new F_(a, e) : e), this.topRules = e.topRules, this.dialects = e.dialects || {}, this.dynamicPrecedences = e.dynamicPrecedences || null, this.tokenPrecTable = e.tokenPrec, this.termNames = e.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]];
	}
	createParse(e, t, n) {
		let r = new K_(this, e, t, n);
	...
	hasAction(e, t) {
		...
		for (let r = 0; r < 2; r++) for (let i = this.stateSlot(e, r ? 2 : 1), a;; i += 3) {
			if ((a = n[i]) == 65535) if (n[i + 1] == 1) a = n[i = Q_(n, i + 2)];
			else if (n[i + 1] == 2) return Q_(n, i + 2);
			else break;
			if (a == t || a == 0) return Q_(n, i + 1);
		}
		return 0;
	}
	stateSlot(e, t) {
	...
	allActions(e, t) {
		...
		for (let n = this.stateSlot(e, 1); r == null; n += 3) {
			if (this.data[n] == 65535) if (this.data[n + 1] == 1) n = Q_(this.data, n + 2);
			else break;
			r = t(Q_(this.data, n + 1));
		}
		return r;
	}
	nextStates(e) {
	...
	configure(t) {
		...
		return t.tokenizers && (n.tokenizers = this.tokenizers.map((e) => {
			...
			return n.specializers[r] = ev(a), a;
...
var tv = 1, nv = 194, rv = 195, iv = 196, av = 197, ov = 198, sv = 199, cv = 200, lv = 2, uv = 3, dv = 201, fv = 24, pv = 25, mv = 49, hv = 50, gv = 55, _v = 56, vv = 57, yv = 59, bv = 60, xv = 61, Sv = 62, Cv = 63, wv = 65, Tv = 238, Ev = 71, Dv = 241, Ov = 242, kv = 243, Av = 244, jv = 245, Mv = 246, Nv = 247, Pv = 248, Fv = 72, Iv = 249, Lv = 250, Rv = 251, zv = 252, Bv = 253, Vv = 254, Hv = 255, Uv = 256, Wv = 73, Gv = 77, Kv = 263, qv = 112, Jv = 130, Yv = 151, Xv = 152, Zv = 155, Qv = 10, $v = 13, ey = 32, ty = 9, ny = 35, ry = 40, iy = 46, ay = 123, oy = 125, sy = 39, cy = 34, ly = 92, uy = 111, dy = 120, fy = 78, py = 117, my = 85, hy = /* @__PURE__ */ new Set([
	pv,
	mv,
	hv,
	Kv,
...
var vy = new L_((e, t) => {
	let n;
	if (e.next < 0) e.acceptToken(sv);
	else if (t.context.flags & by) gy(e.next) && e.acceptToken(ov, 1);
	else if (((n = e.peek(-1)) < 0 || gy(n)) && t.canShift(av)) {
		let t = 0;
		for (; e.next == ey || e.next == ty;) e.advance(), t++;
		(e.next == Qv || e.next == $v || e.next == ny) && e.acceptToken(av, -t);
	} else gy(e.next) && e.acceptToken(iv, 1);
}, { contextual: !0 }), yy = new L_((e, t) => {
	let n = t.context;
	if (n.flags) return;
	let r = e.peek(-1);
	if (r == Qv || r == $v) {
		...
		for (;;) {
			if (e.next == ey) t++;
			else if (e.next == ty) t += 8 - t % 8;
			else break;
			e.advance(), r++;
		}
		t != n.indent && e.next != Qv && e.next != $v && e.next != ny && (t < n.indent ? e.acceptToken(rv, -r) : e.acceptToken(nv));
	}
}), by = 1, xy = 2, Sy = 4, Cy = 8, wy = 16, Ty = 32;
function Ey(e, t, n) {
	this.parent = e, this.indent = t, this.flags = n, this.hash = (e ? e.hash + e.hash << 8 : 0) + t + (t << 4) + n + (n << 6);
}
var Dy = new Ey(null, 0, 0);
function Oy(e) {
	let t = 0;
	for (let n = 0; n < e.length; n++) t += e.charCodeAt(n) == ty ? 8 - t % 8 : 1;
	return t;
}
var ky = new Map([
	[Dv, 0],
	...
	[Hv, 56],
	[Uv, 60]
].map(([e, t]) => [e, t | xy])), Ay = new X_({
	start: Dy,
	reduce(e, t, n, r) {
		return e.flags & by && hy.has(t) || (t == Ev || t == Fv) && e.flags & xy ? e.parent : e;
	},
	shift(e, t, n, r) {
		return t == nv ? new Ey(e, Oy(r.read(r.pos, n.pos)), 0) : t == rv ? e.parent : t == fv || t == gv || t == yv || t == uv ? new Ey(e, 0, by) : ky.has(t) ? new Ey(e, 0, ky.get(t) | e.flags & by) : e;
	},
	hash(e) {
		return e.hash;
	}
	...
	if (!/\w/.test(String.fromCharCode(e.next))) for (let t = 0;; t++) {
		let n = e.peek(t);
		if (!(n == ey || n == ty)) {
			n != ry && n != iy && n != Qv && n != $v && n != ny && e.acceptToken(tv);
			return;
		}
	}
}), My = new L_((e, t) => {
	let { flags: n } = t.context, r = n & Sy ? cy : sy, i = (n & Cy) > 0, a = !(n & wy), o = (n & Ty) > 0, s = e.pos;
	for (; !(e.next < 0);) if (o && e.next == ay) if (e.peek(1) == ay) e.advance(2);
	else {
		if (e.pos == s) {
			e.acceptToken(uv, 1);
			return;
		...
		if (e.pos == s) {
			e.advance();
			let t = e.next;
			t >= 0 && (e.advance(), Ny(e, t)), e.acceptToken(lv);
			return;
		}
		break;
	} else if (e.next == ly && !a && e.peek(1) > -1) e.advance(2);
	else if (e.next == r && (!i || e.peek(1) == r && e.peek(2) == r)) {
		if (e.pos == s) {
			e.acceptToken(dv, i ? 3 : 1);
			return;
		}
		break;
	} else if (e.next == Qv) {
	...
	e.pos > s && e.acceptToken(cv);
});
function Ny(e, t) {
	if (t == uy) for (let t = 0; t < 2 && e.next >= 48 && e.next <= 55; t++) e.advance();
	else if (t == dy) for (let t = 0; t < 2 && _y(e.next); t++) e.advance();
	else if (t == py) for (let t = 0; t < 4 && _y(e.next); t++) e.advance();
	else if (t == my) for (let t = 0; t < 8 && _y(e.next); t++) e.advance();
	else if (t == fy && e.next == ay) {
		for (e.advance(); e.next >= 0 && e.next != oy && e.next != sy && e.next != cy && e.next != Qv;) e.advance();
		e.next == oy && e.advance();
	}
}
var Py = Cl({
	"async \"*\" \"**\" FormatConversion FormatSpec": X.modifier,
	"for while if elif else try except finally return raise break continue with pass assert await yield match case": X.controlKeyword,
	"in not and or is del": X.operatorKeyword,
	"from def class global nonlocal lambda": X.definitionKeyword,
	import: X.moduleKeyword,
	"with as print": X.keyword,
	Boolean: X.bool,
	None: X.null,
	VariableName: X.variableName,
	"CallExpression/VariableName": X.function(X.variableName),
	"FunctionDefinition/VariableName": X.function(X.definition(X.variableName)),
	"ClassDefinition/VariableName": X.definition(X.className),
	PropertyName: X.propertyName,
	"CallExpression/MemberExpression/PropertyName": X.function(X.propertyName),
	Comment: X.lineComment,
	Number: X.number,
	String: X.string,
	FormatString: X.special(X.string),
	Escape: X.escape,
	UpdateOp: X.updateOperator,
	"ArithOp!": X.arithmeticOperator,
	BitOp: X.bitwiseOperator,
	CompareOp: X.compareOperator,
	AssignOp: X.definitionOperator,
	Ellipsis: X.punctuation,
	At: X.meta,
	"( )": X.paren,
	"[ ]": X.squareBracket,
	"{ }": X.brace,
	...
	tokenPrec: 7668
}), Ly = /*@__PURE__*/ new pl(), Ry = /*@__PURE__*/ new Set([
	"Script",
	"Body",
	"FunctionDefinition",
	"ClassDefinition",
...
var By = {
	FunctionDefinition: /*@__PURE__*/ zy("function"),
	ClassDefinition: /*@__PURE__*/ zy("class"),
	ForStatement(e, t, n) {
		if (n) {
	...
	CapturePattern: /*@__PURE__*/ zy("variable"),
	AsPattern: /*@__PURE__*/ zy("variable"),
	__proto__: null
};
function Vy(e, t) {
	let n = Ly.get(t);
	...
	return t.cursor(q.IncludeAnonymous).iterate((t) => {
		if (t.name) {
			let e = By[t.name];
			if (e && e(t, a, i) || !i && Ry.has(t.name)) return !1;
			i = !1;
		} else if (t.to - t.from > 8192) {
			for (let n of Vy(e, t.node)) r.push(n);
			return !1;
		}
	}), Ly.set(t, r), r;
}
var Hy = /^[\w\xa1-\uffff][\w\d\xa1-\uffff]*$/, Uy = [
	"String",
	"FormatString",
	"Comment",
	"PropertyName"
...
function Wy(e) {
	...
	if (Uy.indexOf(t.name) > -1) return null;
	let n = t.name == "VariableName" || t.to - t.from < 20 && Hy.test(e.state.sliceDoc(t.from, t.to));
	if (!n && !e.explicit) return null;
	let r = [];
	for (let n = t; n; n = n.parent) Ry.has(n.name) && (r = r.concat(Vy(e.state.doc, n)));
	return {
		options: r,
		from: n ? t.from : e.pos,
		validFor: Hy
...
var Gy = /*@__PURE__*/ [
	...
	/*@__PURE__*/ Tg("def ${name}(${params}):\n	${}", {
		label: "def",
		detail: "function",
		type: "keyword"
	}),
	/*@__PURE__*/ Tg("for ${name} in ${collection}:\n	${}", {
		label: "for",
		detail: "loop",
		type: "keyword"
	}),
	...
	/*@__PURE__*/ Tg("class ${name}:\n	def __init__(self, ${params}):\n			${}", {
		label: "class",
		detail: "definition",
		type: "keyword"
	}),
	/*@__PURE__*/ Tg("import ${module}", {
		label: "import",
		detail: "statement",
		type: "keyword"
	}),
	/*@__PURE__*/ Tg("from ${module} import ${names}", {
		label: "from",
		detail: "import",
		type: "keyword"
	})
], qy = /*@__PURE__*/ gh(Uy, /*@__PURE__*/ hh(/*@__PURE__*/ Gy.concat(Ky)));
function Jy(e) {
...
var Xy = /*@__PURE__*/ Xl.define({
	name: "python",
	parser: /*@__PURE__*/ Iy.configure({ props: [/*@__PURE__*/ pu.add({
		Body: (e) => Yy(e, /^\s*(#|$)/.test(e.textAfter) && Jy(e) || e.node) ?? e.continue(),
		MatchBody: (e) => Yy(e, Jy(e) || e.node) ?? e.continue(),
		...
		"TupleExpression ComprehensionExpression ParamList ArgList ParenthesizedExpression": /*@__PURE__*/ Su({ closing: ")" }),
		"DictionaryExpression DictionaryComprehensionExpression SetExpression SetComprehensionExpression": /*@__PURE__*/ Su({ closing: "}" }),
		"ArrayExpression ArrayComprehensionExpression": /*@__PURE__*/ Su({ closing: "]" }),
		MemberExpression: (e) => e.baseIndent + e.unit,
		"String FormatString": () => null,
		Script: (e) => {
			let t = Jy(e);
			return (t && Yy(e, t)) ?? e.continue();
		}
	}), /*@__PURE__*/ Du.add({
		"ArrayExpression DictionaryExpression SetExpression TupleExpression": Ou,
		Body: (e, t) => ({
			from: e.from + 1,
...
function Zy() {
	return new ou(Xy, [Xy.data.of({ autocomplete: Wy }), Xy.data.of({ autocomplete: qy })]);
}
//#endregion
export { G as EditorView, E_ as basicSetup, Zy as python };
