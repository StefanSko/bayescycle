...
- Add `bayescycle study init|validate|apply` for initializing and validating
  optional study directories and atomically applying approved RFC 6902 state
...
- Pin native and Playground Bayesite engines to v0.4.0, adding matrix-vector IR execution while retaining corrected ancestral forward-simulation planning and partially observed ancestor propagation.
