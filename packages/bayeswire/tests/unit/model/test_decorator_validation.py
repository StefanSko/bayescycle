...
class _ScalarArrayStub:
    """Duck-typed scalar array standing in for a backend array at the boundary."""
...
class _VectorArrayStub:
    """Duck-typed non-scalar array standing in for a backend array at the boundary."""
...
class OpaqueShiftedNormal:
    ...
    def log_prob(self, x: DistributionValue) -> LogProbability:
        raise NotImplementedError("log-density evaluation is backend behavior")
...
def test_model_declaration_rejects_array_like_expression_constants_with_guidance() -> None:
    offset = _VectorArrayStub((1.0, 2.0))
...
def test_model_declaration_rejects_hidden_non_scalar_distribution_parameters() -> None:
    scale = _VectorArrayStub((1.0, 2.0))
...
def test_private_model_declaration_resolution_matches_scalar_array_uniform_bounds() -> None:
    lower = _ScalarArrayStub(_float32(0.25))
    upper = _ScalarArrayStub(_float32(0.75))
...
def test_private_model_declaration_resolution_compares_bounds_as_exact_python_floats() -> None:
    lower = _ScalarArrayStub(_float32(0.1))
    upper = _ScalarArrayStub(_float32(0.9))
