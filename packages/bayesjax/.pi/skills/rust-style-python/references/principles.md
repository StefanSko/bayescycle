...
These principles are intended for `bayesjax`: a small library with a narrow public story and strong correctness constraints.
...
For `bayesjax`, this includes symbolic-vs-numeric distribution arguments,
