...
- The authoring/IR boundary is the **bayeswire package**. Model declarations,
  ...
  the dimension sidecar live there; bayesjax depends on bayeswire pinned by
...
- Importing bayesjax's backend modules is the only thing that may import
...
- bayesjax proves consume-conformance against the bayeswire corpus read
