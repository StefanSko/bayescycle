...
bayesjax exposes an InferenceData-compatible schema adapter without depending on
...
Posterior arrays keep the public bayesjax layout:
...
| bayesjax diagnostic | InferenceData-compatible variable |
|---|---|
