...
conformance corpus live in bayeswire; bayesjax consumes them and owns
...
semantics when sampling with bayesjax:
...
- For partially observed continuous vectors,
  `bayesjax.data.PartialVector.from_nan(...)` converts a NaN-masked vector
